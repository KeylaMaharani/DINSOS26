      /* Highcharts core (bundled offline) */
      !(
        /**
         ...
         */ (function (t, e) {
          "object" == typeof exports && "object" == typeof module
            ...
            : "function" == typeof define && define.amd
              ...
              : "object" == typeof exports
                ...
                : (t.Highcharts && t.Highcharts.error(16, !0),
                  (t.Highcharts = e()));
          ...
          (() => {
                ...
                for (var i = 0; i < e.length; ) {
                  ...
                  r.o(t, s)
                    ...
                    : 0 === o
                      ...
                      : Object.defineProperty(t, s, { enumerable: !0, get: o });
                }
              else
                for (var s in e)
                  r.o(e, s) &&
            ...
            let a = {};
            (r.d(a, { default: () => sJ }),
              ((il = e2 || (e2 = {})).SVG_NS = "http://www.w3.org/2000/svg"),
              (il.product = "Highcharts"),
              (il.version = "13.0.2"),
              (il.win = "u" > typeof window ? window : {}),
              (il.doc = il.win.document),
              (il.svg = !!il.doc?.createElementNS?.(il.SVG_NS, "svg")
                ?.createSVGRect),
              (il.pageLang = il.doc?.documentElement?.closest("[lang]")?.lang),
              (il.userAgent = il.win.navigator?.userAgent || ""),
              (il.isChrome = il.win.chrome),
              (il.isFirefox = -1 !== il.userAgent.indexOf("Firefox")),
              (il.isMS =
                /(edge|msie|trident)/i.test(il.userAgent) && !il.win.opera),
              (il.isSafari =
                !il.isChrome && -1 !== il.userAgent.indexOf("Safari")),
              (il.isTouchDevice = /(Mobile|Android|Windows Phone)/.test(
                il.userAgent,
              )),
              (il.isWebKit = -1 !== il.userAgent.indexOf("AppleWebKit")),
              (il.deg2rad = (2 * Math.PI) / 360),
              (il.marginNames = [
                "plotTop",
                "marginRight",
                "marginBottom",
              ...
              (il.noop = function () {}),
              (il.supportsPassiveEvents = (function () {
                let t = !1;
                if (!il.isMS) {
                  ...
                  il.win.addEventListener &&
                    il.win.removeEventListener &&
                    (il.win.addEventListener("testPassive", il.noop, e),
                    il.win.removeEventListener("testPassive", il.noop, e));
                }
                return t;
              })()),
              (il.charts = []),
            ...
            function x(t, e, i, s, o) {
              ...
              return (
                e && S(r, e),
                o && b(r, { padding: "0", border: "none", margin: "0" }),
                i && b(r, i),
                s && s.appendChild(r),
                r
              );
            ...
            function T(t, e) {
              let i = function () {};
              return ((i.prototype = new t()), S(i.prototype, e), i);
            }
            function A(t, e, i, s) {
              if (
                ((i = i || {}),
                l?.createEvent && (t.dispatchEvent || (t.fireEvent && t !== n)))
              ) {
              ...
              if ("width" === e) {
                ...
                return (
                  ...
                  Math.max(
                    0,
                    e -
                      (I(t, "padding-left", !0) || 0) -
                      (I(t, "padding-right", !0) || 0),
                  )
                );
              }
              if ("height" === e)
                return Math.max(
                  ...
                  Math.min(t.offsetHeight, t.scrollHeight) -
                    (I(t, "padding-top", !0) || 0) -
                    (I(t, "padding-bottom", !0) || 0),
                );
              let o = d.getComputedStyle(t, void 0);
              return (
                o &&
            ...
            function N(t) {
              return X(t) && "number" == typeof t.nodeType;
            }
            function z(t) {
              let e = t?.constructor;
              return !!(X(t, !0) && !N(t) && e?.name && "Object" !== e.name);
            }
            function R(t) {
              return (
                "number" == typeof t && !isNaN(t) && t < 1 / 0 && t > -1 / 0
              );
            }
            function W(t) {
            ...
            function Y(t, e, i, s, o) {
              ...
              return m(a * i, -Math.round(Math.log(0.001) / Math.LN10));
            }
            function j(t, e, i) {
              for (let s in t)
            ...
            function $(t) {
              ...
              return {
                top:
                  i.top + (d.pageYOffset || e.scrollTop) - (e.clientTop || 0),
                left:
                  i.left +
                  (d.pageXOffset || e.scrollLeft) -
                  (e.clientLeft || 0),
                width: i.width,
                height: i.height,
              };
 ...
 - ${i}: ${e}`),
            ...
            function tr(t, e) {
              ...
              for (i = t.options.isInternal ? o : 0; i < o + 1; i++)
                if (
                  !e[i] ||
                  (R(s) && s < (e[i].options.index ?? e[i]._i)) ||
            ...
            ts.jQuery &&
              (ts.jQuery.fn.highcharts = function () {
                let t = [].slice.call(arguments);
                if (this[0])
                  return t[0]
                    ? (new n[W(t[0]) ? t.shift() : "Chart"](
                        this[0],
                        t[0],
                        t[1],
                      ),
                      this)
                    : ti[u(this[0], "data-highcharts-chart")];
              });
            let { pageLang: th, win: tl } = n,
              td =
                n.isSafari &&
                tl.Intl &&
                !tl.Intl.DateTimeFormat.prototype.formatRange,
              tc = class {
                constructor(t, e) {
                ...
                update(t = {}) {
                  ((this.dTLCache = {}),
                    (this.options = t = F(!0, this.options, t)));
                  let { timezoneOffset: e, useUTC: i, locale: s } = t;
                  this.Date = t.Date || tl.Date || Date;
                  let o = t.timezone;
                  (v(i) && (o = i ? "UTC" : void 0),
                    e &&
                      e % 60 == 0 &&
                ...
                dateTimeFormat(
                  t,
                  e,
                  i = this.options.locale || this.lang?.locale || th,
                ) {
                  let s = JSON.stringify(t) + i;
                  W(t) && (t = this.str2dtf(t));
                ...
                parse(t) {
                  if (!W(t)) return t ?? void 0;
                  let e =
                      (t = t
                        .replace(/\//g, "-")
                        .replace(/(GMT|UTC)/, "")).indexOf("Z") > -1 ||
                      /([+-][0-9]{2}):?[0-9]{2}$/.test(t),
                ...
                dateFormat(t, e, i) {
                  let s = this.lang;
                  if (!v(e) || isNaN(e)) return s?.invalidDate || "";
                  if (W((t = t ?? "%Y-%m-%d %H:%M:%S"))) {
                    let i,
                      o = /%\[([a-zA-Z]+)\]/g;
                    for (; (i = o.exec(t)); )
                      t = t.replace(
                        i[0],
                        this.dateTimeFormat(i[1], e, s?.locale),
                      );
                  }
                  if (W(t) && -1 !== t.indexOf("%")) {
                    let i = this,
                      [o, r, a, h, l, d, c, p] = this.toParts(e),
                      g = s?.weekdays || this.weekdays,
                      u = s?.shortWeekdays || this.shortWeekdays,
                      f = s?.months || this.months,
                      m = s?.shortMonths || this.shortMonths;
                    j(
                      S(
                        {
                          a: u ? u[p] : g[p].substr(0, 3),
                          A: g[p],
                          d: V(a),
                          e: V(a, 2, " "),
                          w: p,
                      ...
                      function (s, o) {
                        if (W(t))
                          for (; -1 !== t.indexOf("%" + o); )
                            t = t.replace(
                              "%" + o,
                              "function" == typeof s ? s.call(i, e, i) : s,
                            );
                      },
                    );
                  } else if (X(t)) {
                    let i = (this.getTimezoneOffset(e) || 0) / 36e5,
                      ...
                      { prefix: o = "", suffix: r = "" } = t;
                    t = o + this.dateTimeFormat(S({ timeZone: s }, t), e) + r;
                  }
                  return i ? te(t) : t;
                }
                resolveDTLFormat(t) {
              ...
              tp = class extends tc {
                getBoundaryTicks(t, e, i, s) {
                  ...
                  if (t.length < 1e4) {
                    ...
                    for (let c = 0; c < t.length; c++) {
                      ...
                      let [, g, u, f, m, x, y] = this.toParts(p),
                        b = !f && !m && !x && !y;
                      (a && 0 === m && (o[p] = "hour"),
                        n && b && (o[p] = "day"),
                        h && 1 === u && b && (o[p] = "month"),
                ...
                getTimeTicks(t, e, i, s) {
                  let o = [],
                    ...
                    n = e,
                    [h, l, d, c, p, g] = this.toParts(e),
                    u = (e || 0) % 1e3,
                    f;
                  if ((s ?? (s = 1), v(e))) {
                    if (
                      ((u = a >= ta.second ? 0 : r * Math.floor(u / r)),
                      a >= ta.second &&
                        (g = a >= ta.minute ? 0 : r * Math.floor(g / r)),
                      a >= ta.minute &&
                        (p = a >= ta.hour ? 0 : r * Math.floor(p / r)),
                      a >= ta.hour &&
                        (c = a >= ta.day ? 0 : r * Math.floor(c / r)),
                      a >= ta.day &&
                        (d =
                          a >= ta.month
                            ? 1
                            : Math.max(1, r * Math.floor(d / r))),
                      a >= ta.month &&
                        (l = a >= ta.year ? 0 : r * Math.floor(l / r)),
                      a >= ta.year && (h -= h % r),
                      a === ta.week)
                    ) {
                    ...
                    ((e = this.makeTime(h, l, d, c, p, g, u)),
                      this.variableTimezone &&
                        v(i) &&
                        (f =
                          i - e > 4 * ta.month ||
                          this.getTimezoneOffset(e) !==
                            this.getTimezoneOffset(i)));
                    let t = e,
                      n = 1;
                    for (; t < i; )
                      (o.push(t),
              ...
              tu = {
                ...
                global: {
                  buttonTheme: {
                    ...
                    states: {
                      ...
                      disabled: {
                        style: { color: "var(--highcharts-neutral-color-20)" },
                      },
                    },
                  },
                },
                ...
                chart: {
                  ...
                  reflow: !0,
                  selectionMarkerFill:
                    "color-mix(in srgb, var(--highcharts-highlight-color-80) 25%, transparent)",
                  type: "line",
                  zooming: {
                    singleTouch: !1,
                    resetButton: {
              ...
              tm = {
                ...
                setOptions: function (t) {
                  return (
                    ...
                    t.lang?.chartTitle &&
                      (tu.title = { ...tu.title, text: t.lang.chartTitle }),
                    tu
                  );
                },
              },
              ...
              ty = (t, e, i) =>
                0 === i
                  ...
                  : 1 === i
                    ? e
                    : `color-mix(in srgb,${t},${e} ${100 * i}%)`,
              tb = (t) => W(t) && !!t && "none" !== t;
            class tv {
              static parse(t) {
                return t ? new tv(t) : tv.None;
              }
              constructor(t) {
                let e, i, s, o;
                ((this.rgba = [NaN, NaN, NaN, NaN]), (this.input = t));
                const r = n.Color;
                if (r && r !== tv) return new r(t);
                if ("object" == typeof t && void 0 !== t.stops)
                  this.stops = t.stops.map((t) => new tv(t[1]));
                else if ("string" == typeof t)
                  for (
                    this.input = t = tv.names[t.toLowerCase()] || t,
                      s = tv.parsers.length;
                    s-- && !i;
                  )
                    (e = (o = tv.parsers[s]).regex.exec(t)) && (i = o.parse(e));
                i && (this.rgba = i);
              }
              get(t) {
                let e = this.input,
              ...
              setOpacity(t) {
                return (
                  R(this.rgba[0])
                    ...
                    : tv.useColorMix &&
                      tb(this.input) &&
                      (this.output = ty(this.input, "#0000", 1 - t)),
                  this
                );
              }
              tweenTo(t, e) {
                let i = this.rgba,
                  s = t.rgba;
                if (!R(i[0]) || !R(s[0]))
                  return tv.useColorMix &&
                    tb(this.input) &&
                    tb(t.input) &&
                    e < 0.99
                    ? ty(this.input, t.input, e)
                    : t.input || "none";
                let o = 1 !== s[3] || 1 !== i[3],
                  r = (t, s) => t + (i[s] - t) * (1 - e),
            ...
            ((tv.names = { white: "#ffffff", black: "#000000" }),
              (tv.parsers = [
                {
                  regex:
                    /rgba\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d?(?:\.\d+)?)\s*\)/,
                  parse: function (t) {
                    return [U(t[1]), U(t[2]), U(t[3]), parseFloat(t[4], 10)];
                  },
                },
                {
                  regex:
                ...
                },
                {
                  ...
                  parse: function (t) {
                    return [
                      ...
                      U(t[2], 16),
                      U(t[3], 16),
                      v(t[4]) ? U(t[4], 16) / 255 : 1,
                    ];
                  },
                },
              ]),
              (tv.useColorMix = tx.CSS?.supports(
                "color",
            ...
            class tM {
              ...
              update() {
                ...
                (this[e + "Setter"]
                  ? this[e + "Setter"]()
                  : t && t.attr
                    ? t.element && t.attr(e, i, void 0, !0)
                    : t && (t.style[e] = i + (this.unit || "")),
                  s?.call(t, i, this));
              }
              run(t, e, i) {
                let { elem: s, options: o } = this,
                  { complete: r, curAnim: a = {} } = o,
                  n = (t) => !n.stopped && this.step(t),
                  h =
                    tw.requestAnimationFrame ||
                    function (t) {
                      setTimeout(t, 13);
                    },
                  l = () => {
                    for (let t = 0; t < tM.timers.length; t++)
                      tM.timers[t]() || tM.timers.splice(t--, 1);
                    tM.timers.length && h(l);
                  };
                t !== e || s["forceAnimate:" + this.prop]
                  ? ((this.startTime = +new Date()),
                    ...
                    (n.elem = s),
                    (n.prop = this.prop),
                    n() && 1 === tM.timers.push(n) && h(l))
                  : (delete a[this.prop],
                    r && 0 === Object.keys(a).length && r.call(s));
              }
              step(t) {
                let e,
                  i,
              ...
              initPath(t, e, i) {
                ...
                return (
                  g.length &&
                    R(l) &&
                    ((d = r.length + l * n),
                    p ? (u(g, r), f(r)) : (u(r, g), f(g))),
                  [g, r]
                );
              }
              fillSetter() {
                tM.prototype.strokeSetter.apply(this, arguments);
              }
              strokeSetter() {
                this.elem.attr(
                  this.prop,
                  tk(this.start).tweenTo(tk(this.end), this.pos),
                  void 0,
                  !0,
                );
              }
            ...
            function tC(t, e) {
              e.renderer.globalAnimation = t ?? e.options.chart.animation ?? !0;
            }
            function tS(t) {
              return X(t)
                ? F({ duration: 500, defer: 0 }, t)
                : { duration: 500 * !!t, defer: 0 };
            }
            function tT(t, e, i) {
              let s = tS(e),
                o = i ? [i] : t.series,
              ...
              (X(i) ||
                ...
                j(e, (s, o) => {
                  ...
                  let r = new tM(t, i, o),
                    ...
                    l = "";
                  ("d" === o && H(a)
                    ? ((r.paths = r.initPath(t, t.pathArray, a)),
                      (r.toD = a),
                      (h = 1))
                    : t?.attr
                      ? (n = t.attr(o))
                      : t &&
                        ((n = +(I(t, o) || 0)), "opacity" !== o && (l = "px")),
                    h || (h = s),
                    "string" == typeof h &&
                      h.match("px") &&
                      (h = h.replace(/px/g, "")),
            ...
            let tP = (t, e) =>
                tM.timers.forEach((i) => {
                  i.elem !== t || (e && e !== i.prop) || (i.stopped = !0);
                }),
              { SVG_NS: tL, win: tO } = n,
              { trustedTypes: tE } = tO,
              tI =
                tE &&
                G(tE.createPolicy) &&
                tE.createPolicy("highcharts", { createHTML: (t) => t }),
              tD = tI ? tI.createHTML("") : "";
            class tB {
              static filterUserAttributes(t) {
                return (
                  j(t, (e, i) => {
                    let s = !0;
                    (-1 === tB.allowedAttributes.indexOf(i) && (s = !1),
                      -1 !==
                        [
                          "background",
                          "dynsrc",
                        ...
                        (s =
                          W(e) &&
                          tB.allowedReferences.some((t) => 0 === e.indexOf(t))),
                      s ||
                        (to(33, !1, void 0, {
                          "Invalid attribute in config": `${i}`,
                        }),
                        delete t[i]),
                      W(e) && t[i] && (t[i] = e.replace(/</g, "&lt;")));
                  }),
                  t
                );
              }
              ...
              static setElementHTML(t, e) {
                ((t.innerHTML = tB.emptyHTML), e && new tB(e).addToDOM(t));
              }
              constructor(t) {
                  ...
                  return (
                    J(e).forEach(function (e) {
                      let o,
                        r = e.tagName,
                        a = e.textContent
                          ? n.doc.createTextNode(e.textContent)
                          : void 0,
                        h = tB.bypassHTMLFiltering;
                      if (r)
                        if ("#text" === r) o = a;
                        else if (-1 !== tB.allowedTags.indexOf(r) || h) {
                          let s = "svg" === r ? tL : i.namespaceURI || tL,
                            l = n.doc.createElementNS(s, r),
                            d = e.attributes || {};
                          (j(e, function (t, e) {
                            "tagName" !== e &&
                              "attributes" !== e &&
                            ...
                            u(l, h ? d : tB.filterUserAttributes(d)),
                            e.style && b(l, e.style),
                            a && l.appendChild(a),
                            t(e.children || [], l),
                            (o = l));
              ...
              parseMarkup(t) {
                ...
                let s = (t, e) => {
                  let i = t.localName || t.nodeName.toLowerCase(),
                    o = { tagName: i };
            ...
            ((tB.allowedAttributes = [
              ...
              (tB.emptyHTML = tD),
              (tB.bypassHTMLFiltering = !1));
            let { defaultOptions: tN, defaultTime: tz } = tm,
              { pageLang: tR } = n,
              tW = {
                add: (t, e) => t + e,
                divide: (t, e) => (0 !== e ? m(t / e) : ""),
                eq: (t, e) => t == e,
                each: function (t) {
            ...
            function tG(t = "", e, i) {
              let s = /\{([^{}]+)\}/g,
                ...
                a = /f$/,
                n = /\.(\d)/,
                h = i?.options?.lang || tN.lang,
                l = i?.time || tz,
                d = i?.numberFormatter || tX.bind(i),
                c = (t = "") => {
                  let i;
                  return (
                    "true" === t ||
              ...
              for (; null !== (p = s.exec(t)); ) {
                ...
                tW[a] && (g.isBlock && a === g.fn && u++, g.fn || (g.fn = a));
                let n = "else" === p[1];
              ...
              return (
                r.forEach((s) => {
                  ...
                  if (m) {
                    ...
                    for (p = tW[m].length; p--; ) t.unshift(c(o[p + 1]));
                    ((r = tW[m].apply(e, t)),
                      s.isBlock &&
                        "boolean" == typeof r &&
                        (r = tG(r ? g : u, e, i)));
                    ...
                    ((o.lastIndex = 0),
                      o.test(s.find) && W(r) && (r = `"${r}"`));
                  }
                  t = t.replace(s.find, r ?? "");
                }),
                f ? tG(t, e, i) : t
              );
            }
            function tX(t, e, i, s) {
              ...
              (i ?? (i = h.decimalPoint),
                ...
                R(e) &&
                  e >= 0 &&
                  ((c.minimumFractionDigits = e),
                  (c.maximumFractionDigits = e)),
                "" === s && (c.useGrouping = !1));
              let p = s || i,
                g = p ? "en" : this?.locale || h.locale || tR,
                u = JSON.stringify(c) + g;
              return (
                (o = (tH[u] ?? (tH[u] = new Intl.NumberFormat(g, c))).format(
                  t,
                )),
                p &&
                  (o = o
            ...
            let tF = {
              dateFormat: function (t, e, i) {
                return tz.dateFormat(t, e, i);
              },
              format: tG,
              helpers: tW,
              numberFormat: tX,
            };
            (e5 || (e5 = {})).distribute = function t(e, i, s) {
              let o = e,
                r = o.reducedLen || i,
              ...
              if (m > r) {
                if (
                  (Q(e, (t, e) => (e.rank || 0) - (t.rank || 0)),
                  e[0].rank === e[e.length - 1].rank)
                ) {
                  let t = [[0, h - 1]];
                  for (; t.length && m > r; ) {
                    let i = t.shift();
                    if (!i) break;
                    ((g = e[(c = Math.floor((i[0] + i[1]) / 2))]),
                      Z(l, c) && (m -= g.size),
                  ...
                  for (c = h - 1; m > r && c >= 0; )
                    ((g = e[c]), Z(l, c) && (m -= g.size), c--);
                l.sort((t, e) => e - t).forEach((t) =>
                  d.apply(n, e.splice(t, 1)),
                );
              }
              for (
                Q(e, a),
                ...
                for (c = e.length; c--; )
                  ((g = e[c]),
                    (u =
                      (Math.min.apply(0, g.targets) +
                        Math.max.apply(0, g.targets)) /
                      2),
                    (g.pos = f(u - g.size * g.align, 0, i - g.size)));
            ...
            class tK {
              ...
              align(t, e, i, s = !0) {
                ...
                t
                  ...
                  : ((t = this.alignOptions || {}),
                    ...
                    (i = this.alignTo));
                let n = !i || W(i) ? i || "renderer" : void 0;
                n && (a && Z(r, this), (i = void 0));
                let h = i ?? o[n] ?? o,
                  l =
                    (h.x || 0) +
                    (t.x || 0) +
                    ((h.width || 0) - (t.width || 0)) * P(t.align),
                  d =
                    (h.y || 0) +
                    (t.y || 0) +
                    ((h.height || 0) - (t.height || 0)) * P(t.verticalAlign),
                  c = {};
                return (
              ...
              animate(t, e, i) {
                let s = tS(e ?? this.renderer.globalAnimation ?? !0),
                  o = s.defer;
                return (
                  t$.hidden && (s.duration = 0),
                  0 !== s.duration
                    ? (i && (s.complete = i),
                      tt(() => {
                        this.element && tA(this, t, s);
                      }, o))
              ...
              applyTextOutline(t) {
                ...
                if (o && "none" !== o && n.svg) {
                  ...
                  let t = t$.createElementNS(tU, "tspan");
                  u(t, {
                  ...
                  let a = t$.createElementNS(tU, "tspan");
                  ((a.textContent = "​"),
                    u(a, { x: Number(e.getAttribute("x")), dy: -r }),
                    t.appendChild(a),
              ...
              clip(t) {
                if (t && !t.clipPath) {
                  ...
                  (S(t, { clipPath: i, id: e, count: 0 }), t.add(i));
                }
                return this.attr(
                  "clip-path",
              ...
              crisp(t, e) {
                ...
                let i = t.x || this.x || 0,
                  ...
                  n = y(s, e);
                return (
                  S(t, { x: a, y: n, width: y(o, e) - a, height: y(r, e) - n }),
                  v(t.strokeWidth) && (t.strokeWidth = e),
                  t
                );
              }
              complexColor(t, e, i) {
                let s = this.renderer,
                  ...
                  g = [],
                  u;
                A(this.renderer, "complexColor", { args: arguments }, () => {
                  if (
                    (t.radialGradient
                      ? (r = "radialGradient")
                  ...
                  (e && (t = S(e, i)),
                    null === t.width || "auto" === t.width
                      ...
                      : "text" === s.nodeName.toLowerCase() &&
                        t.width &&
                        (r = this.textWidth = U(t.width)),
                    S(this.styles, t),
                    r && !tV && o.forExport && delete t.width);
                  let a = (t_ && t.fontSize) || null;
                  a && (R(a) || /^\d+$/.test(a)) && (t.fontSize += "px");
                  let n = F(t);
              ...
              dashstyleSetter(t) {
                ...
                if (("inherit" === i && (i = 1), t)) {
                  let s = (t = t.toLowerCase())
                    ...
                    .replace(/,$/, "")
                    .split(",");
                  for (e = s.length; e--; ) s[e] = "" + U(s[e]) * (i ?? NaN);
              ...
              destroy() {
                ...
                (t.safeRemoveChild(e),
                  t.alignOptions && C(i.alignedObjects, t),
                  j(t, (e, i) => {
                    ((t[i]?.parentGroup === t ||
              ...
              getBBox(t, e) {
                let i,
                  ...
                  p = e ?? this.rotation ?? 0,
                  g = a.styledMode
                    ? r && tK.prototype.getStyle.call(r, "font-size")
                    : n.fontSize,
                  u = this.getBBoxCacheKey([
                    a.rootFontSize,
                    this.textWidth,
                    this.alignValue,
                    n.fontWeight,
                ...
                if ((u && !t && (i = l[u]), !i || i.polygon)) {
                  ...
                  let t = { bBox: i };
                  (A(this, "afterGetBBox", t), (i = t.bBox));
                }
                if (u && ("" === h || i.height > 0)) {
              ...
              getRotatedBox(t, e) {
                let { x: i, y: s, width: o, height: r } = t,
                  ...
                  D = Math.min(C, S, T, A),
                  B = Math.min(L, O, E, I),
                  N = Math.max(C, S, T, A) - D,
                  z = Math.max(L, O, E, I) - B;
                return {
                  x: D,
                  y: B,
                  width: N,
              ...
              constructor(t, e) {
                ((this.onEvents = {}),
                  ...
                  (this.element =
                    "div" === e || "body" === e
                      ? x(e)
                      : t$.createElementNS(this.SVG_NS, e)),
                  (this.renderer = t),
                  (this.styles = {}),
                  A(this, "afterInit"));
              }
              on(t, e) {
                let { onEvents: i } = this;
                return (i[t] && i[t](), (i[t] = c(this.element, t, e)), this);
              }
              opacitySetter(t, e, i) {
              ...
              symbolAttr(t) {
                let e = this;
                (tK.symbolCustomAttribs.forEach(function (i) {
                  e[i] = t[i] ?? e[i];
                }),
                  e.attr({
              ...
              updateTransform(t = "transform") {
                ...
                (v(s) && p.push("matrix(" + s.join(",") + ")"),
                  ...
                  (v(n) || v(h)) && p.push(`scale(${n ?? 1} ${h ?? 1})`),
                  p.length &&
                    !(l || this).textPath &&
                    (i?.element || e).setAttribute(t, p.join(" ")));
              }
              ...
              zIndexSetter(t, e) {
                ...
                if (
                  (v(t)
                    ? (i.setAttribute("data-z-index", t),
                      (t *= 1),
                      this[e] === t && (p = !1))
                    : v(this[e]) && i.removeAttribute("data-z-index"),
                  (this[e] = t),
                  p)
                ) {
                  for (
                    (t = this.zIndex) && s && (s.handleZ = !0),
                      g = (n = r.childNodes).length - 1;
                    g >= 0 && !d;
                    g--
                  )
                    ((c = !v((l = (h = n[g]).getAttribute("data-z-index")))),
                      h !== i &&
                        (v(t) && t < 0 && c && !a && !g
                          ? (r.insertBefore(i, n[g]), (d = !0))
                          : ((v(t) && parseFloat(l || "") <= t) ||
                              (c && (!v(t) || t >= 0))) &&
                            (r.insertBefore(i, n[g + 1]), (d = !0))));
                  d || (r.insertBefore(i, n[3 * !!a]), (d = !0));
                }
                return d;
              }
            }
            ((tK.symbolCustomAttribs = [
              "anchorX",
              "anchorY",
              "clockwise",
              "end",
              ...
              (tK.prototype.strokeSetter = tK.prototype.fillSetter),
              (tK.prototype.yGetter = tK.prototype.xGetter),
              (tK.prototype.matrixSetter =
                tK.prototype.rotationOriginXSetter =
                tK.prototype.rotationOriginYSetter =
                tK.prototype.rotationSetter =
                tK.prototype.scaleXSetter =
                tK.prototype.scaleYSetter =
                tK.prototype.translateXSetter =
                tK.prototype.translateYSetter =
                tK.prototype.verticalAlignSetter =
                  function (t, e) {
            ...
            class t1 {
              ...
              injectCSS(t) {
                let e,
                  ...
                  a = Object.keys(M(t, this.defaultOptions)).length > 0,
                  n = Math.max(t.colors?.length || 0, tQ.length),
                  h = "light",
                  l = (t, e) => {
                    W(t) &&
                      ((e = e
                ...
                for (let e of ["light", "dark"]) {
                  let i = t[e] || {},
                    s = {},
                    r = new tv(i?.neutralColor || ""),
                    a = new tv(i?.backgroundColor || ""),
                    d = new tv(i?.highlightColor || "");
                  ((h = e),
                  ...
                  (j(i, l), j(s, l), "light" === e && S(o.dark, o.light));
                }
                ...
                (p.parentNode ||
                  ((p.nonce = "highcharts"),
                  (p.className = "highcharts-palette"),
                  d.appendChild(p)),
                  (i = (e = (t) => {
                    let e = "";
                    return (
  ...
  color-scheme: dark;
              ...
              update(t) {
                let e = this.renderer.box.parentElement,
                  i = tJ?.[this.renderer.chartIndex];
                ((t = F(!0, this.options, t)),
                  i && (i.options.palette = t),
                  !1 !== t.injectCSS && this.injectCSS(t),
                  e &&
                    (W(t.colorScheme) &&
                    ["light", "dark", "inherit"].includes(t.colorScheme)
            ...
            class t2 extends tq {
              ...
              css(t) {
                ...
                return tq.prototype.css.call(this, t);
              }
              destroy() {
                (q(this.element, "mouseenter"),
                  ...
                  tq.prototype.destroy.call(this));
              }
              fillSetter(t, e) {
                (t && (this.needsBox = !0),
                  (this.fill = t),
              ...
              updateBoxSize() {
                ...
                ((this.width = this.getPaddedWidth()),
                  (this.height =
                    (this.heightSetting || o.height || 0) + 2 * s));
                let r = this.renderer.fontMetrics(e);
                if (
                  ((this.baselineOffset =
                    s +
                    Math.min(
                      (this.text.firstLineMetrics || r).b,
                      o.height || 1 / 0,
                    )),
                  this.heightSetting &&
                  ...
                  ((i.x = t = this.getCrispAdjust()),
                    ...
                    this.box.attr(S(i, this.deferredAttr)),
                    (this.deferredAttr = {}));
                }
              }
              updateTextPadding() {
                ...
                if (!t.textPath) {
                  ...
                  let i = this.baseline ? 0 : this.baselineOffset,
                    s =
                      ...
                      P(e) * (this.widthSetting ?? this.bBox.width);
                  ((s !== t.x || i !== t.y) &&
                    (t.attr({ align: e, x: s }),
                    void 0 !== i && t.attr("y", i)),
                    (t.x = s),
              ...
              getPaddedWidth() {
                let t = this.padding,
                  e = this.paddingLeft ?? t,
                  i = this.paddingRight ?? t;
            ...
            function t5(t, e, i, s, o) {
              ...
              if (o) {
                ...
                let c = o.innerR,
                  ...
                  f = d ? 0 : Math.cos(n),
                  m = d ? 1 : Math.sin(n),
                  x = o.longArc ?? (n - a - Math.PI < 1e-4 ? 0 : 1),
                  y = [
                    "A",
                    h,
                    l,
                ...
                ((y.params = { start: a, end: n, cx: t, cy: e }),
                  r.push(["M", t + h * g, e + l * u], y),
                  v(c) &&
                    (((y = [
                      "A",
                      c,
            ...
            ((t2.emptyBBox = { width: 0, height: 0, x: 0, y: 0 }),
              (t2.textProps = [
                "color",
                "direction",
                "fontFamily",
            ...
            let t9 = {
                ...
                callout: function (t, e, i, s, o) {
                  let r = Math.min(o?.r || 0, i, s),
                    ...
                    h = o?.anchorY || 0,
                    l = t6(t, e, i, s, { r });
                  if (!R(n) || (n < i && n > 0 && h < s && h > 0)) return l;
                  if (t + n > i - a)
                    if (h > e + a && h < e + s - a)
                      l.splice(
                        3,
              ...
              { doc: t4, SVG_NS: t8, win: t7 } = n,
              et = (t, e) => t.substring(0, e) + "…",
              ee = class {
                constructor(t) {
                  const e = t.styles;
                ...
                buildSVG() {
                  ...
                  if (n !== t.textCache) {
                    ...
                    if (
                      ...
                      e.appendChild(
                        t4.createTextNode(this.unescapeEntities(s)),
                      );
                    W(this.textOutline) &&
                      t.applyTextOutline &&
                  ...
                  [].forEach.call(
                    ...
                    (t, s) => {
                      t.nextSibling &&
                        ...
                        u(t, { dy: this.getLineHeight(t.nextSibling), x: i }));
                    },
                  );
                  let s = this.width || 0;
                  if (!s) return;
                  let o = (t, o) => {
                      ...
                      if (n) {
                        ...
                        (n.forEach((e) => {
                          ...
                          r.forEach((e) => {
                            o.insertBefore(t4.createTextNode(e), t);
                            let s = t4.createElementNS(t8, "tspan");
                            ((s.textContent = "​"),
                              u(s, { dy: h, x: i }),
                              o.insertBefore(s, t));
                          }));
                        ...
                        this.ellipsis &&
                          r &&
                          this.truncate(t, r, void 0, 0, s, l, et);
                    },
                    r = (t) => {
                      [].slice.call(t.childNodes).forEach((i) => {
                        i.nodeType === t7.Node.TEXT_NODE
                          ? o(i, t)
                          : (-1 !==
                ...
                getLineHeight(t) {
                  let e =
                    t.nodeType === t7.Node.TEXT_NODE ? t.parentElement : t;
                ...
                modifyTree(t) {
                  let e = (i, s) => {
                    ...
                    ("#text" !== n && "a" !== n && (i.tagName = "tspan"),
                      S(i, { attributes: o, style: a }),
                      r && r.filter((t) => "#text" !== t.tagName).forEach(e));
                  };
                  (t.forEach(e),
                    A(this.svgElement, "afterModifyTree", { nodes: t }));
                }
                truncate(t, e, i, s, o, r, a) {
                  ...
                  if (
                    ((l.rotation = 0), s + (h = f(t.textContent.length)) > o)
                  ) {
                    for (; p <= g; )
                      ((u = Math.ceil((p + g) / 2)),
                        i && (n = a(i, u)),
                ...
                unescapeEntities(t, e) {
                  return (
                    j(this.renderer.escapes, function (i, s) {
                      (e && -1 !== e.indexOf(i)) ||
            ...
            class eg {
              constructor(t, e, i, s, o, r, a, n, h) {
                let l, d;
                ((this.x = 0), (this.y = 0));
                const p = this.createElement("svg").attr({
                    version: "1.1",
                ...
                (t.appendChild(g),
                  ...
                  this.createElement("desc")
                    .add()
                    .element.appendChild(
                      er.createTextNode("Created with Highcharts 13.0.2"),
                    ),
                  ...
                  (this.cacheKeys = []),
                  (this.asyncCounter = 0),
                  (this.rootFontSize = p.getStyle("font-size")),
                  this.setSize(e, i, !1),
                  a ||
                    (p.css(this.getStyle(s || {})),
                    (this.palette = new t1(this, n || ei.palette))),
                  ea &&
                    t.getBoundingClientRect &&
                    ((l = function () {
                      (b(t, { left: 0, top: 0 }),
                    ...
                    (this.unSubPixelFix = c(ep, "resize", l))));
              }
              definition(t) {
                return new tB([t]).addToDOM(this.defs.element);
              }
              getReferenceURL() {
                if ((ea || eh) && er.getElementsByTagName("base").length) {
                  if (!v(e)) {
                    let t = tn(),
                      i = new tB([
                        {
                    ...
                    b(i, { position: "fixed", top: 0, left: 0, zIndex: 9e5 });
                    let s = er.elementFromPoint(6, 6);
                    ((e = s?.id === "hitme"), er.body.removeChild(i));
                  }
                  if (e)
                    return K(
                      ep.location.href.split("#")[0],
                      [/<[^>]*>/g, ""],
                      [/([\('\)])/g, "\\$1"],
                      [/ /g, "%20"],
                    );
              ...
              getContrast(t) {
                ...
                if (R(e[0]) || !tv.useColorMix) {
                  ...
                  return 1.05 / (i + 0.05) > (i + 0.05) / 0.05
                    ? "#FFFFFF"
                    : "#000000";
                }
              ...
              button(t, e, i, s, o = {}, r, a, n, h, l) {
                let d = this.label(
                  ...
                  g = arguments,
                  u = 0;
                ((o = F(ei.global.buttonTheme, o)),
                  p &&
                    (delete o.fill, delete o.stroke, delete o["stroke-width"]));
                let f = o.states || {},
                  m = o.style || {};
                (delete o.states, delete o.style);
                let x = [tB.filterUserAttributes(o)],
                  y = [m];
                return (
                  p ||
                    ["hover", "select", "disabled"].forEach((t, e) => {
                      (x.push(
                        F(
                          x[0],
                          tB.filterUserAttributes(g[e + 5] || f[t] || {}),
                        ),
                      ),
                        y.push(x[e + 1].style),
                        delete x[e + 1].style);
                    }),
                  c(d.element, en ? "mouseover" : "mouseenter", function () {
                    3 !== u && d.setState(1);
                  }),
                  c(d.element, en ? "mouseout" : "mouseleave", function () {
                    3 !== u && d.setState(u);
                  }),
                  (d.setState = (t = 0) => {
                    if (
              ...
              crispLine(t, e) {
                let [i, s] = t;
                return (
                  v(i[1]) && i[1] === s[1] && (i[1] = s[1] = y(i[1], e)),
                  v(i[2]) && i[2] === s[2] && (i[2] = s[2] = y(i[2], e)),
                  t
                );
              }
              path(t) {
              ...
              circle(t, e, i) {
                let s = X(t) ? t : void 0 === t ? {} : { x: t, y: e, r: i },
              ...
              rect(t, e, i, s, o, r) {
                ...
                return (
                  this.styledMode ||
                    (void 0 !== r &&
                      ((a["stroke-width"] = r), S(a, n.crisp(a))),
                    (a.fill = "none")),
              ...
              symbol(t, e, i, s, o, r) {
                ...
                if (f)
                  ...
                  ((s.imgwidth = r?.width ?? ec[h]?.width),
                    (s.imgheight = r?.height ?? ec[h]?.height),
                    ...
                    v(e) && s.attr({ x: e, y: i }),
                    (s.isImg = !0),
                    v(s.imgwidth) && v(s.imgheight)
                      ? l(s)
                      : (s.attr({ width: 0, height: 0 }),
                        x("img", {
                          onload: function () {
                            let t = es[d.chartIndex];
                            (0 === this.width &&
                              (b(this, { position: "absolute", top: "-999em" }),
                              er.body.appendChild(this)),
                              (ec[h] = {
                                width: this.width,
                                height: this.height,
                              }),
              ...
              fontMetrics(t) {
                let e = R(t)
                    ? t
                    : U(tq.prototype.getStyle.call(t, "font-size") || 0),
              ...
              rotCorr(t, e, i) {
                let s = t;
                return (
                  e && i && (s = Math.max(s * Math.cos(e * eo), 4)),
                  { x: (-t / 3) * Math.sin(e * eo), y: s }
                );
              }
              pathToSegments(t) {
                let e = [],
              ...
              label(t, e, i, s, o, r, a, n, h) {
                return new t2(this, t, e, i, s, o, r, a, n, h);
              }
              alignElements() {
            ...
            (S(eg.prototype, {
              ...
              (n.Renderer = eg));
            let { composed: eu, isFirefox: ef } = n;
            class em extends tq {
              static compose(t) {
                Z(eu, "HTMLElement") &&
                  (t.prototype.html = function (t, e, i) {
                    return new em(this, "div").attr({
                      text: t,
                      x: Math.round(e),
                      y: Math.round(i),
              ...
              css(t) {
                ...
                return (
                  ...
                  R(Number(t?.fontSize)) && (t.fontSize += "px"),
                  S(this.styles, t),
                  b(i, t),
              ...
              updateTransform() {
                ...
                let {
                  ...
                  g = () =>
                    this.textPxLength
                      ? this.textPxLength
                      : (b(e, { width: "", whiteSpace: h || "nowrap" }),
                        e.offsetWidth),
                  u = [r, l, e.innerHTML, d, this.textAlign].join(",");
                if (
                  (b(e, { display: "inline-block", verticalAlign: "top" }),
                  d !== s)
                ) {
                  let t = g(),
                    i = d || 0,
                ...
                (i.attr({ width: o.width, height: o.height }),
                  u !== this.cTT &&
                    ((t = o.fontMetrics(e).b),
                    this.getSpanCorrection(
                      (!v(r) && !this.textWidth && this.textPxLength) ||
                        e.offsetWidth,
                      t,
                      P(l),
                    )),
                  ...
                  R(c) && R(p)
                    ? (i.attr({
                        ...
                        "transform-origin":
                          e.getAttribute("transform-origin") || "0 0",
                      }),
                      b(e, { display: n, textAlign: l }))
                    : ef && i.attr({ width: 0, height: 0 }),
                  (this.cTT = u));
              }
              add(t) {
                let { foreignObject: e } = this;
                return (
                  e.add(t),
                  super.add(e),
              ...
              textSetter(t) {
                t !== this.textStr &&
                  ...
                  tB.setElementHTML(this.element, t ?? ""),
                  (this.textStr = t),
                  (this.doTransform = !0));
              }
              alignSetter(t) {
              ...
              visibilitySetter(t, e) {
                (this.foreignObject.attr({ [e]: t }), (this[e] = t));
              }
            }
            let ex = em.prototype;
            ((ex.ySetter = ex.xSetter),
              (ex.opacitySetter = ex.visibilitySetter),
              ((id = e3 || (e3 = {})).xAxis = {
                alignTicks: !0,
                ...
                dateTimeLabelFormats: {
                  ...
                  hour: { main: "%[HM]", boundary: void 0, range: !1 },
                  day: { main: "%[eb]", boundary: "%[eb]" },
                  week: { main: "%[eb]" },
                  month: { main: "%[bY]", boundary: void 0 },
                  year: { main: "%[Y]", boundary: void 0 },
                },
                endOnTick: !1,
            ...
            let ey = e3;
            (e6 || (e6 = {})).registerEventOptions = function (t, e) {
              ((t.eventOptions = t.eventOptions || {}),
                j(e.events, function (e, i) {
                  t.eventOptions[i] !== e &&
                    (t.eventOptions[i] &&
                      (q(t, i, t.eventOptions[i]), delete t.eventOptions[i]),
                    G(e) &&
                      ((t.eventOptions[i] = e), c(t, i, e, { order: 0 })));
                }));
            };
            let eb = e6,
              { deg2rad: ev } = n,
              ek = class {
                ...
                addLabel() {
                  let t = this,
                    ...
                    a = e.names,
                    n = t.pos,
                    h = t.options?.labels ?? i.labels,
                    l = e.tickPositions,
                    d = n === l[0],
                    c = n === l[l.length - 1],
                    p = l.info,
                    g = p?.boundaryTicks[n],
                    u = i.dateTimeLabelFormats,
                    f = t.label,
                    x,
                    y,
                    b,
                    v =
                      this.parameters.category || (o ? (o[n] ?? a[n] ?? n) : n);
                  if ((r && R(v) && (v = m(r.lin2log(v))), e.dateTime && u))
                    if (p) {
                      let t = p.unitName,
                        e = {
                          millisecond: "hour",
                        ...
                        o =
                          (!i.grid?.enabled && g && e && u[e]?.boundary) ||
                          u[t];
                      x = (y = s.time.resolveDTLFormat(o)).main;
                    } else R(v) && (x = e.dateTime.getXDateFormat(v, u || {}));
                  ...
                  (C
                    ? (t.shortenLabel = function () {
                        for (b = 0; b < C.length; b++)
                          if (
                            (S(k, { dateTimeLabelFormat: C[b] }),
                            f.attr({ text: w.call(k, k) }),
                            f.getBBox().width <
                ...
                getPosition(t, e, i, s) {
                  let o = this.axis,
                    ...
                    n = {
                      x: t
                        ? m(o.translate(e + i, void 0, void 0, s) + o.transB)
                        : o.left +
                          o.offset +
                          (o.opposite
                      ...
                      y: t
                        ...
                        : m(
                            a -
                              o.translate(e + i, void 0, void 0, s) -
                              o.transB,
                          ),
                    };
                  return (
                    (n.y = f(n.y, -1e9, 1e9)),
                    A(this, "afterGetPosition", { pos: n }),
                    n
                  );
                }
                  ...
                  return (
                    (h =
                      0 === d.side
                        ...
                        : 2 === d.side
                          ? u.y + m
                          : Math.cos(i.rotation * ev) *
                            (u.y - i.getBBox(!1, 0).height / 2)),
                    v(o.y) && (h = 0 === d.side && d.horiz ? o.y + h : o.y),
                    (t =
                      t +
                      (o.x ?? [0, 1, 0, -1][d.side] * m) +
                      f +
                      u.x -
                      (r && s ? r * c * (p ? -1 : 1) : 0)),
                ...
                handleOverflow(t) {
                  let e = this.axis,
                    ...
                    r = e.chart.spacing,
                    a = e.labelLeft ?? Math.min(e.pos, r[3]),
                    n =
                      e.labelRight ??
                      Math.max(e.isRadial ? 0 : e.pos + e.len, o - r[1]),
                    h = this.label,
                    l = this.rotation,
                    d = P(e.labelAlign || h.attr("align")),
                    c = h.getBBox().width,
                  ...
                  (l || "justify" !== i.overflow
                    ? l < 0 && s - d * c < a
                      ? (f = Math.round(s / Math.cos(l * ev) - a))
                      : l > 0 &&
                        s + d * c > n &&
                        (f = Math.round((o - s) / Math.cos(l * ev)))
                    : (s - d * c < a
                        ? (g = t.x + g * (1 - d) - a)
                        : s + (1 - d) * c > n &&
                          ((g = n - t.x + g * d), (u = -1)),
                ...
                render(t, e, i) {
                  let s = this.axis,
                    o = s.horiz,
                    r = this.pos,
                    a = this.tickmarkOffset ?? s.tickmarkOffset,
                    ...
                    c = d + s.len,
                    p = o ? h : l,
                    g = i ?? this.label?.newOpacity ?? 1;
                  (!s.chart.polar && (m(p) < d || p > c) && (i = 0),
                    i ?? (i = 1),
                    (this.isActive = !0),
                ...
                renderGridLine(t, e) {
                  let i = this.axis,
                    ...
                    r = this.pos,
                    a = this.type,
                    n = this.tickmarkOffset ?? i.tickmarkOffset,
                    h = i.chart.renderer,
                    l = this.gridLine,
                    d,
                    c = s.gridLineWidth,
                ...
                renderLabel(t, e, i, s) {
                  let o = this.axis,
                    ...
                    h = a.labels,
                    l = h.step,
                    d = this.tickmarkOffset ?? o.tickmarkOffset,
                    c = t.x,
                    p = t.y,
                    g = !0;
                  n &&
              ...
              { xAxis: ew, yAxis: eM } = ey,
              { parse: eC } = tv,
              { defaultOptions: eS } = tm,
              { registerEventOptions: eT } = eb,
              { deg2rad: eA } = n,
              eP = (t, e) =>
                Y(
                  e,
                  ...
                  t.options.allowDecimals ??
                    (e < 0.5 || void 0 !== t.tickAmount),
                  !!t.tickAmount,
                );
            S(eS, { xAxis: ew, yAxis: F(ew, eM) });
            class eL {
              constructor(t, e, i) {
              ...
              init(t, e, i = this.coll) {
                ...
                ((this.chart = t),
                  ...
                  (this.opposite = e.opposite ?? this.opposite),
                  (this.side =
                    e.side ??
                    this.side ??
                    (o ? 2 * !this.opposite : this.opposite ? 1 : 3)),
                  this.setOptions(e));
                let r = this.options,
                  a = r.labels;
                (this.type ?? (this.type = r.type || "linear"),
                  ...
                  (this.reversed = r.reversed ?? this.reversed),
                  (this.visible = r.visible),
                  (this.zoomEnabled = r.zoomEnabled),
                  (this.hasNames =
                    "category" === this.type || !0 === r.categories),
                  (this.categories =
                    (H(r.categories) && r.categories) ||
                    (this.hasNames ? [] : void 0)),
                  this.names || (this.names = []),
                  this.namesMap || (this.namesMap = {}),
                  (this.plotLinesAndBandsGroups = {}),
                  (this.positiveValuesOnly = !!this.logarithmic),
                  (this.isLinked = v(r.linkedTo)),
                  (this.ticks = {}),
                  (this.labelEdge = []),
                  (this.minorTicks = {}),
                  ...
                  (this.max = void 0),
                  (this.min = void 0));
                let n = r.crosshair ?? J(t.options.tooltip.crosshairs)[+!s];
                ((this.crosshair = !0 === n ? {} : n),
                  ...
                  t.inverted &&
                    ...
                    !v(this.reversed) &&
                    (this.reversed = !0),
                  (this.labelRotation = R(a.rotation) ? a.rotation : void 0),
                  eT(this, r),
                  A(this, "afterInit"));
              }
              setOptions(t) {
                ...
                ((this.options = F(
                  e,
                  "yAxis" === this.coll
                    ? { title: { text: this.chart.options.lang.yAxisTitle } }
                    : {},
                  eS[this.coll],
                  t,
                )),
                ...
                if (r) g = `${this.value}`;
                  ...
                  for (; c-- && void 0 === g; )
                    d >= (p = Math.pow(l, c + 1)) &&
                      ...
                      null !== h[c] &&
                      0 !== s &&
                      (g = i(s / p, -1, void 0, void 0, e) + h[c]);
                return (
                  g ??
                    (g = i(s, -1, void 0, 1e4 > Math.abs(s) ? "" : void 0, e)),
                  g
                );
              }
              getSeriesExtremes() {
                        ...
                        if (
                          ...
                          (o = i.getColumn("x")).length &&
                            ...
                            R(a) ||
                              ...
                              (n = t.max)),
                            o.length &&
                              ((e.dataMin = Math.min(e.dataMin ?? a, a)),
                              (e.dataMax = Math.max(e.dataMax ?? n, n))));
                        else {
              ...
              getPlotLinePath(t) {
                ...
                return (
                  A(this, "getPlotLinePath", v, function (t) {
                    ((g = m =
                      (c = f(
                        (c = c ?? e.translate(a, void 0, void 0, r)),
                        -1e9,
                        1e9,
                      )) + d),
                      (u = x = h - c - d),
              ...
              getLinearTickPositions(t, e, i) {
                let s,
                  o,
                  r,
                  a = m(Math.floor(e / t) * t),
                  n = m(Math.ceil(i / t) * t),
                  h = [];
                if ((m(a + t) === a && (r = 20), this.single)) return [e];
                for (s = a; s <= n && (h.push(s), (s = m(s + t, r)) !== o); )
                  o = s;
                return h;
              }
              getMinorTickInterval() {
                let { minorTicks: t, minorTickInterval: e } = this.options;
                return !0 === t ? (e ?? "auto") : !1 !== t ? e : void 0;
              }
              ...
              adjustForMinRange() {
                ...
                (this.isXAxis &&
                  ...
                  !e &&
                  (r =
                    v(t.min) || v(t.max) || v(t.floor) || v(t.ceiling)
                      ? null
                      : Math.min(
                          5 *
                            (L(
                  ...
                  (this.series.forEach(function (t) {
                    ...
                    1 === o.length
                      ...
                      : t.sorted &&
                        v(s) &&
                        t.reserveSpace() &&
                        (e = v(e) ? Math.min(e, s) : s);
                  }),
                    i.length && (i.sort((t, e) => t - e), (t = L([i]))));
                }
                return t && e ? Math.min(t, e) : t || e;
              }
              nameToX(t, e) {
                let i,
                  s = H(this.options.categories),
                  { name: o, series: r } = t,
                    ...
                    (e =
                      this.uniqueNames && a
                        ? s
                          ...
                          : (n[o] ?? -1)
                        : r.autoIncrement()),
                  -1 === e ? !s && a && (i = a.length) : R(e) && (i = e),
                  void 0 !== i
                    ? ((this.names[i] = t.name), (n[t.name] = i))
                    : (i = R(t.x) ? t.x : r.autoIncrement()),
                  i
                );
              }
              updateNames() {
              ...
              setTickInterval(t) {
                let {
                  ...
                  d = i.time,
                  c = R(this.threshold) ? this.threshold : void 0,
                  p = this.minRange || 0,
                  {
                    ceiling: g,
                    floor: u,
                  ...
                  S,
                  T =
                    R(h.tickInterval) && h.tickInterval >= 0
                      ? h.tickInterval
                      : void 0,
                  P,
                  L,
                ...
                if (
                  ...
                  (O = this.userMin ?? d.parse(h.min)),
                  (E = this.userMax ?? d.parse(h.max)),
                  b
                    ? ((this.linkedParent = b),
                      (S = b.getExtremes()),
                      (this.min = S.min ?? S.dataMin),
                      (this.max = S.max ?? S.dataMax),
                      this.type !== b.type && to(11, !0, i))
                    : (l &&
                        v(c) &&
                        R(s) &&
                        R(o) &&
                  ...
                  R(this.max) &&
                    ...
                    (n &&
                      (this.positiveValuesOnly &&
                        !t &&
                        0 >= Math.min(this.min, o ?? this.min) &&
                        to(10, !0, i),
                      (this.min = m(n.log2lin(this.min), 16)),
                      (this.max = m(n.log2lin(this.max), 16))),
                    this.range &&
                      R(o) &&
                      ((this.userMin =
                        this.min =
                  ...
                  (!i.polar &&
                    ...
                    (v(h.min)
                      ? (this.max = this.min)
                      : v(h.max) && (this.min = this.max)),
                    (C = this.max - this.min));
                }
                if (
                  (this.min !== this.max && R(this.min) && R(this.max)
                    ? b && !T && k === b.options.tickPixelInterval
                      ? (this.tickInterval = T = b.tickInterval)
                      : (this.tickInterval =
                          T ??
                          (this.tickAmount
                            ? C / Math.max(this.tickAmount - 1, 1)
                            : e
                              ? 1
                              : (C * k) / Math.max(this.len, k)))
                    : (this.tickInterval = 1),
                  a && !t)
                ) {
                  let t =
                  ...
                  (this.series.forEach(function (e) {
                    ...
                    A(this, "postProcessData", { hasExtremesChanged: t }));
                }
                ...
                let I =
                  ...
                  (r && !this.series.some((t) => !t.sorted)
                    ...
                    : 0);
                (!T && I && this.tickInterval < I && (this.tickInterval = I),
                  r ||
                    n ||
                    T ||
                    (this.tickInterval = eP(this, this.tickInterval)),
              ...
              setTickPositions() {
                ...
                if (
                  ...
                  if (
                    ...
                    ((n = [this.min, this.max]), to(19, !1, this.chart));
                    ...
                    for (; e <= 2 * t; )
                      if (
                        ...
                        this.tickInterval = eP(this, (e *= 1.1));
                      else break;
                  }
                  (n.length > this.len &&
                    ...
                    i &&
                      ...
                      (h = i.apply(this, [this.min, this.max, this])) &&
                        (n = h)));
                }
                (this.isDirty ||
                  n.length === this.tickPositions?.length ||
                  (this.isDirty = !0),
                  (this.tickPositions = n),
              ...
              trimTicks(t, e, i) {
                ...
                if ((A(this, "trimTicks"), !this.isLinked || !this.grid)) {
                  if (e && R(s)) this.min = s;
              ...
              getThresholdAlignment(t) {
                if (
                  ((!R(this.dataMin) ||
                    (this !== t &&
                      this.series.some(
                        (t) => t.isDirty || t.isDirtyData || t.xAxis?.isDirty,
                      ))) &&
              ...
              adjustTickAmount() {
                let t = this,
                  ...
                  h = r?.length,
                  l = t.threshold ?? (t.softThreshold ? 0 : null),
                  d,
                  c,
                  p = t.tickInterval,
                  g,
                  u = () => r.push(m(r[r.length - 1] + p)),
                  x = () => r.unshift(m(r[0] - p));
                if (
                  (R(n) &&
                    ((g =
                  ...
                  if (R(g) && R(t.threshold)) {
                    for (
                      ...
                      for (r.length = 0, r.push(t.threshold); r.length < a; )
                        void 0 === r[g] || r[g] > t.threshold ? x() : u();
                      if (p > 8 * t.tickInterval) break;
                      p *= 2;
                    }
                    n();
                  } else if (h < a) {
                    for (; r.length < a; ) r.length % 2 || s === l ? u() : x();
                    n();
                  }
                  if (v(e)) {
                    for (c = d = r.length; c--; )
              ...
              setAxisSize() {
                let t = this.chart,
                  ...
                  o = (this.width = Math.round(
                    _(e.width ?? t.plotWidth - i[3] + i[1], t.plotWidth),
                  )),
                  r = (this.height = Math.round(
                    _(e.height ?? t.plotHeight - i[0] + i[2], t.plotHeight),
                  )),
                  a = (this.top = Math.round(
                    _(e.top ?? t.plotTop + i[0], t.plotHeight, t.plotTop),
                  )),
                  n = (this.left = Math.round(
                    _(e.left ?? t.plotLeft + i[3], t.plotWidth, t.plotLeft),
                  ));
              ...
              autoLabelAlign(t) {
                let e = (((t - 90 * this.side) % 360) + 360) % 360,
                  i = { align: "center" };
                return (
                  A(this, "autoLabelAlign", i, function (t) {
                    e > 15 && e < 165
                      ? (t.align = "right")
              ...
              tickSize(t) {
                ...
                let r = { tickSize: o, prefix: t };
                return (A(this, "afterTickSize", r), r.tickSize);
              }
              labelMetrics() {
              ...
              unsquish() {
                let t = this.options.labels,
                  ...
                  s = this.tickInterval,
                  o =
                    this.len / ((+!!this.categories + this.max - this.min) / s),
                  r = t.rotation,
                  a = m(0.8 * this.labelMetrics().h),
              ...
              getSlotWidth(t) {
                let e = this.chart,
                  ...
                  r = e.margin[3];
                if (t && R(t.slotWidth)) return t.slotWidth;
              ...
              renderUnsquish() {
                let t = this.chart,
                  ...
                  h = Math.max(
                    1,
                    Math.round(
                      n - (a ? 2 * (o.padding || 0) : o.distance || 0),
                    ),
                  ),
                  l = {},
                  d = this.labelMetrics(),
                  ...
                  u = 0;
                (W(o.rotation) || (l.rotation = o.rotation || 0),
                  ...
                  l.rotation &&
                    ...
                    c || (g = 1)),
                  (this.labelAlign =
                    o.align || this.autoLabelAlign(this.labelRotation || 0)),
                    ...
                    i &&
                      ...
                      e.shortenLabel
                        ...
                        : p &&
                            ...
                            "nowrap" !== r.whiteSpace &&
                            (p < (i.textPxLength || 0) ||
                              "DIV" === i.element.tagName)
                          ? i.css(S(a, { width: `${p}px`, lineClamp: g }))
                          : (i.styles.width ||
                              i.textWidth ||
                              i.styles.lineClamp) &&
                            !a.width &&
                            !o &&
                            i.css({ width: "auto", lineClamp: 0 }),
              ...
              addTitle(t) {
                ...
                (this.axisTitle ||
                  ...
                  a || this.axisTitle.css(F(r.style)),
              ...
              generateTick(t) {
                let e = this.ticks;
                e[t] ? e[t].addLabel() : (e[t] = new ek(this, t));
              }
              createGroups() {
              ...
              getOffset() {
                let {
                  ...
                  C;
                if (
                  ((this.showAxis = m = n || i.showEmpty),
                  (this.staggerLines =
                    (this.horiz && l.staggerLines) || void 0),
                  this.createGroups(),
                  n || this.isLinked
                    ? (this.shuffleTicks(),
                      r.forEach(this.generateTick.bind(this)),
                      this.renderUnsquish(),
                      (f = Math.abs((u = this.tickRotCorr).x)),
                      (C = this.reserveSpaceDefault =
                        0 === s ||
                        2 === s ||
                        { 1: "left", 3: "right" }[s] === this.labelAlign),
                      (l.reserveSpace ??
                        (!d && null) ??
                        ("center" === this.labelAlign || null) ??
                        C) &&
                        r.forEach(function (t) {
                          k = Math.max(o[t].getLabelSize(), k);
                        }),
                      this.staggerLines && (k *= this.staggerLines),
                      !e && R(this.labelRotation) && C && (k -= f),
                      (this.labelOffset = k * (this.opposite ? -1 : 1)))
                    : j(o, function (t, e) {
                  ...
                  h?.text &&
                    ...
                    m &&
                      ...
                      !1 !== h.reserveSpace &&
                      ((this.titleOffset = x =
                        this.axisTitle.getBBox()[e ? "height" : "width"]),
                      (b = v((y = h.offset))
                        ? 0
                        : (h.margin ?? (e ? 5 : 10))))),
                  this.renderLine(),
                  (this.offset =
                    ...
                    (R(i.offset)
                      ...
                      : c[s]
                        ? c[s] + (i.margin || 0)
                        : 0)),
                  (M = 0 === s ? -this.labelMetrics().h : 2 === s ? u.y : 0),
                  (w = Math.abs(k) + b),
                  k &&
                    ((w -= M),
                    (w +=
                      g *
                      (e
                        ? (l.y ?? u.y + g * l.distance)
                        : (l.x ??
                          (C ? g * (l.distance - f) : u.x + g * l.distance)))),
                    !e &&
                      !C &&
                      "center" === this.labelAlign &&
                      R(this.labelRotation) &&
                      (w += f)),
                  (this.axisTitleMargin = y ?? w),
                  ...
                  c[s] = Math.max(
                    c[s],
                    (this.axisTitleMargin || 0) + x + g * this.offset,
                    w,
                    r?.length && t ? t[0] + g * this.offset : 0,
                  );
                  let e =
                    !this.axisLine || i.offset
                      ? 0
                      : this.axisLine.strokeWidth() / 2;
                  p[s] = Math.max(p[s], e);
                }
              ...
              getTitlePosition(t) {
                ...
                return (
                  A(this, "afterGetTitlePosition", { titlePosition: f }),
                  f
                );
              }
              renderMinorTick(t, e) {
                let i = this.minorTicks;
                (i[t] || (i[t] = new ek(this, t, "minor")),
              ...
              render() {
                let t,
                  ...
                  y = i.axisLine,
                  b = i.showAxis,
                  v = tS(r.globalAnimation);
                if (
                  ((i.labelEdge.length = 0),
                  (i.overlap = !1),
                  [c, p, g].forEach(function (t) {
                    j(t, function (t) {
                      t.isActive = !1;
                    });
                  }),
                ...
                if (i.hasData() || h) {
                  let r = i.chart.hasRendered && i.old && R(i.old.min);
                  (i.minorTickInterval &&
                    !i.categories &&
                    ...
                    l.length &&
                      ...
                      x &&
                        (0 === i.min || i.single) &&
                        (c[-1] || (c[-1] = new ek(i, -1, null, !0)),
                        c[-1].render(-1))),
                    f &&
                      l.forEach(function (r, a) {
                        ((e = void 0 !== l[a + 1] ? l[a + 1] + x : i.max - x),
                          a % 2 == 0 &&
                            r < i.max &&
                            e <= i.max + (s.polar ? -x : x) &&
                            (g[r] || (g[r] = new n.PlotLineOrBand(i, {})),
                            (t = r + x),
                            (g[r].options = {
                ...
                ([c, p, g].forEach(function (t) {
                  ...
                  d &&
                    b &&
                    (d[d.isNew ? "attr" : "animate"](i.getTitlePosition(d)),
                    (d.isNew = !1)),
              ...
              getKeepProps() {
                return this.keepProps || eL.keepProps;
              }
              destroy(t) {
                let e = this,
                  ...
                  if (
                    ...
                    v(s) &&
                      ((r = {
                        value:
                          e &&
                          (this.isXAxis ? e.x : (e.stackY ?? e.y ?? void 0)),
                        translatedValue: s,
                      }),
                      h.polar &&
                        S(r, {
                      ...
                      () => {
                        ...
                        (e ||
                          ...
                          !h.styledMode &&
                            (e
                              .attr({
                                stroke:
                                  a.color ||
                                  (o
                                    ? eC("var(--highcharts-highlight-color-20)")
                                        .setOpacity(0.25)
                                        .get()
                            ...
                            a.dashStyle && e.attr({ dashstyle: a.dashStyle }))),
                          e.show().animate({ d: i }, tS(a?.animation)),
                          o &&
                            !a.width &&
                            e.attr({ "stroke-width": this.transA }),
                          this.cross && (this.cross.e = t));
                      },
                      ((!l || "hidden" === l.attr("visibility")) &&
                        a.showDelay) ||
                        0,
                    )));
                ...
                class s {
                  ...
                  normalizeTimeTickInterval(t, e) {
                    ...
                    for (a = 0; a < i.length; a++)
                      if (((o = ta[(s = i[a])[0]]), (r = s[1]), i[a + 1])) {
                        let e = (o * r[r.length - 1] + ta[i[a + 1][0]]) / 2;
                        if (t <= e) {
                          n = e / t;
                          break;
                        }
                      }
                    o === ta.year && t < 5 * o && (r = [1, 2, 5]);
                    let h = Y(
                      t / o,
                      r,
                      "year" === s[0] ? Math.max(O(t / o), 1) : 1,
                    );
                    return { unitRange: o, count: h, unitName: s[0], match: n };
                  }
                  getXDateFormat(t, e) {
                    let { axis: i } = this,
                      s = i.chart.time;
              ...
              function n(t) {
                ...
                if (e) {
                  ...
                  [
                    ...
                    for (o = e.length; o--; ) e[o]?.id === t && C(e, e[o]);
                  });
                }
              }
              function h(t) {
            ...
            class eD {
              ...
              render() {
                ...
                if (
                  (!i.styledMode &&
                    (w
                      ? ((C.stroke = r || "var(--highcharts-neutral-color-40)"),
                        (C["stroke-width"] = e.width ?? 1),
                        e.dashStyle && (C.dashstyle = e.dashStyle))
                      : k &&
                        ((C.fill = r || "var(--highcharts-highlight-color-10)"),
                        u &&
                          ((C.stroke = e.borderColor),
                          (C["stroke-width"] = u)))),
                  (d.zIndex = n),
                  (S += "-" + n),
                  (b = t.plotLinesAndBandsGroups[S]) ||
                    (t.plotLinesAndBandsGroups[S] = b =
                      h
                        ...
                        .attr(d)
                        .add()),
                  x || (this.svgElem = x = h.path().attr(C).add(b)),
                  v(g))
                )
                  y = t.getPlotLinePath({
                    value: o?.log2lin(g) ?? g,
                ...
                return (
                  ...
                  (M || !x.d) && y?.length
                    ...
                    : x &&
                      (y
                        ? (x.show(), x.animate({ d: y }))
                        : x.d &&
                          (x.hide(), m && (this.label = m = m.destroy()))),
                  f &&
                  (v(f.text) || v(f.formatter)) &&
                  y?.length &&
                  t.width > 0 &&
                  t.height > 0 &&
                  !y.isFlat
                    ? ((f = F(
                        {
                          align: s && k ? "center" : void 0,
                          x: s ? !k && 4 : 10,
                          verticalAlign: !s && k ? "middle" : void 0,
                          y: s ? (k ? 16 : 10) : k ? 6 : -4,
                          rotation: s && !k ? 90 : 0,
                          ...(k ? { inside: !0 } : {}),
                        },
              ...
              renderLabel(t, e, i, s) {
                ...
                let h = e.xBounds || [e[0][1], e[1][1], i ? e[2][1] : e[0][1]],
                  ...
                  c = p(l),
                  u = g(h) - d;
                (n.align(t, !1, { x: d, y: c, width: u, height: g(l) - c }),
                  (n.alignAttr.y -= r.fontMetrics(n).b),
                  (!n.alignValue || "left" === n.alignValue || v(a)) &&
                    n.css({
                      width:
                        (t.style?.width ||
                          (i && a
                            ...
                            : 90 === n.rotation
                              ...
                              : (t.clip
                                  ? o.width + o.left
                                  : o.chart.chartWidth) - n.alignAttr.x)) +
                        "px",
                    }),
                  n.show(!0));
              }
              getLabelText(t) {
                return v(t.formatter) ? t.formatter.call(this, this) : t.text;
              }
              destroy() {
            ...
            let { format: eB } = tF,
              { composed: eN, dateFormats: ez, doc: eR, isSafari: eW } = n,
              { distribute: eH } = tY,
              eG = (t) => {
            ...
            class eX {
              ...
              getAnchor(t, e) {
                ...
                return (A(this, "getAnchor", h), h.ret.map(Math.round));
              }
              getClassName(t, e, i) {
                let s = this.options,
                  o = t.series,
                ...
                return [
                  ...
                  !i && "highcharts-color-" + (t.colorIndex ?? o.colorIndex),
                  r?.className,
                ]
                  .filter(W)
                  .join(" ");
              ...
              getLabel(
                { anchorX: t, anchorY: e } = { anchorX: 0, anchorY: 0 },
              ) {
                let i = this,
                ...
                if (!this.label) {
                  if (this.outside) {
                    ...
                    ((this.container = a = n.doc.createElement("div")),
                      (a.className =
                      ...
                      (this.renderer = h =
                        new eg(a, 0, 0, e, void 0, void 0, h.styledMode)));
                  }
                  if (
                    (r
                ...
                return (
                  a && !a.parentElement && n.doc.body.appendChild(a),
                  this.label
                );
              }
              getPlayingField() {
                let { body: t, documentElement: e } = eR,
              ...
              getPosition(t, e, i) {
                    ...
                    return [i, a ? m : f, a ? t : e].concat(
                      r
                        ? [
                            ...
                            a
                              ? x.left - s + (c + h) * x.scaleX
                              : x.top - s + (p + l) * x.scaleY,
                            0,
                            a ? m : f,
                          ]
                        : [
                ...
                let M = !this.followPointer && (i.ttBelow ?? (!d && !n === w)),
              ...
              getFixedPosition(t, e, i) {
                let s = i.series,
                  ...
                  h = n.relativeTo,
                  l =
                    r.shared || (s?.yAxis?.isRadial && ("pane" === h || !h))
                      ? "plotBox"
                      : h,
                  d = "chart" === l ? o.renderer : o[l] || o.getClipBox(s, !0);
                return {
                  x: d.x + (d.width - t) * P(n.align) + n.x,
                  y:
                    d.y +
                    (d.height - e) * P(n.verticalAlign) +
                    ((!a && n.y) || 0),
                };
              }
              hide(t) {
                let e = this;
                (eG(this),
                  (t = t ?? this.options.hideDelay),
                  this.isHidden ||
                    (this.hideTimer = tt(function () {
                      let i = e.getLabel();
                      (e.getLabel().animate(
                        { opacity: 0 },
                        {
              ...
              move(t, e, i, s) {
                let { followPointer: o, options: r } = this,
                  a = tS(!o && !this.isHidden && !r.fixed && r.animation),
                  n = o || (this.len || 0) > 1,
                  h = { x: t, y: e };
                (n
                  ? (h.anchorX = h.anchorY = NaN)
                  : ((h.anchorX = i), (h.anchorY = s)),
              ...
              refresh(t, e) {
                ...
                (eG(this),
                  ...
                  (p = p && !i.allowShared),
                  (i.followPointer =
                    !i.split && h.series.tooltipOptions.followPointer));
                let g = i.getAnchor(t, e),
                  u = g[0],
                  m = g[1];
                (a &&
                  i.allowShared &&
                  (r.applyInactiveState(n),
                  n.forEach((t) => t.setState("hover")),
                  (h.points = n)),
                  (this.len = n.length));
                let x = W(l) ? eB(l, h, s) : d.call(h, i, h);
                h.points = void 0;
                let y = h.series;
                ((this.distance = y.tooltipOptions.distance ?? 16),
                  !1 === x
                    ? this.hide()
                    : (this.showTimer = tt(
                        () => {
                          if (i.split && i.allowShared) i.renderSplit(x, n);
                          else {
                            let t = u,
                              a = m;
                            if (
                              (e &&
                                r.isDirectTouch &&
                                ((t = e.chartX - s.plotLeft),
                                (a = e.chartY - s.plotTop)),
                              !(
                                s.polar ||
                                !1 === y.options.clip ||
                                n.some(
                                  (e) =>
                                    r.isDirectTouch ||
                                    e.series.shouldShowTooltip(t, a),
                                )
                              ))
                            )
                              return void i.hide();
              ...
              renderSplit(t, e) {
                let i = this,
                  {
                    ...
                    distance: p,
                    options: g,
                    options: { fixed: u, position: m, positioner: x },
                    pointer: y,
                  } = i,
                  { scrollLeft: b = 0, scrollTop: v = 0 } =
                    s.scrollablePlotArea?.scrollingContainer || {},
                  k =
                    i.outside && "number" != typeof d
                      ? eR.documentElement.getBoundingClientRect()
                      : { left: b, right: b + o, top: v, bottom: v + r },
                  w = i.getLabel(),
                  M = this.renderer || s.renderer,
                  C = !!s.xAxis[0]?.opposite,
                  { left: T, top: A } = y.getChartPosition(),
                  P = x || u,
                  L = h + v,
                  O = 0,
                  E = a - l,
                  I = function (t, e, s, o, r = [0, 0], a = !0) {
                    let n, h;
                    if (s.isHeader)
                      ((h = C ? 0 : E),
                        (n = f(
                ...
                W(t) && (t = [!1, t]);
                let D = t.slice(0, e.length + 1).reduce(function (t, s, o) {
                  if (!1 !== s && "" !== s) {
                    let r = e[o - 1] || {
                        isHeader: !0,
                        plotX: e[0].plotX,
                      ...
                      y = m.getBBox(),
                      b = y.width + m.strokeWidth();
                    l &&
                      ((O = y.height + g.header.distance),
                      (E += O),
                      C && (L -= O));
                    let { anchorX: v, anchorY: S } = (function (t) {
                      let e,
                        i,
                        {
                          isHeader: s,
                      ...
                      if (s) ((e = Math.max(n + o, n)), (i = h + a / 2));
                        ...
                        ((e = t.pos + f(o, -p, t.len + p)),
                          l.shouldShowTooltip(0, s.pos - h + r, {
                            ignoreX: !0,
                          }) && (i = s.pos + r));
                      }
                      return {
                        anchorX: (e = f(e, k.left - p, k.right + p)),
                        anchorY: i,
                      };
                    })(r);
                    if ("number" == typeof S) {
                      let e = y.height + 1,
                        s = (x || I).call(i, b, e, r, i, [v, S]);
                      t.push({
                        align: P ? 0 : void 0,
                        anchorX: v,
                        anchorY: S,
                ...
                (!P &&
                  D.some((t) => {
                    let { outside: e } = i,
                      s = (e ? T : 0) + t.anchorX;
                    return (
                      (s < k.left && s + t.boxWidth < k.right) ||
                      (s < T - k.left + t.boxWidth && k.right - s > s)
                    );
                  }) &&
                  (D = D.map((t) => {
                    let { x: e, y: i } = I.call(
                    ...
                    return S(t, { target: i, x: e });
                  })),
                  i.cleanSplit(),
                  eH(D, E));
                let B = { left: T, right: T };
                (D.forEach(function (t) {
                  let { x: e, boxWidth: s, isHeader: o } = t;
                  !o &&
                    (i.outside && T + e < B.left && (B.left = T + e),
                    i.outside && B.left + s > B.right && (B.right = T + e));
                }),
                  D.forEach(function (t) {
                    let {
                        x: e,
                    ...
                    if (i.outside && e < s) {
                      let t = T - B.left;
                      t > 0 &&
                        ((n.x = a ? (B.right - B.left) / 2 : e + t),
                        (n.anchorX = s + t));
                    }
                    t.tt.attr(n);
                  }));
                let { container: N, outside: z, renderer: R } = i;
                if (z && N && R) {
                ...
                eW && w.attr({ opacity: 1 === w.opacity ? 0.999 : 1 });
              }
              drawTracker() {
                let t = this;
                ...
                if (!i || !s) return;
                let o = { x: 0, y: 0, width: 0, height: 0 },
                  r = this.getAnchor(s),
                  a = i.getBBox();
                ((r[0] += e.plotLeft - (i.translateX || 0)),
                  ...
                  t.tracker
                    ? t.tracker.attr(o)
                    : ((t.tracker = i.renderer
                        .rect(o)
                        .addClass("highcharts-tracker")
                        .add(i)),
                      c(t.tracker.element, "mouseenter", () => eG(t)),
                      e.styledMode ||
                        t.tracker.attr({ fill: "rgba(0,0,0,0)" })));
              }
              styledModeFormat(t) {
                return t
                  .replace(
              ...
              headerFooterFormatter(t, e) {
                ...
                return (
                  A(this, "headerFormatter", a, function (e) {
                    if (
                      (r &&
                        !n &&
                        R(t.key) &&
                      ...
                      if (X(n)) {
                        let t = n;
                        ((ez[0] = (e) => i.chart.time.dateFormat(t, e)),
                          (n = "%0"));
                      }
              ...
              updatePosition(t) {
                let {
                  ...
                  { height: h = 0, width: l = 0 } = this.getLabel(),
                  { fixed: d, positioner: c } = o,
                  {
                    left: p,
                    top: g,
                    scaleX: u,
                  ...
                  x = (
                    c ||
                    (d && this.getFixedPosition) ||
                    this.getPosition
                  ).call(this, l, h, t, this),
                  y = n.doc,
                  v = (t.plotX || 0) + e.plotLeft,
                  k = (t.plotY || 0) + e.plotTop,
                  w;
                if (a && i) {
                  if (((x.x += p), (x.y += g), c || d)) {
                  ...
                  ((w = (o.borderWidth ?? +!d) + 2 * s + 2),
                    a.setSize(
                      f(l + w, 0, y.documentElement.clientWidth) - 1,
                      h + w,
                      !1,
                    ),
                    (1 !== u || 1 !== m) &&
                      (b(i, { transform: `scale(${u}, ${m})` }),
                      (v *= u),
                      (k *= m)),
                    (v += p - x.x),
                    (k += g - x.y));
                }
                this.move(Math.round(x.x), Math.round(x.y || 0), v, k);
              }
            }
            (ic = eX || (eX = {})).compose = function (t) {
              Z(eN, "Core.Tooltip") &&
                c(t, "afterInit", function () {
                  let t = this.chart;
                  t.options.tooltip &&
                    (t.tooltip = new ic(t, t.options.tooltip, this));
                });
            };
            let eF = eX,
              { defaultOptions: eY } = tm,
              { format: ej } = tF;
            class e$ {
              constructor(t, e, i) {
                ((this.formatPrefix = "point"),
                  ...
                  this.id ?? (this.id = tn()),
                  this.resolveColor(),
                  this.dataLabelOnNull ??
                    (this.dataLabelOnNull = t.options.nullInteraction),
                  t.chart.pointCount++,
              ...
              applyOptions(t, e, i) {
                ...
                return (
                  S(this, (t = e$.prototype.optionsToObject.call(this, t))),
                  this.options
              ...
              destroy(t) {
                if (!this.destroyed && !this.condemned) {
                  let e = this,
                    ...
                    o = s.hoverPoints,
                    { duration: r } = tS(
                      e.series.chart.renderer.globalAnimation,
                    ),
                    a = () => {
                      for (let t in ((e.graphic ||
                        e.graphics ||
                        e.dataLabel ||
                        e.dataLabels) &&
                        (q(e), e.destroyElements()),
                      e))
                        delete e[t];
                      this.destroyed = !0;
                    };
                  (e.legendItem && s.legend.destroyItem(e),
                    o &&
                      (e.setState(),
                      C(o, e),
                      o.length || (s.hoverPoints = void 0)),
                    e === s.hoverPoint && e.onMouseOut(),
                    r && !t && i.condemnedPoints
                      ? (i.condemnedPoints.push(this),
              ...
              destroyElements(t = { graphic: 1, dataLabel: 1 }) {
                let e,
                  i,
                  s = this,
                  o = [];
              ...
              getZone() {
                let t = this.series,
                  ...
                  s,
                  o = 0;
                for (s = e[0]; o < e.length && this[i] >= s.value; ) s = e[++o];
                return (
              ...
              isValid() {
                return (R(this.x) || this.x instanceof Date) && R(this.y);
              }
              optionsToObject(t) {
                let e = this.series,
                  i = e.options.keys,
                ...
                return (
                  (i || !e.options.data) &&
                    Object.keys(r).forEach((t) => {
                      t.indexOf(".") > 0 &&
                        (e$.prototype.setNestedProperty(r, r[t], t),
                        delete r[t]);
                    }),
                  r
                );
              ...
              resolveColor() {
                ...
                ((this.colorIndex = t.colorIndex ?? n),
                  (this.color = t.color ?? r));
              }
              ...
              update(t, e = !0, i, s) {
                ...
                function d() {
                  ...
                  (a &&
                    c &&
                    ((o.graphic = a.destroy()), delete o.hasMockGraphic),
                    X(t, !0) &&
                      (a?.element &&
                        t?.marker &&
                  ...
                  (!r.hasProcessedDataTable &&
                    ...
                    l &&
                      (l[d] =
                        X(l[d], !0) || X(t, !0) ? o.options : (t ?? l[d]))),
                    (r.isDirty = r.isDirtyData = !0),
                    "x" in p &&
                      (W(p.x) && (r.xColumnIsNumbers = void 0),
                      (o.x = r.getX(p.x)),
                        ...
                        e ||
                          o.getSelectedPoints().forEach(function (t) {
                            ...
                            t.selected &&
                              ...
                              t.setState(
                                o.hoverPoints && s.inactiveOtherPoints
                                  ? "inactive"
                                  : "",
                              ),
              ...
              manageEvent(t) {
                let e = F(this.series.options.point, this.options),
                  i = e.events?.[t];
                G(i) &&
                (!this.hcEvents?.[t] ||
                  this.hcEvents?.[t]?.map((t) => t.fn).indexOf(i) === -1)
                  ? (this.importedUserEvent?.(),
                    (this.importedUserEvent = c(this, t, i)),
                  ...
                  : this.importedUserEvent &&
                    ...
                    Object.keys(this.hcEvents) ||
                      delete this.importedUserEvent);
              }
              setState(t, e) {
                let i = this.series,
                  s = this.state,
                  o = i.options.states?.[t || "normal"] || {},
                  r = eY.plotOptions?.[i.type]?.marker && i.options.marker,
                  a = r?.enabled === !1,
                  n = r?.states?.[t || "normal"] || {},
                  h = !1 === n.enabled,
                  l = this.marker || {},
                ...
                if (
                  ...
                  if (
                    ...
                    ((u = i.pointAttribs(this, t)),
                      (f = d.options.chart.animation ?? o.animation));
                    let e = u.opacity;
                    (i.options.inactiveOtherPoints &&
                      ...
                      (this.dataLabels || []).forEach(function (t) {
                        t &&
                          ...
                          t.connector &&
                            t.connector.animate({ opacity: e }, f));
                      }),
                  ...
                  (g &&
                    this.graphic.animate(
                      g,
                      d.options.chart.animation ?? n.animation ?? r.animation,
                    ),
                    m && m.hide());
                } else
                  (t &&
                      ...
                      (m
                        ...
                        : x &&
                          ((i.stateMarkerGraphic = m =
                            d.renderer
                              .symbol(x, g.x, g.y, g.width, g.height, F(r, n))
                              .add(i.markerGroup)),
                          (m.currentSymbol = x))),
                    !d.styledMode &&
                      m &&
                ...
                (y.size && b && "hidden" !== v && !this.isCluster
                  ? (p || (i.halo = p = d.renderer.path().add(b.parentGroup)),
                    p
                      .show()
                      [e ? "animate" : "attr"]({ d: this.haloPath(y.size) }),
                    p.attr({
                      class:
                    ...
                    d.styledMode ||
                      p.attr(
                        S(
                          ...
                          tB.filterUserAttributes(y.attributes || {}),
                        ),
                      ))
                  : p?.point?.haloPath &&
                    !p.point.destroyed &&
                    p.animate({ d: p.point.haloPath(0) }, null, p.hide),
                  A(this, "afterSetState", { state: t }));
              }
              haloPath(t) {
                let e = this.pos();
                return e
            ...
            let eV = e$,
              { charts: eU, composed: eZ, isTouchDevice: e_ } = n,
              eK = (t, e) => !v(e) || t[`${e}Key`];
            class eq {
                ...
                for (let i of (t.forEach((t) => {
                  ...
                  (e.push(i),
                    ...
                    i.boosted &&
                      ...
                      e.push.apply(
                        e,
                        this.chart.series.filter(
                          (t) => t.markerGroup === i.markerGroup,
                        ),
                      ));
                }),
                this.chart.series)) {
                  ...
                  t.states?.inactive?.enabled !== !1 &&
                    (-1 === e.indexOf(i)
                      ...
                      : t.inactiveOtherPoints &&
                        i.setAllPointsToState("inactive"));
                }
              }
              destroy() {
                let t = this;
                (this.eventsToUnbind.forEach((t) => t()),
                  (this.eventsToUnbind = []),
                  !n.chartCount &&
                    (eq.unbindDocumentMouseUp.forEach((t) => t.unbind()),
                    (eq.unbindDocumentMouseUp.length = 0),
                    eq.unbindDocumentTouchEnd &&
                      (eq.unbindDocumentTouchEnd =
                        eq.unbindDocumentTouchEnd())),
                  j(t, function (e, i) {
                    t[i] = void 0;
              ...
              getSelectionMarkerAttrs(t, e) {
                ...
                return (
                  A(this, "getSelectionMarkerAttrs", i, (i) => {
                    let s,
                    ...
                    ((l.x = o.plotLeft),
                      ...
                      r &&
                        ((l.width = Math.max(1, Math.abs((s = t - n)))),
                        (l.x = (s > 0 ? 0 : s) + n)),
                      a &&
                        ((l.height = Math.max(1, Math.abs((s = e - h)))),
                        (l.y = (s > 0 ? 0 : s) + h)));
                  }),
                  i
                );
              ...
              drag(t) {
                ...
                if (
                  ...
                  let { shapeType: l, attrs: d } = this.getSelectionMarkerAttrs(
                    g,
                    u,
                  );
                  (this.hasZoom &&
                    ...
                    !p &&
                    !m &&
                    ((this.selectionMarker = m = e.renderer[l]()),
                    m
                      .attr({ class: "highcharts-selection-marker", zIndex: 7 })
                      .add(),
                    e.styledMode || m.attr({ fill: a })),
                    m && m.attr(d),
                    f && !m && c && eK(t, r) && e.pan(t, o));
                }
              }
              dragStart(t) {
                let e = this.chart;
              ...
              getSelectionBox(t) {
                ...
                return (A(this, "getSelectionBox", e), e.result);
              }
              drop(t) {
                let e,
                ...
                if (
                  ...
                  R(i.index) && (this.selectionMarker = s.destroy());
                }
                i &&
                  R(i.index) &&
                  (b(i.container, { cursor: i._cursor }),
              ...
              getChartCoordinatesFromPoint(t, e) {
                ...
                if (i && s) {
                  let r = t.clientX ?? t.plotX ?? 0,
                    a = t.plotY || 0;
                  return (
                    t.isNode && o && R(o.x) && R(o.y) && ((r = o.x), (a = o.y)),
                    e
              ...
              getHoverData(t, e, i, s, o, r) {
                let a = [],
                  n = function (t) {
                    return (
                      t.visible &&
                      !(!o && t.directTouch) &&
                      (t.options.enableMouseTracking ?? !0)
                    );
                  },
                  h = e,
                  l,
                ...
                (A(this, "beforeGetHoverData", d),
                  (l =
                    h && !h.stickyTracking
                      ? [h]
                      : i.filter(
                          (t) => t.stickyTracking && (d.filter || n)(t),
                        )));
                    ...
                    (o && !h.noSharedTooltip
                      ? (l = i.filter(function (t) {
                          ...
                          let e = t.options?.nullInteraction,
                            i = D(t.points, function (t) {
                              return t.x === c.x && (!t.isNull || !!e);
                            });
                          X(i) &&
                            (t.boosted && t.boost && (i = t.boost.getPoint(i)),
                            a.push(i));
                        })
                      : a.push(c)),
                  A(this, "afterGetHoverData", (d = { hoverPoint: c })),
              ...
              normalize(t, e) {
                let i = t.touches,
                  s = i
                    ? i.length
                      ? i.item(0)
                      : (i.changedTouches ?? t.changedTouches)[0]
                    : t;
              ...
              onContainerClick(t) {
                ...
                !e.cancelClick &&
                  (i && this.inClass(s.target, "highcharts-tracker")
                    ? (A(i.series, "click", S(s, { point: i })),
                      e.hoverPoint && i.firePointEvent("click", s))
                    : (S(s, this.getCoordinates(s)),
              ...
              onContainerMouseDown(t) {
                ...
                ((t = this.normalize(t)),
                  n.isFirefox && 0 !== t.button && this.onContainerMouseMove(t),
                  (void 0 === t.button || e) &&
                    (this.zoomOption(t),
                    e && t.preventDefault?.(),
                    this.dragStart(t)));
              ...
              onContainerMouseLeave(t) {
                let { pointer: e } = eU[eq.hoverChartIndex ?? -1] || {};
                ((t = this.normalize(t)),
              ...
              onDocumentMouseUp(t) {
                (t?.touches && this.hasPinchMoved && t?.preventDefault?.(),
                  eU[eq.hoverChartIndex ?? -1]?.pointer?.drop(t));
              }
              pinch(t) {
                let e = this,
              ...
              runPointActions(t, e, i) {
                let s = this.chart,
                  ...
                  l =
                    (!t || "touchmove" !== t.type) &&
                    (!!e || (h?.directTouch && this.isDirectTouch)),
                ...
                if (n && (i || n !== s.hoverPoint || r?.isHidden)) {
                  ...
                  ((s.hoverPoints = p),
                    ...
                    n.firePointEvent("mouseOver", void 0, () => {
                      r && n && r.refresh(u ? p : n, t);
                    }));
                } else if (g && r && !r.isHidden) {
                  let e = r.getAnchor([{}], t);
                ...
                (this.unDocMouseMove ||
                  ((this.unDocMouseMove = c(
                    ...
                    (t) =>
                      eU[
                        eq.hoverChartIndex ?? -1
                      ]?.pointer?.onDocumentMouseMove(t),
                  )),
              ...
              setDOMEvents() {
                let t = this.chart.container,
                  e = t.ownerDocument,
                  i = (t) =>
                    t.parentElement || t.getRootNode()?.host?.parentElement;
                ((t.onmousedown = this.onContainerMouseDown.bind(this)),
                  ...
                  this.eventsToUnbind.push(
                    c(t, "mouseenter", this.onContainerMouseEnter.bind(this)),
                    c(t, "mouseleave", this.onContainerMouseLeave.bind(this)),
                  ),
                  eq.unbindDocumentMouseUp.some((t) => t.doc === e) ||
                    eq.unbindDocumentMouseUp.push({
                      doc: e,
                      unbind: c(
                        e,
                        "mouseup",
                ...
                for (; s && "BODY" !== s.tagName; )
                  (this.eventsToUnbind.push(
                    ...
                    (s = i(s)));
                (this.eventsToUnbind.push(
                  c(t, "touchstart", this.onContainerTouchStart.bind(this), {
                    passive: !1,
                  }),
                  c(t, "touchmove", this.onContainerTouchMove.bind(this), {
                    passive: !1,
                  }),
                ),
                  eq.unbindDocumentTouchEnd ||
                    (eq.unbindDocumentTouchEnd = c(
                      e,
                      "touchend",
                  ...
                  c(this.chart, "redraw", this.setPointerCapture.bind(this)));
              }
              setPointerCapture() {
                if (!e_) return;
                  ...
                  1 === (t = this.normalize(t)).touches.length
                    ? ((s = o.isInsidePlot(
                        ...
                        ? (e && this.runPointActions(t),
                          ...
                          (i ?? !0) && this.pinch(t))
                        : e && this.reset(),
                      (o.tooltip?.options.followTouchMove ?? !0) &&
                        s &&
                        "touchmove" === t.type &&
                        !(o.scrollablePixelsX || o.scrollablePixelsY) &&
                        t.preventDefault())
              ...
              zoomOption(t) {
                let e = this.chart,
                  ...
                  o,
                  r;
                (/touch/.test(t.type) && (s = e.zooming.pinchType ?? s),
                  (this.zoomX = o = /x/.test(s)),
                  (this.zoomY = r = /y/.test(s)),
                  (this.zoomHor = (o && !i) || (r && i)),
                  (this.zoomVert = (r && !i) || (o && i)),
                  (this.hasZoom = (o || r) && eK(t, e.zooming.key)));
              }
            }
            ((eq.unbindDocumentMouseUp = []),
              ((ip = eq || (eq = {})).compose = function (t) {
                Z(eZ, "Core.Pointer") &&
                  c(t, "beforeRender", function () {
                    this.pointer = new ip(this, this.options);
                  });
              }));
            let eJ = eq,
              { setLength: eQ, splice: e0 } = {
              ...
              e1 = class {
                ...
                applyRowCount(t) {
                  ((this.rowCount = t),
                    j(this.columns, (e, i) => {
                      e.length !== t && (this.columns[i] = eQ(e, t));
                    }));
                }
                deleteRows(t, e = 1) {
                  if (e > 0 && t < this.rowCount) {
                    let i = 0;
                    (j(this.columns, (s, o) => {
                      ((this.columns[o] = e0(s, t, e).array), (i = s.length));
                    }),
                      (this.rowCount = i));
                  }
                  (A(this, "afterDeleteRows", { rowIndex: t, rowCount: e }),
                    (this.versionTag = tn()));
                }
                getColumn(t, e) {
                ...
                getRowObject(t, e) {
                  let i = {},
                    s = this.columns;
                  for (let o of (e ?? (e = Object.keys(this.columns)), e))
                    i[o] = s[o]?.[t];
                  return i;
                }
                setColumn(t, e = [], i = 0, s) {
                ...
                setColumns(t, e, i) {
                  ...
                  (j(t, (t, e) => {
                    ...
                    i?.silent ||
                      (A(this, "afterSetColumns"), (this.versionTag = tn())));
                }
                setRow(t, e = this.rowCount, i, s) {
                  ...
                  (j(r, (s, o) => {
                    s &&
                      (i
                        ? (s = e0(s, e, 0, !0, [t[o]]).array)
                        : (s[e] = o in t ? t[o] : s[e]),
                      (r[o] = s));
                  }),
                    this.applyRowCount(Math.max(a, this.rowCount)),
                    s?.silent ||
                      (A(this, "afterSetRows", { rowIndex: e }),
                      (this.versionTag = tn())));
                }
                getModified() {
            ...
            function ib(t, e, i) {
              ...
              if (
                ...
                u["stroke-linecap"] &&
                  (x = Math.min(s.line.strokeWidth(), n) / 2),
                n)
              ) {
                let t = [
                  ["M", x, g],
              ...
              if (m && !1 !== m.enabled && n) {
                let t = Math.min(m.radius ?? d, d);
                (0 === l.indexOf("url") &&
                  ((m = F(m, { width: h, height: h })), (t = 0)),
                  (s.symbol = f =
                    c
                      .symbol(
                        l,
            ...
            ((iy.areaMarker = function (t, e) {
              ib.call(this, t, e, !0);
            }),
              (iy.lineMarker = ib));
            let iv = e7,
              { defaultOptions: ik } = tm;
            var iw = it || (it = {});
            function iM(t, e) {
              let i = ik.plotOptions || {},
                s = e.defaultOptions,
                o = e.prototype;
              return (
                (o.type = t),
                o.pointClass || (o.pointClass = eV),
                !iw.seriesTypes[t] &&
                  (s && (i[t] = s), (iw.seriesTypes[t] = e), !0)
              );
            }
            ((iw.seriesTypes = n.seriesTypes),
              (iw.registerSeriesType = iM),
              (iw.seriesType = function (t, e, i, s, o) {
                let r = ik.plotOptions || {};
                if (
                  ((e = e || ""),
                  (r[t] = F(r[e], i)),
                  delete iw.seriesTypes[t],
                  iM(t, T(iw.seriesTypes[e] || n.Series, s)),
                  (iw.seriesTypes[t].prototype.type = t),
                  o)
                ) {
                  class e extends eV {}
                  (S(e.prototype, o),
                    (iw.seriesTypes[t].prototype.pointClass = e));
                }
                return iw.seriesTypes[t];
              }));
            let iC = it,
              { defaultOptions: iS } = tm,
              { registerEventOptions: iT } = eb,
              { svg: iA, win: iP } = n,
              { seriesTypes: iL } = iC,
              { format: iO } = tF;
            class iE {
              ...
              init(t, e) {
                ...
                let o = this.options,
                  r = !1 !== o.visible;
                (this.dataTable ??
                  (this.dataTable = H(o.dataTable)
                    ? new e1()
                    : o.dataTable?.isDataTable
                      ? o.dataTable
                      : new e1(o.dataTable)),
                  (this.linkedSeries = []),
                  this.bindAxes(),
                  ...
                  iT(this, o));
                let a = o.events;
                ((a?.click || o.point?.events?.click || o.allowPointSelect) &&
                  (t.runTrackerClick = !0),
                  this.getColor(),
                  this.getSymbol(),
                  ...
                  t.orderItems("series", tr(this, s)),
                  this.points || this.data || this.setData(o.data, !1),
                  A(this, "afterInit"));
              }
              is(t) {
                return iL[t] && this instanceof iL[t];
              }
              bindAxes() {
                let t,
                  e = this,
                  ...
                  (e.axisTypes || []).forEach(function (o) {
                    ((s[o] || []).forEach(function (s) {
                      ((t = s.options),
                        ((i[o] ?? 0) === s.index ||
                          (void 0 !== i[o] && i[o] === t.id)) &&
                          (tr(e, s.series), (e[o] = s), (s.isDirty = !0)));
                    }),
                      e[o] || e.optionalAxis === o || to(18, !0, s));
                  });
                }),
              ...
              autoIncrement(t) {
                ...
                if (
                  ((this.pointInterval = e =
                    this.pointInterval ?? i.pointInterval ?? 1),
                  o && R(t) && (e *= t),
                  s)
                ) {
                  let t = r.toParts(a);
                ...
                return o && R(t) ? a + e : ((this.xIncrement = a + e), a);
              }
              setOptions(t) {
                let e,
                  i = this.chart,
                ...
                let g = F(h, s.series, p, r),
                  ...
                  y = (x || []).map((t) => ({ ...t }));
                return (
                  (this.tooltipOptions = F(
                    iS.tooltip,
                    iS.plotOptions.series?.tooltip,
                    c?.tooltip,
                  ...
                  (u || f) &&
                    ...
                    a ||
                      ("boolean" != typeof u && (e.color = u),
                      (e.fillColor = f)),
                    y.push(e)),
                  y.length &&
                    v(y[y.length - 1].value) &&
                    y.push(
                      a ? {} : { color: this.color, fillColor: this.fillColor },
                    ),
                  A(this, "afterSetOptions", { options: g }),
                  g
                );
              }
              getName() {
                let { chart: t, options: e } = this,
                  ...
                  o = i?.y || i?.value,
                  r = W(o) ? o : o?.column;
                return s ?? (W(r) ? r : iO(t.options.lang.seriesName, this, t));
              }
              getCyclic(t, e, i) {
                let s,
                  o,
                ...
                (!e &&
                  (v(
                    (o =
                      "color" === t
                        ? (this.options.colorIndex ?? this[a])
                        : this[a]),
                  )
                    ? (s = o)
              ...
              getColor() {
                ...
                t.styledMode
                  ...
                  : this.options.colorByPoint
                    ...
                    : this.getCyclic(
                        "color",
                        this.options.color || iS.plotOptions[this.type]?.color,
                        t.options.colors,
                      );
              }
              getPointsCollection() {
              ...
              getColumn(t, e, i) {
                ...
                if ("x" === t && !r) {
                  ...
                  let t = s.getColumn("name", !0),
                    e = this.options,
                    i = (t) => {
                      if (void 0 !== this.xColumnIsNumbers)
                        return this.xColumnIsNumbers;
                      for (let e of t)
                        if ("number" != typeof e)
                          return (this.xColumnIsNumbers = !1);
                  ...
                  if (
                    ...
                    for (let i = 0; i < o; i++) {
                      ...
                      (v(s) ||
                        (this.xIncrement ??
                          (this.xIncrement = e[e.length - 1] ?? null)),
              ...
              getX(t, e) {
                return this.xAxis?.hasNames &&
                  this.dataTable.getColumn("name", !0) &&
                  v(e)
                  ? this.xAxis.nameToX({ name: e, series: this }, t)
                  : void 0 === t || (R(t) && this.options.relativeXValue)
                    ? this.autoIncrement(t)
                    : ("string" == typeof t &&
                        R((t = this.chart.time.parse(t))),
                      t);
              }
              matchPoints(t, e, i, s) {
                ...
                let y = o.getColumn("x"),
                  b = o.getColumn("id"),
                  k = n?.matchByName ? o.getColumn("name") : void 0,
                  w = o.getColumn("index");
                for (u = 0; u < o.rowCount; u++) {
                  let r = y?.[u],
                    ...
                    S = -1;
                  if (C) {
                    if (-1 === (S = C.indexOf(M, m))) {
                      let e = y?.[u],
                        i = t?.length ?? o.rowCount;
                      for (; i && t && "number" == typeof e && t[i - 1] > e; )
                        i--;
                      l.push({ newIndex: i, oldIndex: u });
                    } else
                      h[S] &&
                        (d.push({ newIndex: S, oldIndex: u }),
                        (h[S].touched = !0),
                        a && (m = S + 1));
                    (!c || u !== S || n?.enabled || this.hasDerivedData) &&
                      (p = !0);
                  } else l.push({ newIndex: u, oldIndex: u });
                }
                if (p) {
                  for (
                    d.forEach((t) => {
                    ...
                    (f = h[u]) && !f.touched && (f.destroy(), h.splice(u, 1));
                ...
                return (
                  null === this.xIncrement &&
                    M.length &&
                    ((this.xIncrement = g(M)), this.autoIncrement()),
                  !0
                );
              }
              getDataColumnKeys() {
                return (
                  this.dataColumnKeys || ["x", ...(this.pointArrayMap || ["y"])]
                );
              }
              setData(t, e = !0, i, s) {
                let o,
                  ...
                  p = n.getColumn("id"),
                  g =
                    (h.dataSorting?.matchByName && l?.map((t) => t.name)) ||
                    n.getColumn("name"),
                  u = n.getColumn("index"),
                  f = this.chart,
                  m = this.xAxis;
                if (
                  (f.options.chart.allowMutatingData ||
                  ...
                  (this.colorCounter = 0),
                  H(t) ? this.setDataFromArray(t) : this.setDataFromTable(t),
                  !1 === s ||
                    !d ||
                    this.cropped ||
                    this.hasGroupedData ||
                    !this.visible ||
                    this.boosted ||
                    (o = this.matchPoints(c, p, g, u)),
                  !o)
                ) {
                  for (
                    W(this.getColumn("y")[0]) && to(14, !0, f),
                      this.data = [],
                      r = d;
                    r--;
                  )
                  ...
                  (m && (m.minRange = m.userMinRange),
                    (this.isDirty = f.isDirtyBox = !0),
                    (this.isDirtyData = !!l),
                    (i = !1));
                }
                (H(t) && (this.options.data = this.userOptions.data = t),
                  "point" === h.legendType &&
                    ...
                    if (a) {
                      let e = s.length === a,
                        i = Array(s.length)
                          ...
                          .map(() => []);
                      for (let e of t)
                        for (let t = 0; t <= a; t++) i[t]?.push(e[t]);
                      n.setColumns(
                        (e ? r : h).reduce((t, e, s) => ((t[e] = i[s]), t), {}),
                      );
                    } else {
                      (i &&
                        ((d = i.indexOf("x")),
                      ...
                      let o = n?.[s],
                        ...
                        h = W(o)
                          ...
                          : ((o?.dataTable || 0) === e ||
                              (a && o?.dataTable === a)) &&
                            (R(o?.column)
                              ? Object.values(r)[o.column]
                              : r[o?.column || s]);
                      return (h && (i[s] = h), i);
                    }, {});
                    ((n || t) && s.setColumns(i),
                      t.isDataTable && this.bindDataTableEvents(t, i));
                  }));
              }
              bindDataTableEvents(t, e) {
                ...
                (s.push(
                  c(t, "afterSetRows", (t) => {
                    let i = t.rowIndex;
                    if (R(i)) {
                      let t = e1.prototype.getRowObject.call({ columns: e }, i),
                        s = this.data[i];
                      t &&
                  ...
                  s.push(
                    c(t, "afterDeleteRows", (t) => {
                      let { rowCount: e, rowIndex: i } = t;
                      if (R(i)) {
                        for (let t = i + e - 1; t >= i; t--)
                          this.removePoint(t, !1);
                        o();
                      }
                    }),
                  ),
                  s.push(
                    c(t, "afterSetColumns", (t) => {
              ...
              getProcessedData(t) {
                ...
                return (
                  ...
                  x !== i && (m = x.getColumn("x", !0) || []),
                  {
                    ...
                    closestPointRange: L(
                      [h ? m.map(h.log2lin) : m],
                      () => e.requireSorting && !y && to(15, !1, e.chart),
                    ),
                  }
                );
              }
              ...
              cropData(t, e, i) {
                ...
                return (
                  (l.x = s.slice(n, h)),
                  { modified: new e1({ columns: l }), start: n, end: h }
                );
              }
              generatePoints() {
                let t = this.options,
                ...
                for (h && n && (this.options.keys = !1), f = 0; f < r; f++)
                  ((g = a + f),
                    n
                      ? (((u = new o(this, i.getRowObject(f, c))).dataGroup =
                          this.groupMap?.[d + f]),
                        u.dataGroup?.options &&
                          ((u.options = u.dataGroup.options),
                          S(u, u.dataGroup.options),
                          delete u.dataLabels,
                          (u.key = u.name ?? u.category)))
                      : ((u = m[g]),
                        (x = e ? e[g] : i.getRowObject(f)),
                        u || void 0 === x
                          ? u &&
                            ((u.category =
                              this.xAxis?.categories?.[u.x] ?? u.x),
                            (u.key = u.name ?? u.category))
                          : (m[g] = u = new o(this, x, s[f]))),
                    u && ((u.index = n ? d + f : g), (l[f] = u)));
                if (((this.options.keys = h), m && (r !== (p = m.length) || n)))
                  for (f = 0; f < p; f++)
                    (f !== a || n || (f += r),
                      m[f] && (m[f].destroyElements(), (m[f].plotX = void 0)));
                ((this.data = m),
                  (this.points = l),
                  A(this, "afterGeneratePoints"));
              }
              getXExtremes(t) {
                return { min: p(t), max: g(t) };
              }
              getExtremes(t, e) {
                let { options: i, xAxis: s, yAxis: o } = this,
                  r = e || this.getExtremesFromAll || i.getExtremesFromAll,
                  a =
                    r && this.cropped
                      ? this.dataTable
                      : this.dataTable.getModified(),
                  n = a.rowCount,
                  h = t || this.stackedYData,
                  l = h
                    ? [h]
                    : (
                        this.keysAffectYAxis ||
                        this.pointArrayMap || ["y"]
                      )?.map((t) => a.getColumn(t, !0) || []) || [],
                  d = this.getColumn("x", !0),
                  c = [],
                  u = this.requireSorting && !this.is("column") ? 1 : 0,
                  f = i.cumulative && i.cumulativeStart && u && !r,
                  ...
                  w = 0;
                for (
                  s && ((k = (y = s.getExtremes()).min), (w = y.max)), v = 0;
                  v < n;
                  v++
                )
                  if (
                    ((b = d[v]),
                    (x || ((d[v + u] || b) >= k && (d[v - u] || b) <= w)) &&
                      (!f || b >= k))
                  )
                    for (let t of l) {
                      let e = t[v];
                ...
                let M = { activeYData: c, dataMin: p(c), dataMax: g(c) };
                return (A(this, "afterGetExtremes", { dataExtremes: M }), M);
              }
              applyExtremes() {
              ...
              translate() {
                this.generatePoints();
                let { hasRendered: t, options: e, xAxis: i, yAxis: s } = this,
                  { stacking: o, threshold: r } = e,
                  { polar: a } = this.chart,
                  n = this.points.concat(this.condemnedPoints),
                  h = n.length,
                  l = this.pointPlacementToXValue(),
                  d = !!l,
                  c = e.startFromThreshold ? r : 0,
                  p = e?.nullInteraction && s.len,
                  g,
                  u,
                  x,
                  y,
                ...
                let w = (t, e) => {
                    let s = i.translate(t, !1, !1, e, !0, l);
                    return R(s) ? m(k(s)) : void 0;
                  },
                  M = (t, e, i) => {
                    if (R(t) && void 0 !== e.plotX) {
                      let e = s.translate(t, !1, !0, i, !0);
                      return R(e) ? k(e) : void 0;
                    }
                    if (!R(t) && p) return p;
                  };
                for (g = 0; g < h; g++) {
                  ...
                  ((e.plotX = u = w(h)),
                    o &&
                      ...
                      T &&
                      T[h] &&
                      ((y = this.getStackIndicator(y, h, this.index)),
                      !e.isNull && y.key && (f = (p = T[h]).points[y.key]),
                      p &&
                        H(f) &&
                        ((S = f[0]),
                        (C = f[1]),
                        S === c &&
                          y.key === T[h].base &&
                          (S = R(r) ? r : s.min),
                        s.positiveValuesOnly && v(S) && S <= 0 && (S = void 0),
                        (e.total = e.stackTotal = p.total ?? void 0),
                        (e.percentage =
                          v(e.y) && p.total ? (e.y / p.total) * 100 : void 0),
                        (e.stackY = C),
                    ...
                    (e.yBottom = v(S)
                      ? k(s.translate(S, !1, !0, !1, !0))
                      : void 0),
                    this.dataModify && (C = this.dataModify.modifyValue(C, g)),
                    (e.plotY = M(C, e)),
                    (e.origin =
                      !t || e.graphic || a
                        ? void 0
                    ...
                    (e.clientX = d ? m(i.translate(h, !1, !1, !1, !0, l)) : u),
                    (e.negative = (e.y || 0) < (r || 0)),
                    !e.isNull &&
                      !1 !== e.visible &&
                      R(u) &&
                      (R(x) && (b = Math.min(b, Math.abs(u - x))), (x = u)),
                    (e.zone = this.zones.length ? e.getZone() : void 0));
                }
                ((this.closestPointRangePx = b), A(this, "afterTranslate"));
              }
              ...
              setClip() {
                ...
                (d ? d.animate(n) : (r[l] = d = a.clipRect(n)),
                  ...
                  i?.clip(),
                  o?.clip(
                    h && this.yAxis.clippable ? t.plotClipInner : void 0,
                  ));
              }
              animate(t) {
                let { chart: e, group: i, markerGroup: s } = this,
                  o = e.inverted,
                  r = tS(this.options.animation),
                  a = [
              ...
              afterAnimate() {
                (this.setClip(),
                  j(this.chart.sharedClips, (t, e, i) => {
                    t &&
              ...
              drawPoints(t) {
                ...
                let h = this.chart,
                  ...
                  m =
                    p.enabled ??
                    (!f || !!f.isRadial || null) ??
                    (this.closestPointRangePx ?? -1 / 0) >=
                      (p.enabledThreshold ?? 2) * p.radius;
                if (!1 !== p.enabled || this._hasPointMarkers)
                  for (e = 0; e < t.length; e++) {
                    ...
                    let c = i.isNull;
                    if (
                      ((m && !v(r.enabled)) || r.enabled) &&
                      (!c || g) &&
                      !1 !== i.visible
                    ) {
                      let t = r.symbol ?? this.symbol ?? "rect";
              ...
              markerAttribs(t, e) {
                ...
                (e &&
                  ...
                  (h = o.states?.[e]),
                  (l =
                    h?.radius ?? n?.radius ?? (l && l + (n?.radiusPlus || 0)))),
              ...
              pointAttribs(t, e) {
                let i = this.options,
                  ...
                  d,
                  c,
                  p = r.lineWidth ?? s.lineWidth,
                  g = t?.isNull && i.nullInteraction ? 0 : 1;
                ((l = a || h || n || l),
                  (d = r.fillColor || s.fillColor || l),
                  (c = r.lineColor || s.lineColor || l),
                  (e = e || "normal"));
                let u = s.states?.[e] || {},
                  f = r.states?.[e] || {};
                return (
                  (p =
                    f.lineWidth ??
                    u.lineWidth ??
                    (p || 0) + (f.lineWidthPlus ?? u.lineWidthPlus ?? 0)),
                  (d = f.fillColor || u.fillColor || d),
                  (c = f.lineColor || u.lineColor || c),
                  (g = f.opacity ?? u.opacity ?? g),
                  {
                    stroke: c,
                    "stroke-width": p,
                    fill: d,
                    opacity: t?.condemned || t?.isInside === !1 ? 0 : g,
                  }
                );
              }
              destroy(t) {
                let e,
                  ...
                  s = this,
                  o = s.chart,
                  r = /AppleWebKit\/533/.test(iP.navigator.userAgent),
                  a = s.data || [];
                for (
                  A(s, "destroy", { keepEventsForUpdate: t }),
                    this.removeEvents(t),
                    (s.axisTypes || []).forEach(function (t) {
                      ((i = s[t]),
                        i?.series &&
                          (C(i.series, s), (i.isDirty = i.forceRedraw = !0)));
                    }),
                  ...
                  a[e]?.destroy?.(!0);
                for (let t of s.zones || []) k(t, void 0, !0);
                (B(s.animationTimeout),
                  j(s, function (t, e) {
                    t instanceof tq &&
                      !t.survive &&
              ...
              applyZones() {
                ...
                if (s.length && (i || t) && d && R(d.min)) {
                  ...
                  let x = [],
                    y = d.toPixels(d.getExtremes().min - g, !0);
                  s.forEach((e) => {
                    let s = e.lineClip || [],
              ...
              render() {
                ...
                (A(this, "render"),
                  e.plotClipInner &&
                    (t.plotClipGroup ||
                      (t.plotClipGroup = e.renderer.g().add(n))),
              ...
              searchKDTree(t, e, i, s, o) {
                let r = this,
                  ...
                  h = e ? "distX" : "dist",
                  l =
                    (r.options.findNearestPointBy || "").indexOf("y") > -1
                      ? 2
                      : 1,
                  d = !!r.isBubble,
                  c =
                ...
                if (
                  ...
                  return (function t(e, i, s, o) {
                    ...
                    ((l = e[a]),
                      ...
                      (b.dist = Math.sqrt(((u && u * u) || 0) + x * x) - y),
                      (b.distX = v(u) ? Math.abs(u) - y : Number.MAX_VALUE));
                    let C =
                        (e[k] || 0) -
                        (b[k] || 0) +
                        ((d && b.marker?.radius) || 0),
                      ...
                      T = C < 0 ? "right" : "left";
                    return (
                      i[S] && ([w, M] = c(b, t(e, i[S], s + 1, o), h)),
                      i[T] &&
                        p(Math.sqrt(C * C), w[h], M) &&
                        (w = c(w, t(e, i[T], s + 1, o), h)[0]),
                      w
                    );
                  })(t, this.kdTree, l, l);
              }
              pointPlacementToXValue() {
                ...
                return (
                  ...
                  R(i) ? i * (t.pointRange || e.pointRange) : 0
                );
              }
              isPointInside(t) {
              ...
              drawTracker() {
                let t = this,
                  ...
                  l = "rgba(192,192,192," + (iA ? 1e-4 : 0.002) + ")",
                  d = t.tracker;
                (d
                  ? d.attr({ d: s })
                  : t.graph &&
              ...
              addPoint(t, e, i, s, o) {
                let r,
                  ...
                  u = this.getColumn("x");
                e = e ?? !0;
                let { applyOptions: f, optionsToObject: m } =
                    this.pointClass.prototype,
                  x = { series: this },
                  y = m.call(x, t);
                f.call(x, y, void 0, !1);
                let b = x.x;
                if (((a = u.length), this.requireSorting && b < u[a - 1]))
                  for (r = !0; a && u[a - 1] > b; ) a--;
                (d.setRow(y, a, !0),
                  this.xColumn?.splice(a, 0, this.getX(b)),
                  p && x.name && (p[b] = x.name),
                  g?.splice(a, 0, t),
                  (r || this.hasProcessedDataTable) &&
                    (this.data.splice(a, 0, null), this.processData()),
                  "point" === n.legendType && this.generatePoints(),
                  i &&
                    (l[0] && l[0].remove
                      ? l[0].remove(!1)
                      : ([l, g, this.xColumn].filter(v).forEach((t) => {
                          t.shift();
                        }),
                        d.deleteRows(0))),
                  !1 !== o && A(this, "addPoint", { point: x }),
                  (this.isDirty = !0),
                  (this.isDirtyData = !0),
                  e && h.redraw(s));
              }
              ...
              remove(t, e, i, s) {
                ...
                !1 !== i ? A(o, "remove", null, a) : a();
              }
              update(t, e) {
                A(this, "update", { options: (t = M(t, this.userOptions)) });
                let i = this,
                  s = i.chart,
                  o = i.userOptions,
                ...
                ((u = u || r),
                  f
                    ? (g.push.apply(g, iE.keepPropsForPoints),
                      !1 !== t.visible &&
                        (g.push("area", "graph"),
                        "zones" in t || g.push("zones")),
                      i.parallelArrays.forEach(function (t) {
                        g.push(t + "Data");
                      }),
                      d &&
                        (t.dataSorting &&
                          S(i.options.dataSorting, t.dataSorting),
                        this.setData(d, !1)))
                    : (this.dataTable.modified = this.dataTable),
                  t.dataLabels &&
                    o.dataLabels &&
                    (t.dataLabels = this.mergeArrays(
                      o.dataLabels,
                      t.dataLabels,
                    )),
                  (t = F(
                    ...
                    !f && { data: i.options.data },
                    t,
                    h,
                  )),
                  f && t.data && (t.data = i.options.data),
                  (g = [
                    "dataLabelsGroup",
                    "dataLabelsGroups",
                ...
                if (iL[u]) {
                  if (((m = u !== i.type), i.remove(!1, !1, !1, !0), m))
                    if ((s.propFromSeries(), Object.setPrototypeOf))
                      Object.setPrototypeOf(i, iL[u].prototype);
                    else {
                      let t =
                ...
                } else to(17, !0, s, { missingModuleFor: u });
                if (
                ...
                ((i.initialType = r),
                  s.linkSeries(),
                  m && i.linkedSeries.length && (i.isDirtyData = !0),
                  A(this, "afterUpdate"),
                  (e ?? !0) && s.redraw(!!f && void 0));
              }
              setName(t) {
              ...
              hasOptionChanged(t) {
                let e = this.chart,
                  ...
                  r = s?.[this.type]?.[t] ?? s?.series?.[t];
                return o && !v(r) ? i !== o : i !== (r ?? i);
              }
              onMouseOver() {
                let t = this.chart,
                  e = t.hoverSeries,
                ...
                if (
                  ...
                  if (
                    (t &&
                      ((h =
                        a[t]?.lineWidth ??
                        (R(h) ? h + (a?.[t]?.lineWidthPlus || 0) : void 0)),
                      (l = a[t]?.opacity ?? l)),
                    s && !s.dashstyle && R(h))
                  )
              ...
              setAllPointsToState(t) {
                this.points.forEach((e) => e.setState?.(t));
              }
              setVisible(t, e) {
                let i = this,
                  s = i.chart,
              ...
              drawLegendSymbol(t, e) {
                let i = this.chart.renderer,
                  ...
                  g =
                    "rectangle" === s
                      ? i.rect(d, c, l, a, p)
                      : i.symbols[s] && i.symbol(s, d, c, l, a, { r: p });
                g
                  ? (o.symbol = g
                      .addClass("highcharts-point")
                      .attr({ zIndex: 3 })
            ...
            ((iE.defaultOptions = {
              ...
              (iE.types = iC.seriesTypes),
              (iE.registerType = iC.registerSeriesType),
              (iE.keepProps = [
                "colorIndex",
                "eventOptions",
                "navigatorSeries",
              ...
              (iC.series = iE));
            let iI = iE,
              { registerEventOptions: iD } = eb,
              { composed: iB, marginNames: iN } = n,
              { distribute: iz } = tY,
              { format: iR } = tF;
            class iW {
              constructor(t, e) {
              ...
              setOptions(t) {
                ...
                ((this.options = t),
                  ...
                  (this.symbolWidth = t.symbolWidth ?? 16),
                  (this.pages = []),
                  (this.proximate =
              ...
              update(t, e) {
                let i = this.chart;
                (this.setOptions(F(!0, this.options, t)),
                  "events" in this.options && iD(this, this.options),
                  this.destroy(),
                  (i.isDirtyLegend = i.isDirtyBox = !0),
                  (e ?? !0) && i.redraw(),
                  A(this, "afterUpdate", { redraw: e }));
              }
              colorizeItem(t, e) {
                let i = t.color,
                  {
                ...
                if (
                  ((t instanceof iI || t instanceof eV) &&
                  ...
                  let { itemHiddenStyle: i = {} } = this,
                    ...
                    d = (t) => (
                      !e &&
                        (t.fill && (t.fill = o), t.stroke && (t.stroke = o)),
                      t
                    );
                  (r?.css(F(e ? this.itemStyle : i)),
                    a?.attr(d({ stroke: l || t.color })),
                    n?.attr(
                      d(
                        t.series
                          ? t.series.pointAttribs?.(t)
                          : t.pointAttribs?.() || { fill: t.color },
                      ),
                    ),
                    s?.attr(
                      d({
                ...
                ((t.color = i),
                  A(this, "afterColorizeItem", { item: t, visible: e }));
              }
              positionItems() {
              ...
              positionItem(t) {
                ...
                if (e?.element) {
                  let o = {
                    ...
                    n = () => {
                      A(this, "afterPositionItem", { item: t });
                    };
                  e[v(e.translateY) ? "animate" : "attr"](o, void 0, n);
                }
                n && ((n.x = i), (n.y = s));
              }
              destroyItem(t) {
                ...
                for (let t of ["group", "label", "line", "symbol"])
                  e[t] && (e[t] = e[t].destroy());
                ((t.checkbox = w(t.checkbox)), (t.legendItem = void 0));
              }
              destroy() {
              ...
              setText(t) {
                ...
                t.legendItem.label.attr({
                  text: e.labelFormat
                    ? iR(e.labelFormat, t, this.chart)
                    : e.labelFormatter.call(t, t),
                });
              }
              renderItem(t) {
                ...
                (!y &&
                  ...
                  i.styledMode || y.css(F(t.visible ? h : l)),
                  y
                  ...
                  !this.baseline &&
                    ...
                    o.squareSymbol &&
                      ((this.symbolWidth =
                        o.symbolWidth ?? Math.max(this.symbolHeight, 16)),
                    ...
                    y.css({
                      width:
                        Math.min(
                          ...
                          o.maxWidth ? _(o.maxWidth, i.chartWidth) : 1 / 0,
                        ) -
                        b +
                        "px",
                    }),
              ...
              getAllItems() {
                ...
                return (
                  this.chart.series.forEach(function (e) {
                    let i = e?.options;
                    e &&
                      (i.showInLegend ?? !v(i.linkedTo)) &&
                      (t = t.concat(
                        e.legendItem?.labels ||
                          ("point" === i.legendType ? e.data : e),
                      ));
                  }),
                  A(this, "afterGetAllItems", { allItems: t }),
                  t
                );
              }
              getAlignment() {
              ...
              proximatePositions() {
                ...
                iz(i, e.plotHeight)))
                  ((t = o.item.legendItem || {}),
                    R(o.pos) && (t.y = e.plotTop - e.spacing[0] + o.pos));
              }
              render() {
                let t = this.chart,
                ...
                ((this.itemX = o),
                  ...
                  (this.offsetWidth = 0),
                  (this.lastItemY = 0),
                  (this.widthOption = _(s.width, e - o)),
                  (d = e - 2 * o - s.x),
                  ...
                  l ||
                    ((this.group = l =
                      i
                        ...
                        .attr({ zIndex: 7 })
                        .add()),
                    (this.contentGroup = i.g().attr({ zIndex: 1 }).add(l)),
                    (this.scrollGroup = i.g().add(this.contentGroup))),
                  this.renderTitle(),
                  Q(
                    r,
                    (t, e) =>
                      (t.options?.legendIndex || 0) -
                      (e.options?.legendIndex || 0),
                  ),
                  ...
                  n > 0 &&
                    ...
                    c[c.placed ? "animate" : "attr"](
                      c.crisp.call(
                        {},
                        { x: 0, y: 0, width: n, height: h },
                        c.strokeWidth(),
                      ),
                    ),
                  l[a ? "show" : "hide"](),
                  t.styledMode &&
                    "none" === l.getStyle("display") &&
                    (n = h = 0),
                  (this.legendWidth = n),
                  (this.legendHeight = h),
                  a && this.align(),
              ...
              handleOverflow(t) {
                let e = this,
                  ...
                  u = function (t) {
                    ("number" == typeof t
                      ? w.attr({ height: t })
                      : w &&
                        ((e.clipRect = w.destroy()), e.contentGroup.clip()),
                      e.contentGroup.div &&
                ...
                return (
                  ...
                  t && v > 0 && t > v && !1 !== l.enabled
                    ? ((this.clipHeight = m =
                        Math.max(v - 20 - this.titleHeight - n, 0)),
                      ...
                      w ||
                        ((w = e.clipRect = s.clipRect(0, n - 2, 9999, 0)),
              ...
              scroll(t, e) {
                ...
                (l > o && (l = o),
                  l > 0 &&
                    ...
                    tt(
                      () => {
                        A(this, "afterScroll", { currentPage: l });
                      },
                      tS(e ?? i.renderer.globalAnimation ?? !0).duration,
                    )));
              }
              setItemEvents(t, e, i) {
                let s = this,
                  ...
                  n = t instanceof iI,
                  h =
                    "highcharts-legend-" + (a ? "point" : "series") + "-active",
                  ...
                  i &&
                    i
                      ...
                      .on("mouseout", function () {
                        (s.chart.styledMode ||
                          e.css(F(t.visible ? s.itemStyle : s.itemHiddenStyle)),
                          c(""),
                          r.removeClass(h),
                          t.setState());
                      })
                      .on("click", function (e) {
                        ...
                        (r.removeClass(h),
                          A(
                            s,
                            "itemClick",
                            { browserEvent: e, legendItem: t, context: s },
                            i,
                          ),
                          a
                            ...
                            : n &&
                              A(t, "legendItemClick", { browserEvent: e }));
                      });
              }
            ...
            (ig = iW || (iW = {})).compose = function (t) {
              Z(iB, "Core.Legend") &&
                c(t, "beforeMargins", function () {
                  this.legend = new ig(this, this.options.legend);
                });
            };
            let iH = iW,
              { defaultOptions: iG } = tm,
              { numberFormat: iX } = tF,
              { registerEventOptions: iF } = eb,
              { charts: iY, doc: ij, marginNames: i$, win: iV } = n,
              { seriesTypes: iU } = iC;
            class iZ {
              static chart(t, e, i) {
                let s = new iZ(t, e, i);
              ...
              constructor(t, e, i) {
                if (((this.sharedClips = {}), !ij))
                  return void to(36, !1, this);
                const s = [...arguments];
                ((W(t) || t.nodeName) && (this.renderTo = s.shift()),
                  this.init(s[0], s[1]));
              }
              setZoomOptions() {
              ...
              init(t, e) {
                A(this, "init", { args: arguments }, function () {
                  ...
                  ((this.userOptions = S({}, t)),
                    (this.renderTo = W(o) ? ij.getElementById(o) : o) ||
                      to(13, !0, this),
                    (this.margin = []),
                    (this.spacing = []),
                    ...
                    (this.time = new tp(
                      S(i.time || {}, { locale: this.locale }),
                      i.lang,
                    )),
                    (i.time = this.time.options),
                    (this.numberFormatter = (s.numberFormatter || iX).bind(
                      this,
                    )),
                    (this.styledMode = s.styledMode),
                    (this.hasCartesianSeries = s.showAxes),
                    (this.index = iY.length),
              ...
              getDataTable(t) {
                return (t.dataTable ? J(t.dataTable) : []).map((t) =>
                  t.isDataTable ? t : new e1(t),
                );
              }
              initSeries(t) {
                let e = this.options.chart,
                  i = t.type || e.type,
                  s = iU[i];
                s || to(17, !0, this, { missingModuleFor: i });
                let o = new s();
                return ("function" == typeof o.init && o.init(this, t), o);
              }
              orderItems(t, e = 0) {
                let i = this[t],
                  s = (this.options[t] = J(this.options[t]).slice()),
                  o = (this.userOptions[t] = this.userOptions[t]
                    ? J(this.userOptions[t]).slice()
                    : []);
                if ((this.hasRendered && (s.splice(e), o.splice(e)), i))
                  for (let t = e, r = i.length; t < r; ++t) {
                    ...
                    e &&
                      ((e.index = t),
                      e instanceof iI && (e.name = e.getName()),
                      e.options.isInternal ||
              ...
              getClipBox(t, e) {
                let i = this.inverted,
                  { xAxis: s, yAxis: o } = t || {},
                  { x: r, y: a, width: n, height: h } = F(this.clipBox);
                return (
                  t &&
                    (s &&
                      s.len !== this.plotSizeX &&
                      !s.isRadial &&
                      (n = s.len),
                    o && o.len !== this.plotSizeY && !o.isRadial && (h = o.len),
                    i && !t.invertible && ([n, h] = [h, n])),
                  e &&
                    ((r += (i ? o : s)?.pos ?? this.plotLeft),
              ...
              isInsidePlot(t, e, i = {}) {
                ...
                return (A(this, "afterIsInsidePlot", u), u.isInsidePlot);
              }
              redraw(t) {
                A(this, "beforeRedraw");
                ...
                for (
                  ...
                  if (
                    ((g = i[c]).options.stacking ||
                      g.options.centerInCategory) &&
                    ((d = !0), g.isDirty)
                  ) {
                    l = !0;
                    break;
                  ...
                  (t.isDirty &&
                    ("point" === t.options.legendType
                      ? ("function" == typeof t.updateTotals &&
                          t.updateTotals(),
                        (p = !0))
                      : r && (r.labelFormatter || r.labelFormat) && (p = !0)),
                    t.isDirtyData && A(t, "updatedData"));
                }),
                  p &&
                    o &&
                    o.options.enabled &&
                ...
                (e.forEach(function (t) {
                  ...
                  A(this, "predraw"),
                  i.forEach(function (t) {
                    ((u || t.isDirty) && t.visible && t.redraw(),
                      (t.isDirtyData = !1));
                  }),
                  s && s.reset(!0),
                  a.draw(),
              ...
              get(t) {
                ...
                let s = D(this.axes, i) || D(this.series, i);
              ...
              createAxes() {
                ...
                for (let e of (A(this, "createAxes"), ["xAxis", "yAxis"]))
                  for (let i of (t[e] = J(t[e] || {}))) new eL(this, i, e);
                A(this, "afterCreateAxes");
              }
              getSelectedPoints() {
                ...
                (["title", "subtitle", "caption"].forEach((t) => {
                  ...
                  if (i && r) {
                    ...
                    let o = s.fontMetrics(i),
                      ...
                      f = Math.max(p, u),
                      m = F({ y: "bottom" === d ? h : g + h }, r),
                      x =
                        (r.width || (u > p ? this.chartWidth : a.width) / f) +
                        "px";
                    (m.align ??
                      (m.align =
                        "title" === t
                    ...
                    let y = Math.round(
                      i.css({ width: x }).getBBox(r.useHTML).height,
                    );
                    if (
                      ((m.height = y),
                      i.align(m, !1, a).attr({
                        ...
                        scaleX: f,
                        scaleY: f,
                        "transform-origin": `${a.x + n * f * P(m.align)} ${l}`,
                      }),
                      !r.floating)
                    ) {
                      let t = y * (y < 1.2 * l ? 1 : f);
              ...
              getContainerBox() {
                let t = [].map.call(this.renderTo.children, (t) => {
                  ...
                  e = {
                    width: I(this.renderTo, "width", !0) || 0,
                    height: I(this.renderTo, "height", !0) || 0,
                  };
                return (
              ...
              getChartSize() {
                ...
                ((this.chartWidth = Math.max(0, e || s.width || 600)),
                  (this.chartHeight = Math.max(
                    0,
                    _(i, this.chartWidth) || (o ? 400 : s.height),
                  )),
                  (this.containerBox = s));
              }
              temporaryDisplay(t) {
                ...
                if (t)
                  for (; e?.style; )
                    (e.hcOrigStyle &&
                      (b(e, e.hcOrigStyle), delete e.hcOrigStyle),
                      e.hcOrigDetached &&
                        (ij.body.removeChild(e), (e.hcOrigDetached = !1)),
                      (e = e.parentNode));
                else
                  for (
                    ;
                    ...
                    (ij.body.contains(e) ||
                      e.parentNode ||
                      ((e.hcOrigDetached = !0), ij.body.appendChild(e)),
                    ("none" === I(e, "display", !1) || e.hcOrigDetached) &&
                      ((e.hcOrigStyle = {
              ...
              getContainer() {
                let t,
                  ...
                  r = this.renderTo,
                  a = U(u(r, s));
                (R(a) && iY[a] && iY[a].hasRendered && iY[a].destroy(),
                  u(r, s, this.index),
                  (r.innerHTML = tB.emptyHTML),
                ...
                if (
                  ...
                  h !== this.chartWidth &&
                    ((h = this.chartWidth),
                    this.styledMode ||
                      b(l, { width: i.style?.width ?? h + "px" })),
                  (this._cursor = l.style.cursor),
                  (this.renderer = new eg(
                    l,
                    h,
                    n,
                    void 0,
                  ...
                  (this.renderer.setStyle(i.style),
                    (this.palette = this.renderer.palette));
              ...
              setChartSize(t) {
                ...
                if (
                  ...
                  (this.plotWidth = s =
                    Math.max(0, Math.round(a - e - (this.marginRight ?? 0)))),
                  (this.plotHeight = o =
                    Math.max(0, Math.round(r - i - (this.marginBottom ?? 0)))),
                ...
                A(this, "afterSetChartSize", { skipAxes: t });
              }
              resetMargins() {
                A(this, "resetMargins");
                let t = this,
              ...
              drawChartBox() {
                ...
                (v ||
                  ((t.chartBackground = v =
                    y.rect().addClass("highcharts-background").add()),
                  (T = "attr")),
                  b
                    ? (M = C = v.strokeWidth())
                    : ((C = (M = e.borderWidth || 0) + 8 * !!a),
                      (S = { fill: i || "none" }),
                      (M || v["stroke-width"]) &&
                        ((S.stroke = e.borderColor), (S["stroke-width"] = M)),
                      v.attr(S).shadow(a)),
                  v[T]({
                    x: C / 2,
                    y: C / 2,
                  ...
                  k ||
                    ((T = "attr"),
                    (t.plotBackground = k =
                      y.rect().addClass("highcharts-plot-background").add())),
                  k[T]({ ...g, r: r }),
                  !b &&
                    (k.attr({ fill: s || "none" }).shadow(e.plotShadow),
                    o &&
                      (p
                        ? (o !== p.attr("href") && p.attr("href", o),
                          p.animate(g))
                        : (t.plotBGImage = y.image(o, u, f, m, x).add()))),
                  c
                    ? c.animate({ width: l.width, height: l.height })
              ...
              propFromSeries() {
                ...
                ["inverted", "angular", "polar"].forEach(function (a) {
                  for (
                    ...
                    (e = iU[r[t].type]) && e.prototype[a] && (i = !0);
                  s[a] = i;
                });
              }
              linkSeries(t) {
                ...
                (i.forEach(function (t) {
                  ...
                  i.forEach(function (t) {
                    let { linkedTo: s } = t.options,
                      o =
                        W(s) && (":previous" === s ? i[t.index - 1] : e.get(s));
                    o &&
                      o.linkedParent !== t &&
                      (o.linkedSeries.push(t),
                      (t.linkedParent = o),
                      (t.visible =
                        t.options.visible ?? o.options.visible ?? t.visible));
                  }),
                  A(this, "afterLinkSeries", { isUpdating: t }));
              }
              renderSeries() {
                this.series.forEach(function (t) {
              ...
              render() {
                let t = this.axes,
                  e = this.colorAxis,
                  i = this.renderer,
                  { axisLayoutRuns: s = 2, plotBorderRadius: o } =
                    this.options.chart,
                  r = (t) => {
                    t.forEach((t) => {
                      t.visible && t.render();
                ...
                for (
                  this.plotHeight = Math.max(this.plotHeight - a, 0);
                  (n || h || s > 1) && l < s;
                ) {
              ...
              addCredits(t) {
                ...
                i.enabled &&
                  ...
                  ((this.credits = this.renderer
                    ...
                    .on("click", function (t) {
                      A(e, "creditsClick", t, () => {
                        i.href && (iV.location.href = i.href);
                      });
                    })
                    .attr({ align: i.position.align, zIndex: 8 })),
                  i.events?.click && c(e, "creditsClick", i.events.click),
              ...
              destroy() {
                ...
                for (
                  A(e, "destroy"),
                    e.renderer.forExport ? C(iY, e) : (iY[e.index] = void 0),
                    n.chartCount--,
                  ...
                  i[t] = i[t].destroy();
                for (this.scroller?.destroy?.(), t = s.length; t--; )
                  s[t] = s[t].destroy();
                ([
                  "title",
                  "subtitle",
                  ...
                  o && ((o.innerHTML = tB.emptyHTML), q(o), r && w(o)),
                  j(e, function (t, i) {
                    delete e[i];
                  }));
              }
              ...
              warnIfA11yModuleNotLoaded() {
                ...
                t &&
                  ...
                  (this.renderer.boxWrapper.attr({
                    role: "img",
                    "aria-label": (e?.element.textContent || "").replace(
                      /</g,
                      "&lt;",
                    ),
                  }),
              ...
              warnIfCSSNotLoaded() {
                this.styledMode &&
                  "0" !== iV.getComputedStyle(this.container).zIndex &&
                  to(35, !1, this);
              }
              addSeries(t, e, i) {
                let s,
                ...
                return (
                  t &&
                    ((e = e ?? !0),
                    A(o, "addSeries", { options: t }, function () {
                      ((s = o.initSeries(t)),
                        (o.isDirtyLegend = !0),
                        o.linkSeries(),
                        A(o, "afterAddSeries", { series: s }),
                        e && o.redraw(i));
                    })),
                  s
                );
              ...
              createAxis(t, e) {
                let i = new eL(this, e.axis, t);
                return ((e.redraw ?? !0) && this.redraw(e.animation), i);
              }
              showLoading(t) {
                let e = this,
                  i = e.options,
                ...
                (a ||
                  ...
                  tB.setElementHTML(n, t ?? i.lang.loading ?? ""),
                  !e.styledMode &&
                    (b(a, S(o, { zIndex: 10 })),
                    b(n, s?.labelStyle ?? {}),
                    e.loadingShown ||
                      (b(a, { opacity: 0, display: "" }),
                      tA(
                        a,
              ...
              update(t, e, i, s) {
                let o,
                  ...
                  d = [],
                  c = {
                    options: (t = M(t, n.options)),
                    hasChanged: !!Object.keys(t).length,
                  };
                if ((A(n, "update", c), !c.hasChanged)) return;
                (l || n.setResponsive(!1, !0),
                  (n.userOptions = F(n.userOptions, t)));
                let p = t.chart;
                (p &&
                  (F(!0, n.options.chart, p),
                  this.setZoomOptions(),
                  "className" in p && n.setClassName(p.className),
                  ("inverted" in p || "polar" in p || "type" in p) &&
                    (n.propFromSeries(), (o = !0)),
                  "alignTicks" in p && (o = !0),
                  "events" in p && iF(this, p),
                  j(p, function (t, e) {
                      ...
                      (J(t[e]).forEach((t, s) => {
                        ...
                        (r && (o = n.get(t.id)),
                          !o &&
                            n[e] &&
                            (o = n[e][t.index ?? s]) &&
                            ((r && v(o.options.id)) || o.options.isInternal) &&
                            (o = void 0),
                          o &&
                            o.coll === e &&
                ...
                let g = p?.width,
                  u =
                    p &&
                    (W(p.height) ? _(p.height, g || n.chartWidth) : p.height);
                (a ||
                (R(g) && g !== n.chartWidth) ||
                (R(u) && u !== n.chartHeight)
                  ? n.setSize(g, u, s)
                  : (e ?? !0) && n.redraw(s),
                  A(n, "afterUpdate", { options: t, redraw: e, animation: s }));
              }
              setSubtitle(t, e) {
                ...
                let t = this,
                  ...
                  o =
                    "chart" === i.relativeTo || "spacingBox" === i.relativeTo
                      ? void 0
                      : "plotBox";
                (A(this, "beforeShowResetZoom", void 0, () => {
                  t.resetZoomButton = t.renderer
                    .button(e.resetZoom, 0, 0, () => t.zoomOut(), s)
              ...
              zoomOut() {
                A(this, "selection", { resetSelection: !0 }, () =>
              ...
              transform(t) {
                let {
                  ...
                  { time: l } = this;
                (this.hoverPoints?.forEach((t) => t.setState()),
                  A(this, "transform", t));
                let d = t.hasZoomed || !1,
                  c,
                  p;
                for (let t of e) {
                  let {
                    ...
                    M = (s[y] || 0) + k / 2 - t.pos,
                    C = M - ((a[y] ?? t.pos) + b / 2 - t.pos) / w,
                    T = (e && !m) || (!e && m) ? 1 : -1;
                  if (!o && (M < 0 || M > t.len)) continue;
                  let A =
                      r || t.chart.polar || (t.isOrdinal && w <= 1)
                        ? 0
                        : u * T || 0,
                    P = t.toValue(C, !0),
                    L = t.toValue(C + g / w, !0),
                  ...
                  if (
                    (O > E && ([O, E] = [E, O]),
                    1 === w && !o && "yAxis" === t.coll && !I)
                  ) {
                    for (let e of t.series) {
                      let t = e.getExtremes(
                        e
                          .getProcessedData(!0)
                          .modified.getColumn(e.pointValKey || "y") || [],
                        !0,
                      );
                      (I ??
                        (I = {
                        ...
                        R(t.dataMin) &&
                          R(t.dataMax) &&
                          ((I.dataMin = Math.min(t.dataMin, I.dataMin)),
                          (I.dataMax = Math.max(t.dataMax, I.dataMax))));
                    }
                    t.allExtremes = I;
                  }
                  let {
                    ...
                    X = B ?? H,
                    F = E - O,
                    Y = t.categories ? 0 : Math.min(F, X - G),
                    j = G - Y * (v(W) ? 0 : f.minPadding),
                    $ = X + Y * (v(H) ? 0 : f.maxPadding),
                    V =
                      t.allowZoomOutside || 1 === w || ("zoom" !== n && w > 1),
                    U = Math.min(W ?? j, j, V ? N : j),
                    Z = Math.max(H ?? $, $, V ? z : $);
                  (!t.isOrdinal || 1 !== w || o) &&
                    (O < U && ((O = U), w >= 1 && (E = O + F)),
                    E > Z && ((E = Z), w >= 1 && (O = E - F)),
                    (o ||
                      ...
                      (r
                        ...
                        : ((t.isPanning = "zoom" !== n && "drop" !== n),
                          t.isPanning && "mousewheel" !== n && (p = !0),
                          "drop" !== n &&
                            t.setExtremes(
                              o ? void 0 : O,
                              o ? void 0 : E,
                              !1,
                              !1,
                              { move: C, trigger: n, scale: w },
                            ),
                          !o && (O > U || E < Z) && (c = h)),
                      (d = !0)),
                    this.hasCartesianSeries || o || (c = h),
                    i &&
            ...
            S(iZ.prototype, {
              callbacks: [],
              collectionsWithInit: {
                xAxis: [iZ.prototype.addAxis, [!0]],
                yAxis: [iZ.prototype.addAxis, [!1]],
                series: [iZ.prototype.addSeries],
              },
            ...
            function iK() {
              ((this.scrollablePixelsX || this.scrollablePixelsY) &&
                ...
                (this.scrollablePlotArea = new iJ(this)),
            ...
            class iJ {
              static compose(t, e, i) {
                Z(i_, "ScrollablePlotArea") &&
                  (c(t, "afterInit", iq),
                  c(e, "afterSetChartSize", (t) =>
              ...
              static afterSetSize(t, e) {
                let i,
                  s,
                  o,
                  { minWidth: r, minHeight: a } =
                    t.options.chart.scrollablePlotArea || {},
                  { clipBox: n, plotBox: h, inverted: l, renderer: d } = t;
                if (!d.forExport)
                  if (
                    (r
                      ? ((t.scrollablePixelsX = i =
                          Math.max(0, r - t.chartWidth)),
                        i &&
                          ((t.scrollablePlotBox = F(t.plotBox)),
                          (h.width = t.plotWidth += i),
                          (n[l ? "height" : "width"] += i),
                          (o = !0)))
                      : a &&
                        ((t.scrollablePixelsY = s =
                          Math.max(0, a - t.chartHeight)),
                        v(s) &&
                          ((t.scrollablePlotBox = F(t.plotBox)),
              ...
              constructor(t) {
                ...
                (t.scrollablePixelsX && (r.overflowX = "auto"),
                  ...
                  (this.chart = t));
                const a = (this.parentDiv = x(
                    "div",
                    { className: "highcharts-scrolling-parent" },
                    { position: "relative" },
                    t.renderTo,
                  )),
                  n = (this.scrollingContainer = x(
                    "div",
                    { className: "highcharts-scrolling" },
                    r,
                    a,
                  )),
                  h = (this.innerContainer = x(
                    "div",
                ...
                ((this.mask = d
                  ...
                  b(t.renderTo, { overflow: "visible" }),
                  c(t, "afterShowResetZoom", o),
                  c(t, "afterApplyDrilldown", o),
                  c(t, "afterLayOutTitles", o),
                  c(n, "scroll", () => {
              ...
              applyFixed() {
                ...
                (e.setSize(r, a),
                  ...
                  b(s, { width: `${r}px`, height: `${a}px` }),
                  v(i) || ((s.scrollLeft = p * u), (s.scrollTop = g * f)));
                let y = d - o[0] - 1,
                  k = l - o[3] - 1,
                  w = d + h + o[2] + 1,
                  M = l + c + o[1] + 1,
              ...
              i1 = class {
                ...
                render(t) {
                  let e = this.axis.chart,
                    ...
                    s = i.format,
                    o =
                      (s ? iQ(s, this, e) : i.formatter?.call(this, this)) ||
                      "";
                  if (this.label)
                ...
                setOffset(t, e, i, s, o, r) {
                  ...
                  if (h && p) {
                    ...
                    ((p.x -= o),
                      ...
                      i &&
                        i0.prototype.justifyDataLabel.call(
                          n,
                          h,
                          a,
                          h.alignAttr,
                      ...
                      h.attr({
                        ...
                        y: h.alignAttr.y,
                        rotation: l.rotation,
                        rotationOriginX: t.width * P(l.textAlign || "center"),
                ...
                adjustStackPosition({
                  ...
                  return {
                    x: t.width / 2 + (t.width / 2) * (2 * P(i) - 1),
                    y: (t.height / 2) * 2 * (1 - P(e)),
                  };
                }
                getStackBox(t) {
                  let e = this.axis,
                    ...
                    h = e.stacking.usePercentage ? 100 : (s ?? this.total ?? 0),
                    l = e.toPixels(h),
                    d = t.xAxis || i.xAxis[0],
                    c = (o ?? d.translate(this.x)) + r,
                    p = Math.abs(
                      l -
                        e.toPixels(
                          n ||
            ...
            function i6() {
              this.stacking || (this.stacking = new se(this));
            }
            function i9(t, e, i, s) {
              return (
                !v(t) || t.x !== e || (s && t.stackKey !== s)
            ...
            function i7(t) {
              (this.is("column") || this.is("columnrange")) &&
                (this.options.centerInCategory && this.chart.series.length > 1
                  ? i2.setStackedPoints.call(this, t, "group")
            ...
            function st(t, e) {
              ...
              let d = this.getColumn("x", !0),
                ...
                u = this.options,
                f = u.threshold || 0,
                x = u.startFromThreshold ? f : 0,
                y = u.stack,
                b = e ? `${this.type},${l}` : this.stackKey || "",
                k = "-" + b,
                w = this.negStacks,
                M = t.stacking,
                C = M.stacks,
                S = M.oldStacks;
              for (M.stacksTouched += 1, h = 0; h < g; h++) {
                let e = d[h] || 0,
                  g = c[h],
                  u = (R(g) && g) || 0;
                ((n = (i = this.getStackIndicator(i, e, this.index)).key || ""),
                  C[(a = (s = w && u < (x ? 0 : f)) ? k : b)] || (C[a] = {}),
                  C[a][e] ||
                    (S[a]?.[e]
                      ? ((C[a][e] = S[a][e]), (C[a][e].total = null))
                      : (C[a][e] = new i1(
                          t,
                  ...
                  (o = C[a][e]),
                  null !== g
                    ? ((o.points[n] = o.points[this.index] =
                        [o.cumulative ?? x]),
                      v(o.cumulative) || (o.base = n),
                      (o.touched = M.stacksTouched),
                      i.index > 0 &&
                        !1 === this.singleStacks &&
                        (o.points[n][0] =
                          o.points[this.index + "," + e + ",0"][0]))
                ...
                ("percent" === l
                  ? ((r = s ? b : k),
                    (T =
                      w && C[r]?.[e]
                        ? ((r = C[r][e]).total =
                            Math.max(r.total || 0, T) + Math.abs(u))
                        : m(T + Math.abs(u))))
                  : "group" === l
                    ? R(g) && T++
                    : (T = m(T + u)),
                  "group" === l
                    ? (o.cumulative = (T || 1) - 1)
                    : (o.cumulative = m((o.cumulative ?? x) + u)),
                  (o.total = T),
                  null !== g &&
            ...
            class se {
              ...
              resetStacks() {
                j(this.stacks, (t) => {
                  j(t, (e, i) => {
                    R(e.touched) && e.touched < this.stacksTouched
              ...
              renderStackTotals() {
                let t = this.axis,
                  ...
                  i = e.renderer,
                  s = this.stacks,
                  o = tT(e, t.options.stackLabels?.animation || !1),
            ...
            (ie || (ie = {})).compose = function (t, e, i) {
              ...
              s.getStacks ||
                ...
                c(t, "destroy", i3),
                (s.getStacks = i5),
                (o.getStackIndicator = i9),
                (o.modifyStacks = i4),
                (o.percentStacker = i8),
                (o.setGroupedPoints = i7),
                ...
                [this, ...this.zones].forEach((s, o) => {
                  ...
                  if (
                    ...
                    let e = this.chart.inverted,
                      i = { filterUnits: "userSpaceOnUse" },
                      s = X(t.shadow) ? F(e ? {} : i, t.shadow) : !!e || i;
                    a.shadow(s);
                  }
            ...
            ((ss.defaultOptions = F(iI.defaultOptions, {
              legendSymbol: "lineMarker",
            })),
              iC.registerSeriesType("line", ss));
            let {
              seriesTypes: { line: so },
            } = iC;
            class sr extends so {
              ...
              getGraphPath(t) {
                let e,
                  ...
                  f = function (i, s, o) {
                    let r = t[i],
                      ...
                      k = !0;
                    (f && (x || m)
                      ? ((y = (m ? f[0] : f[1]) + x), (b = f[0] + x), (k = !!m))
                      : !a && u && (u.isNull || !v(u.plotY)) && (y = b = p),
                      void 0 !== y &&
                        (l.push({
                          plotX: e,
                ...
                for (let o = 0, r = t.length; o < r; ++o)
                  (a ||
                    (t[o].leftCliff =
                      ...
                      t[o].rightNull =
                        void 0),
                    (i = t[o].isNull || !v(t[o].plotY)),
                    (e = t[o].rectPlotX ?? t[o].plotX),
                    (s = a ? (t[o].yBottom ?? g) : g),
                    (!i || u) &&
                      (u || f(o, o - 1, "left"),
                      (i && !a && u) ||
                ...
                let b = m.concat(x);
                b.length && b.push(["Z"]);
                let k = o.call(this, l, !1, u);
                return (
                  this.chart.series.length > 1 &&
                    a &&
                    l.some((t) => t.isCliff) &&
                    (b.hasStackedCliffs = k.hasStackedCliffs = !0),
                  (b.xMap = m.xMap),
                  (this.areaPath = b),
                  k
                );
                ...
                if (((t = t || this.points), this.options.stacking)) {
                  ...
                  s.forEach(function (t, u) {
                    ...
                    if (n[t] && !n[t].isNull)
                      ...
                      f || (f = 0);
                      let s =
                        r.positiveValuesOnly && f <= 0
                          ? p
                          : r.translate(f, !1, !0, !1, !0);
                      i.push({
                        isNull: !0,
            ...
            ((sr.defaultOptions = F(so.defaultOptions, {
              threshold: 0,
              legendSymbol: "areaMarker",
            })),
              S(sr.prototype, { singleStacks: !1 }),
              iC.registerSeriesType("area", sr));
            let { line: sa } = iC.seriesTypes;
            class sn extends sa {
              getPointSpline(t, e, i) {
                ...
                if (c(l) && c(d)) {
                  ...
                  ((s = (1.5 * n + t) / 2.5),
                    ...
                    o > i && o > h
                      ...
                      : o < i &&
                        o < h &&
                        ((o = Math.min(i, h)), (a = 2 * h - o)),
                    a > p && a > h
                      ? ((a = Math.max(p, h)), (o = 2 * h - a))
                      : a < p &&
                        a < h &&
                        ((a = Math.min(p, h)), (o = 2 * h - a)),
                    (e.rightContX = r),
                    (e.rightContY = a),
                ...
                let p = [
                  "C",
                  l.rightContX ?? l.plotX ?? 0,
                  l.rightContY ?? l.plotY ?? 0,
                  s ?? n ?? 0,
                  o ?? h ?? 0,
                  n,
                  h,
            ...
            ((sn.defaultOptions = F(sa.defaultOptions)),
              iC.registerSeriesType("spline", sn));
            let sh = sn,
              {
                area: sl,
                area: { prototype: sd },
            ...
            class sc extends sh {}
            ((sc.defaultOptions = F(sh.defaultOptions, sl.defaultOptions)),
              S(sc.prototype, {
                getGraphPath: sd.getGraphPath,
                getStackPoints: sd.getStackPoints,
                drawGraph: sd.drawGraph,
              }),
              iC.registerSeriesType("areaspline", sc));
            let { parse: sp } = tv,
              { noop: sg } = n;
            class su extends iI {
              animate(t) {
                ...
                t && h
                  ? ((d.scaleY = 0.001),
                    (i = f(o.toPixels(n.threshold || 0), r, r + o.len)),
                    l
                      ? (d.translateX =
                          (i += a
                            ? -Math.floor(h[+!!l])
                            : Math.ceil(h[l ? 3 : 2])) - o.len)
                      : (d.translateY = i +=
                          a ? Math.ceil(h[+!!l]) : -Math.floor(h[l ? 3 : 2])),
                    s.clipBox && s.setClip(),
                    s.group.attr(d))
                  : ((e = Number(s.group.attr(c))),
                    s.group.animate(
                      { scaleY: 1 },
                      S(tS(s.options.animation), {
                        step: function (t, i) {
                          s.group &&
                            ((d[c] = e + i.pos * (r - e)), s.group.attr(d));
                        },
                      }),
                    ));
              }
              ...
              getColumnMetrics() {
                ...
                let l = Math.min(
                  ...
                  p = Math.min(
                    ...
                    e.pointWidth ?? c * (1 - 2 * e.pointPadding),
                  ),
                  g = (t.columnIndex || 0) + +!!r;
                return (
                  (t.columnMetrics = {
              ...
              crispCol(t, e, i, s) {
                ...
                return (
                  (s = y(e + s, o, r) - (e = y(e, o, r))),
                  this.options.crisp && (i = y(t + i, o) - (t = y(t, o))),
              ...
              adjustForMissingColumns(t, e, i, s) {
                if (!i.isNull && s.columnCount > 1) {
                  let o = this.xAxis.series
                    ...
                    r = 0,
                    a = 0;
                  (j(this.xAxis.stacking?.stacks, (t) => {
                    let e =
                        "number" == typeof i.x
                          ? t[i.x.toString()]?.points
                          : void 0,
                      s = e?.[this.index],
                      n = {};
                    if (e && H(s)) {
                    ...
                    (h &&
                      ...
                      (w =
                        Math.abs(w - u) > h
                          ? o - (k ? h : 0)
                          : u - (k ? h : 0))),
                      v(s.options.pointWidth) &&
                        (S -= Math.round(
                          ((C = T = Math.ceil(s.options.pointWidth)) - d) / 2,
                        )),
                      i.centerInCategory &&
                        (S = t.adjustForMissingColumns(S, C, s, l)),
                      (s.barX = S),
                      (s.pointWidth = C),
                      (s.tooltipPos = e.inverted
                        ? [
                            f(
                              a.len + a.pos - e.plotLeft - b,
                              a.pos - e.plotLeft,
                              a.len + a.pos - e.plotLeft,
                            ),
                            r.len + r.pos - e.plotTop - S - T / 2,
                            M,
                          ]
                        : [
                            r.left - e.plotLeft + S + T / 2,
                            f(
                              b + a.pos - e.plotTop,
                              a.pos - e.plotTop,
                      ...
                      (s.shapeArgs = t.crispCol(S, w, T, s.isNull ? 0 : M)));
                  }),
                  A(this, "afterColumnTranslate"));
              }
              drawGraph() {
              ...
              pointAttribs(t, e) {
                let i = this.options,
                  ...
                  n,
                  h,
                  l = t?.color || this.color,
                  d = t?.[o] || i[o] || l,
                  c = t?.options.dashStyle || i.dashStyle,
                  p = t?.[r] ?? i[r] ?? this[r] ?? 1,
                  g =
                    t?.isNull && i.nullInteraction
                      ? 0
                      : (t?.opacity ?? i.opacity ?? 1);
                (t &&
                  this.zones.length &&
                  ((n = t.getZone()),
                  (l =
                  ...
                  e &&
                    t &&
                    ((h = (a = F(i.states?.[e], t.options.states?.[e] || {}))
                      .brightness),
                    (l =
                      a.color ||
                      (void 0 !== h && sp(l).brighten(a.brightness).get()) ||
                      l),
                    (d = a[o] || d),
                    (p = a[r] || p),
                    (c = a.dashStyle || c),
              ...
              drawPoints(t) {
                ...
                t.forEach(function (t) {
                  ...
                  if (R(l) && (null !== t.y || r)) {
                    if (
                      ((e = t.shapeArgs),
                      d && t.hasNewShapeType() && (d = d.destroy()),
                      !d)
                    ) {
                      let o = e;
                      (t.origin &&
                        s.pointCount < h &&
                        ((o = F(e, t.getOrigin(t.origin, e))),
                        a || ((o.opacity = 0), (o["stroke-width"] = 0)),
                        (c = !0),
                        (p = "animate")),
                        (t.graphic = d =
                          n[t.shapeType](o).add(t.group || i.group)));
                    }
                    (c && d[p](F(e)),
                      a ||
                        d[p](
                          i.pointAttribs(t, t.selected ? "select" : ""),
                        ).shadow(!1 !== t.allowShadow && o.shadow),
                  ...
                  r = function (t) {
                    ...
                    o &&
                      ...
                      (s.isInsidePlot(
                        ...
                        (i.allowOutsidePlotInteraction &&
                          o?.inClass(t.target, "highcharts-point")) ||
              ...
              remove() {
                ...
                (e.hasRendered &&
                  ...
                  iI.prototype.remove.apply(t, arguments));
              }
            }
            ((su.defaultOptions = F(iI.defaultOptions, {
              borderRadius: 3,
              centerInCategory: !1,
              groupPadding: 0.2,
              marker: null,
              ...
              iC.registerSeriesType("column", su));
            let sf = su,
              { format: sm } = tF;
            !(function (t) {
              function e() {
              ...
              function i(t, e, i, s, o) {
                let { chart: r } = this,
                  ...
                  b =
                    ...
                    (this.forceDL ||
                      n ||
                      y ||
                      ((i.inside ?? !!this.options.stacking) &&
                        s &&
                ...
                if (x) {
                  ...
                  ((s = S(
                    { x: x[0], y: Math.round(x[1]), width: 0, height: 0 },
                    s || {},
                  )),
                    "plotEdges" === i.alignTo &&
                      this.isCartesian &&
                      ((s[a ? "x" : "y"] = 0),
                      (s[a ? "width" : "height"] = this.yAxis?.len || 0)),
                    S(i, { width: l.width, height: l.height }));
                  let y = 0,
                    v = 0;
                  (R(p) &&
                    !i.inside &&
                    ...
                    (e.distX = y),
                    (e.distY = v),
                    (e.alignAttr.x += f * (d.width - l.width)),
                    (e.alignAttr.y += m * (d.height - l.height)));
                  let k = e.alignAttr.x + (l.width - d.width) / 2,
                    w = e.alignAttr.y + (l.height - d.height) / 2;
                  if (h) {
                    let i = t.pos(!1, h.x, h.y);
                    if (i) {
                      let s = [i[0] - x[0], i[1] - x[1]];
                      ((this.is("column") || t.plotHigh) && (s[+!a] = 0),
                        e.attr({ x: k + s[0], y: w + s[1], opacity: 0.01 }),
                        (e.placed = !0),
                        (o = !1));
                    }
                  }
                  ...
                  if (
                    ((n || !b) && (M.opacity = 0),
                    e[e.placed ? "animate" : "attr"](M),
                    0 === u && !n && "justify" === g && b && s.height >= 0)
                  )
                  ...
                  i.shape &&
                    !u &&
                    e[o ? "attr" : "animate"]({ anchorX: x[0], anchorY: x[1] });
                }
                (e[o ? "attr" : "animate"]({
              ...
              function o(t, e, i) {
                let s = !!this.hasRendered,
                  o = this.initDataLabelsGroup(t, i).attr({ opacity: +s });
                return (
                  !s &&
                    o &&
                    (this.visible && o.show(),
                    this.options.animation
                      ? o.animate({ opacity: 1 }, e)
                      : o.attr({ opacity: 1 })),
                  o
                );
              }
              function r(t) {
                ...
                let e = this,
                  ...
                  s = e.options,
                  o = i.renderer,
                  { backgroundColor: r, plotBackgroundColor: a } =
                    i.options.chart,
                  l = o.getContrast(
                    (W(a) && a) ||
                      (W(r) && r) ||
                  ...
                  u = g ? tT(i, p, e) : { defer: 0, duration: 0 };
                (A(this, "drawDataLabels"),
                  e.hasDataLabels?.() &&
                    t.concat(e.condemnedPoints).forEach((t) => {
                      let r = t.dataLabels || [],
                        a = t.color || e.color;
                      J(n(c, t.dlOptions || t.options?.dataLabels)).forEach(
                        (n, h) => {
                          let c =
                              n.enabled &&
                          ...
                          if (
                            (c &&
                              ((b = v(
                                (y = n[t.formatPrefix + "Format"] ?? n.format),
                              )
                                ? sm(y, t, i)
                                : (
                                    n[t.formatPrefix + "Formatter"] ||
                                    n.formatter
                                  ).call(t, n, t)),
                              (k = n.rotation),
                              !i.styledMode &&
                                ((m.color =
                                  (W(n.color) ? n.color : void 0) ??
                                  m.color ??
                                  (W(e.color) ? e.color : void 0) ??
                              ...
                              i.styledMode ||
                                ((w.fill = "auto" === p ? t.color : p),
                                (w.stroke = "auto" === g ? t.color : g),
                                (w["stroke-width"] = n.borderWidth)),
                              j(w, (t, e) => {
                                void 0 === t && delete w[e];
                              })),
                            !M ||
                            ...
                            ((M.options = n),
                              ...
                              i.styledMode
                                ...
                                : M.css(m).shadow(n.shadow),
                              A(M, "beforeAddingDataLabel", {
                                labelOptions: n,
                                point: t,
                              }));
                            let s = (d[h] =
                              d[h] || this.initDataLabels(h, u, n));
                            (M.added || M.add(s),
                              e.alignDataLabel(t, M, n, void 0, C),
                              (M.isActive = !0),
              ...
              function a(t, e, i, s, o, r) {
                let a = this.chart,
                  ...
                  g = p ? p.left - a.plotLeft : 0,
                  u = a.inverted ? this.xAxis : this.yAxis,
                  f = u ? u.top - a.plotTop : 0,
                  { x: m = 0, y: x = 0 } = e,
                  y,
                  b,
                  v;
                return (
                  (y = (i.x || 0) - l + c + g) < 0 &&
                    ("right" === n && m >= 0
                      ? ((e.align = "left"), (e.inside = !0), (m -= l))
                      : (m -= y),
                    (b = !0)),
                  (y = (i.x || 0) + s.width - l - c + g) > a.plotWidth &&
                    ("left" === n && m <= 0
                      ? ((e.align = "right"), (e.inside = !0), (m -= l))
                      : (m += a.plotWidth - y),
                    (b = !0)),
                  (y = (i.y || 0) - d + c + f) < 0 &&
                    ("bottom" === h && x >= 0
                      ...
                      : (x -= y),
                    (v = !0)),
                  (y = (i.y || 0) + s.height - d - c + f) > a.plotHeight &&
                    ("top" === h && x <= 0
            ...
            function sv(t, e, i, s, o) {
              ...
              (i.align ?? (i.align = !n || p ? "center" : c ? "right" : "left"),
                i.verticalAlign ??
                  (i.verticalAlign = n || p ? "middle" : c ? "top" : "bottom"),
                sb.prototype.alignDataLabel.call(this, t, e, i, s, o),
                i.inside &&
                  t.contrastColor &&
                  e.css({ color: t.contrastColor }));
            }
            (is || (is = {})).compose = function (t) {
              (sx.compose(sb),
                Z(sy, "ColumnDataLabel") && (t.prototype.alignDataLabel = sv));
            };
            let sk = is;
            class sw extends sf {}
            ((sw.defaultOptions = F(sf.defaultOptions, {})),
              S(sw.prototype, { inverted: !0 }),
              iC.registerSeriesType("bar", sw));
            let { column: sM, line: sC } = iC.seriesTypes;
            class sS extends sC {
              applyJitter() {
                let t = this,
                  ...
                  this.points.forEach((s, o) => {
                    ["x", "y"].forEach((r, a) => {
                      if (e[r] && !s.isNull) {
                        ...
                        if (h && !h.logarithmic) {
                          let t,
                            l = e[r] * h.transA * (h.reversed ? -1 : 1),
                            d = (s[n] || 0) - l,
                            c = (s[n] || 0) + l;
                          ((s[n] =
                            d +
                            (c - d) *
                              ((t = 1e4 * Math.sin(o + a * i)) -
                                Math.floor(t))),
            ...
            ((sS.defaultOptions = F(sC.defaultOptions, {
              lineWidth: 0,
              ...
              S(sS.prototype, {
                ...
                drawTracker: sM.prototype.drawTracker,
                sorted: !1,
                requireSorting: !1,
                noSharedTooltip: !0,
                trackerGroups: ["group", "markerGroup", "dataLabelsGroup"],
              }),
              c(sS, "afterTranslate", function () {
                this.applyJitter();
              }),
              iC.registerSeriesType("scatter", sS));
            let { deg2rad: sT } = n;
            (((iu = io || (io = {})).getCenter = function () {
              let t = this.options,
                e = this.chart,
              ...
              let g = [
                r?.[0] ?? "50%",
                r?.[1] ?? "50%",
                (l && l < 0 ? void 0 : t.size) ?? "100%",
                (d && d < 0 ? void 0 : t.innerSize || 0) ?? "0%",
              ];
              for (c = 0; c < 4; ++c)
                ((p = g[c]),
                  (h = c < 2 || (2 === c && /%$/.test(p))),
                  (g[c] = _(p, [s, o, a, g[2]][c]) + (h ? i : 0)));
              return (
                g[3] > g[2] && (g[3] = g[2]),
                R(n) && 2 * n < g[2] && n > 0 && (g[3] = g[2] - 2 * n),
                A(this, "afterGetCenter", { positions: g }),
                g
              );
            }),
              (iu.getStartAndEndRadians = function (t, e) {
                let i = R(t) ? t : 0,
                  s = R(e) && e > i && e - i < 360 ? e : i + 360;
                return { start: sT * (i + -90), end: sT * (s + -90) };
              }));
            let sA = io;
            class sP extends eV {
              getConnectorPath(t) {
              ...
              constructor(t, e, i) {
                ...
                (c(this, "select", s), c(this, "unselect", s));
              }
              isValid() {
                return R(this.y) && this.y >= 0;
              }
              setVisible(t, e = !0) {
                t !== this.visible &&
            ...
            let { getStartAndEndRadians: sL } = sA,
              { noop: sO } = n;
            class sE extends iI {
              animate(t) {
                let e = this,
                ...
                t ||
                  i.forEach(function (t) {
                    ...
                    i &&
                      o &&
                      (i.attr({
                        r: t.startR ?? (e.center && e.center[3] / 2),
                        start: s,
                        end: s,
                      }),
                      i.animate(
                  ...
                  ? ((t = this.center[0]),
                    ...
                    this.graph ||
                      (this.graph = this.chart.renderer
                        ...
                        .add(this.group)),
                    this.graph.attr({
                      d: t9.arc(t, e, this.center[2] / 2, 0, {
                        start: i,
                        end: s,
              ...
              translate(t) {
                (A(this, "translate"), this.generatePoints());
                let e = this.options,
                  i = e.slicedOffset,
                  s = sL(e.startAngle, e.endAngle),
                  ...
                  m = 0;
                for (
                  t || (this.center = t = this.getCenter()), u = 0;
                  u < h;
                  u++
                ) {
                  ((f = a[u]),
            ...
            ((sE.defaultOptions = F(iI.defaultOptions, {
              borderRadius: 3,
              center: [null, null],
              clip: !1,
              colorByPoint: !0,
              ...
              S(sE.prototype, {
                ...
                directTouch: !0,
                drawGraph: void 0,
                drawTracker: sf.prototype.drawTracker,
                getCenter: sA.getCenter,
                getSymbol: sO,
                invertible: !1,
                isCartesian: !1,
                noSharedTooltip: !0,
                pointAttribs: sf.prototype.pointAttribs,
                pointClass: sP,
                requireSorting: !1,
                searchPoint: sO,
                trackerGroups: ["group", "dataLabelsGroup"],
              }),
              iC.registerSeriesType("pie", sE));
            let { composed: sI, noop: sD } = n,
              { distribute: sB } = tY,
              { series: sN } = iC;
            !(function (t) {
              let e = {
              ...
              function i(t, e) {
                ...
                let { center: a, options: n } = this,
                  ...
                  p = a[1] + d * h,
                  g = Math.min(
                    (n.slicedOffset || 0) + (n.borderWidth || 0),
                    e / 5,
                  );
                return {
              ...
              function s() {
                ...
                t.visible &&
                  ...
                  sN.prototype.drawDataLabels.apply(t),
                  e.forEach((t) => {
                            ...
                            if (
                              ...
                              switch (d.alignTo) {
                                ...
                                case "plotEdges":
                                  ...
                                  break;
                                default:
                                  M = p.radialDistributionX(t, i, C - w, y, l);
                              }
                            if (
                              ((x.attribs = {
                                visibility: S,
                              ...
                              let t;
                              (M - (f = l.getBBox().width) < b && 1 === a
                                ? ((t = Math.round(f - M + b)),
                                  (c[3] = Math.max(t, c[3])))
                                : M + f > s - b &&
                                  0 === a &&
                                  ((t = Math.round(M + f - s + b)),
                                  (c[1] = Math.max(t, c[1]))),
                                C - m / 2 < 0
                                  ? (c[0] = Math.max(
                                      Math.round(-C + m / 2),
                  ...
                  (0 === g(c) || this.verifyDataLabelOverflow(c)) &&
                    (this.placeDataLabels(),
                    this.points.forEach((e) => {
                      e.dataLabels?.forEach((s, o) => {
                        let { connectorColor: r, connectorWidth: a = 1 } =
                            s.options || {},
                          ...
                          ((u = s.connector),
                            n && n.distance > 0
                              ? ((h = !u),
                                ...
                                u.attr({ visibility: n.attribs?.visibility }))
              ...
              t.compose = function (t) {
                if ((sx.compose(sN), Z(sI, "PieDataLabel"))) {
                  let a = t.prototype;
            ...
            let sz = ir;
            (((im = ia || (ia = {})).getCenterOfPoints = function (t) {
              ...
              (im.getDistanceBetweenPoints = function (t, e) {
                return Math.sqrt(
                  Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2),
                );
              }),
              (im.getAngleBetweenPoints = function (t, e) {
                return Math.atan2(e.x - t.x, e.y - t.y);
              }),
              (im.pointInPolygon = function ({ x: t, y: e }, i) {
                let s = i.length,
                  o,
                  r,
                  a = !1;
                  ...
                  t.oldOpacity !== i &&
                    (t.hasClass("highcharts-data-label")
                      ? (t[i ? "removeClass" : "addClass"](
                        ...
                        A(e, "afterHideOverlappingLabel"))
                      : t.attr({ opacity: i })),
                  (t.isOld = !0)),
                s
              );
            }
            let { defaultOptions: sH } = tm,
              { noop: sG } = n,
              sX = { radius: 0, scope: "stack", where: void 0 },
              sF = sG,
              sY = sG;
            function sj(t, e, i, s, o = {}) {
              let r = sF(t, e, i, s, o),
                {
                  brStart: a = !0,
                  brEnd: n = !0,
              ...
              let p = c - d,
                ...
                u = Math.max(
                  Math.min(
                    _(sV(o.borderRadius).radius, l - h),
                    (l - h) / 2,
                    (l * g) / (1 + g),
                  ),
                  0,
            ...
            function s$() {
              if (
                ...
                let { options: t, yAxis: e } = this,
                  ...
                  s = sH.plotOptions?.[this.type]?.borderRadius,
                  o = sV(t.borderRadius, X(s) ? s : {}),
                ...
                for (let s of this.points) {
                  ...
                  if ("roundedRect" === s.shapeType && a) {
                    ...
                    ("end" === g && (p && (d -= u), (c += u)),
                      S(a, { brBoxHeight: c, brBoxY: d, r: u }));
                  }
                }
              }
            }
            function sV(t, e) {
              return (X(t) || (t = { radius: t || 0 }), F(sX, e, t));
            }
            function sU() {
              let t = sV(this.options.borderRadius);
              for (let e of this.points) {
                let i = e.shapeArgs;
                i &&
                  (i.borderRadius = _(t.radius, (i.r || 0) - (i.innerR || 0)));
              }
            }
            ...
            function s_(t, e) {
              ...
              (
                ...
                function () {
                  return (
                    this.chartWidth <= (i.maxWidth ?? Number.MAX_VALUE) &&
                    this.chartHeight <= (i.maxHeight ?? Number.MAX_VALUE) &&
                    this.chartWidth >= (i.minWidth ?? 0) &&
                    this.chartHeight >= (i.minHeight ?? 0)
                  );
                }
            ...
            function sK(t, e) {
              ...
              !e &&
                ...
                i.rules &&
                i.rules.forEach((t) => {
                  (void 0 === t._id && (t._id = tn()),
                    this.matchResponsiveRule(t, o));
                }, this);
              let a = F(
                ...o
                  .map((t) => D(i?.rules || [], (e) => e._id === t))
                  .map((t) => t?.chartOptions),
              );
            ...
            (ih || (ih = {})).compose = function (t) {
              let e = t.prototype;
              return (
                e.matchResponsiveRule ||
                  S(e, { matchResponsiveRule: s_, setResponsive: sK }),
                t
              );
            };
            let sq = ih;
            ((n.AST = tB),
              ...
              (n.Templating = tF),
              (n.Tick = ek),
              (n.Time = class extends tp {
                constructor(t, e) {
                  const i = tm.getOptions();
                  super(t ?? i.time, e ?? i.lang);
                }
              }),
              (n.Tooltip = eF),
              (n.addEvent = c),
              ...
              (n.css = b),
              (n.crisp = y),
              (n.dateFormat = tF.dateFormat),
              (n.defaultOptions = tm.defaultOptions),
              (n.defined = v),
              (n.destroyObjectProperties = k),
              (n.diffObjects = M),
              (n.discardElement = w),
              (n.distribute = tY.distribute),
              (n.erase = C),
              (n.error = to),
              (n.extend = S),
              (n.extendClass = T),
              ...
              (n.format = tF.format),
              (n.getAlignFactor = P),
              (n.getClosestDistance = L),
              (n.getDeferredAnimation = tT),
              (n.getMagnitude = O),
              (n.getNestedProperty = E),
              (n.getOptions = tm.getOptions),
              (n.getStyle = I),
              (n.insertItem = tr),
              (n.isArray = H),
              (n.isClass = z),
              ...
              (n.isObject = X),
              (n.isString = W),
              (n.internalClearTimeout = B),
              (n.merge = F),
              (n.normalizeTickInterval = Y),
              (n.numberFormat = tF.numberFormat),
              (n.objectEach = j),
              (n.offset = $),
              (n.pad = V),
              (n.pick = function (...t) {
              ...
              (n.removeEvent = q),
              (n.replaceNested = K),
              (n.seriesType = iC.seriesType),
              (n.setAnimation = tC),
              (n.setOptions = tm.setOptions),
              (n.splat = J),
              (n.stableSort = Q),
              (n.stop = tP),
              (n.syncTimeout = tt),
              (n.time = tm.defaultTime),
              (n.ucfirst = te),
              (n.timers = tM.timers),
              (n.timeUnits = ta),
              (n.uniqueKey = tn),
              (n.useSerialIds = function (e) {
                return (t = e ?? t);
              }),
              ...
              (function (t, e, i) {
                ...
                if (!e.symbolCustomAttribs.includes("borderRadius")) {
                  ...
                  (c(t, "afterColumnTranslate", s$, { order: 9 }),
                    c(s, "afterTranslate", sU),
              ...
              })(n.Series, n.SVGElement, n.SVGRenderer),
              sk.compose(n.Series.types.column),
              sx.compose(n.Series),
              eO.compose(n.Axis),
              em.compose(n.SVGRenderer),
              iH.compose(n.Chart),
              eE.compose(n.Axis),
              (o = (ix = n.Chart).prototype).hideOverlappingLabels ||
                ((o.hideOverlappingLabels = function (t) {
                  let e = t.length,
                    i = (t, e) =>
                      !(
                        e.x >= t.x + t.width ||
                        ...
                        if (t && (!t.alignAttr || t.placed)) {
                          let e = t.box ? 0 : t.padding || 0,
                            i = t.dataLabelPosition?.posAttribs ||
                              t.alignAttr || { x: t.attr("x"), y: t.attr("y") },
                  ...
                  for (let e of t) e && sW(e, this) && (l = !0);
                  l && A(this, "afterHideAllOverlappingLabels");
                }),
                c(ix, "render", function () {
                  let t = this,
                    e = [];
                          ...
                          o.visible &&
                            (o.dataLabels || []).forEach((s) => {
                              ...
                              ((s.labelrank =
                                ...
                                o.shapeArgs?.height),
                                (r.allowOverlap ??
                                (i.is("pie") && Number(r.distance) > 0))
                                  ? ((s.oldOpacity = s.opacity),
                                    (s.newOpacity = 1),
                                    sW(s, t))
                                  : e.push(s));
                            });
              ...
              sz.compose(n.Series.types.pie),
              eD.compose(n.Chart, n.Axis),
              eJ.compose(n.Chart),
              sq.compose(n.Chart),
              iJ.compose(n.Axis, n.Chart, n.Series),
              si.compose(n.Axis, n.Chart, n.Series),
              eF.compose(n.Pointer));
            let sJ = n;
            return a.default;
          })(),
        )
         ...
         */ (function (t, e) {
          "object" == typeof exports && "object" == typeof module
            ...
            : "function" == typeof define && define.amd
              ...
              : "object" == typeof exports
                ? (exports["highcharts/highcharts-3d"] = e(
                    t._Highcharts,
                    t._Highcharts.Color,
                    t._Highcharts.SeriesRegistry,
                    t._Highcharts.Series,
          ...
          (() => {
            ...
            function x(t) {
              ...
              let i = (c[t] = { exports: {} });
              return (d[t](i, i.exports, x), i.exports);
            }
            ((x.n = (t) => {
              let e = t && t.__esModule ? () => t.default : () => t;
              return (x.d(e, { a: e }), e);
            }),
              (x.d = (t, e) => {
                if (Array.isArray(e))
            ...
            let { deg2rad: g } = u();
            function m(t, e, i, s) {
              let a = e.options.chart.options3d,
                r = s ?? (!!i && e.inverted),
                o = {
                  x: e.plotWidth / 2,
                  y: e.plotHeight / 2,
                  z: a.depth / 2,
                  vd: (a.depth ?? 1) * (a.viewDistance ?? 0),
                },
                h = e.scale3d || 1,
                n = g * a.beta * (r ? -1 : 1),
                l = g * a.alpha * (r ? -1 : 1),
              ...
              return (
                i || ((o.x += e.plotLeft), (o.y += e.plotTop)),
                t.map(function (t) {
                  var e, i, s;
                  let a =
                      ((e = (r ? t.y : t.x) - o.x),
                  ...
                  return (
                    ...
                    (n.y = n.y * h + o.y),
                    (n.z = a.z * h + o.z),
                    { x: r ? n.y : n.x, y: r ? n.x : n.y, z: n.z }
                  );
                })
              );
            }
            function v(t, e, i) {
              let s = i > 0 && i < 1 / 0 ? i / (t.z + e.z + i) : 1;
            ...
            let A = {
                ...
                pointCameraDistance: function (t, e) {
                  let i = e.options.chart.options3d,
                    s = {
                      x: e.plotWidth / 2,
                      y: e.plotHeight / 2,
                      z: (i.depth ?? 1) * (i.viewDistance ?? 0) + i.depth,
                    };
                  return Math.sqrt(
                    Math.pow(s.x - (t.plotX ?? t.x), 2) +
                      Math.pow(s.y - (t.plotY ?? t.y), 2) +
                      Math.pow(s.z - (t.plotZ ?? t.z), 2),
                  );
                },
                shapeArea: M,
              ...
              { parse: P } = b(),
              { defaultOptions: S } = u(),
              { perspective: k, shapeArea3D: w } = A;
            !(function (t) {
              function e(t) {
                this.is3d() &&
                  "scatter" === t.options.type &&
                  (t.options.type = "scatter3d");
              }
              function i() {
                if (this.chart3d && this.is3d()) {
                  let t = this.renderer,
                    ...
                    r = this.plotTop,
                    o = this.plotTop + this.plotHeight,
                    h = e.depth,
                    n = s - (i.left.visible ? i.left.size : 0),
                    l = a + (i.right.visible ? i.right.size : 0),
                    p = r - (i.top.visible ? i.top.size : 0),
                    d = o + (i.bottom.visible ? i.bottom.size : 0),
                    c = 0 - (i.front.visible ? i.front.size : 0),
                    x = h + (i.back.visible ? i.back.size : 0),
                  ...
                  ((this.chart3d.frame3d = i),
                    ...
                    this.frameShapes.bottom[y]({
                      ...
                      faces: [
                        {
                          fill: P(i.bottom.color).brighten(0.1).get(),
                          vertexes: [
                            { x: n, y: d, z: c },
                            { x: l, y: d, z: c },
                            { x: l, y: d, z: x },
                    ...
                    this.frameShapes.top[y]({
                      ...
                      faces: [
                        {
                          fill: P(i.top.color).brighten(0.1).get(),
                          vertexes: [
                            { x: n, y: p, z: x },
                            { x: l, y: p, z: x },
                            { x: l, y: p, z: c },
                    ...
                    this.frameShapes.left[y]({
                      ...
                      faces: [
                        {
                          fill: P(i.left.color).brighten(0.1).get(),
                          vertexes: [
                            { x: n, y: d, z: c },
                            { x: s, y: o, z: 0 },
                            { x: s, y: o, z: h },
                    ...
                    this.frameShapes.right[y]({
                      ...
                      faces: [
                        {
                          fill: P(i.right.color).brighten(0.1).get(),
                          vertexes: [
                            { x: l, y: d, z: x },
                            { x: a, y: o, z: h },
                            { x: a, y: o, z: 0 },
                    ...
                    this.frameShapes.back[y]({
                      ...
                      faces: [
                        {
                          fill: P(i.back.color).brighten(0.1).get(),
                          vertexes: [
                            { x: l, y: d, z: x },
                            { x: n, y: d, z: x },
                            { x: s, y: o, z: h },
                    ...
                    this.frameShapes.front[y]({
                      ...
                      faces: [
                        {
                          fill: P(i.front.color).brighten(0.1).get(),
                          vertexes: [
                            { x: n, y: d, z: c },
                            { x: l, y: d, z: c },
                            { x: a, y: o, z: 0 },
                ...
                this.styledMode &&
                  [
                    ...
                    this.renderer.definition({
                      tagName: "filter",
                      attributes: { id: "highcharts-" + t.name },
                      children: [
                        {
                          ...
                          children: [
                            {
                              tagName: "feFuncR",
                              attributes: { type: "linear", slope: t.slope },
                            },
                            {
                              tagName: "feFuncG",
                              attributes: { type: "linear", slope: t.slope },
              ...
              function r() {
                ...
                if (this.chart3d && this.is3d()) {
                  t &&
                    ((t.alpha = (t.alpha % 360) + (t.alpha >= 0 ? 0 : 360)),
                  ...
                  ((i[e ? "y" : "x"] = -(s[3] || 0)),
                    (i[e ? "x" : "y"] = -(s[0] || 0)),
                    (i[e ? "height" : "width"] =
                      this.chartWidth + (s[3] || 0) + (s[1] || 0)),
                    (i[e ? "width" : "height"] =
                      this.chartHeight + (s[0] || 0) + (s[2] || 0)),
                    (this.scale3d = 1),
                    !0 === t.fitToPlot &&
                      (this.scale3d = this.chart3d.getScale(t.depth)),
              ...
              function n() {
                this.chart3d || (this.chart3d = new c(this));
              }
              function l(t) {
                return (
                  this.is3d() || t.apply(this, [].slice.call(arguments, 1))
                );
              }
              function p(t) {
                let e,
                ...
                if (this.is3d())
                  for (; i--; ) ((e = this.series[i]).translate(), e.render());
                else t.call(this);
              }
              function d(t) {
              ...
              ((t.defaultOptions = {
                ...
                (t.compose = function (c, x) {
                  let y = c.prototype,
                    u = x.prototype;
                  ((y.is3d = function () {
                    return !!this.options.chart.options3d?.enabled;
                  }),
                    y.propsRequireDirtyBox.push("chart.options3d"),
                    y.propsRequireUpdateSeries.push("chart.options3d"),
                    (u.matrixSetter = function () {
                      let t;
                      if (
                        this.pos < 1 &&
                        ((0, f.isArray)(this.start) || (0, f.isArray)(this.end))
                      ) {
                    ...
                    (0, f.merge)(!0, S, t.defaultOptions),
                    (0, f.addEvent)(c, "init", n),
                    (0, f.addEvent)(c, "addSeries", e),
                    (0, f.addEvent)(c, "afterDrawChartBox", i),
                    (0, f.addEvent)(c, "afterGetContainer", s),
                    (0, f.addEvent)(c, "afterInit", a),
                    (0, f.addEvent)(c, "afterSetChartSize", r),
                    (0, f.addEvent)(c, "beforeRedraw", o),
                    (0, f.addEvent)(c, "beforeRender", h),
                    (0, f.wrap)(y, "isInsidePlot", l),
                    (0, f.wrap)(y, "renderSeries", p),
                    (0, f.wrap)(y, "setClassName", d));
                }));
              class c {
                constructor(t) {
                  this.chart = t;
                ...
                get3dFrame() {
                  let t = this.chart,
                    ...
                    i = e.frame,
                    s = t.plotLeft,
                    a = t.plotLeft + t.plotWidth,
                    r = t.plotTop,
                    o = t.plotTop + t.plotHeight,
                    h = e.depth,
                    n = function (e) {
                      let i = w(e, t);
                      return i > 0.5 ? 1 : i < -0.5 ? -1 : 0;
                    },
                    l = n([
                      { x: s, y: o, z: h },
                      { x: a, y: o, z: h },
                  ...
                  let g = function (t, e, i) {
                      ...
                      let r = i;
                      return (
                        !0 === a.visible || !1 === a.visible
                          ? (r = a.visible)
                          : "auto" === a.visible && (r = e > 0),
                        {
                          size: a.size ?? 1,
                          color: a.color ?? "none",
                          frontFacing: e > 0,
                    ...
                    m = {
                      axes: {},
                      bottom: g([i.bottom, i.top, i], l, f),
                      top: g([i.top, i.bottom, i], p, u),
                      left: g([i.left, i.right, i.side, i], d, z),
                      right: g([i.right, i.left, i.side, i], c, b),
                      back: g([i.back, i.front, i], y, !0),
                      front: g([i.front, i.back, i], x, !1),
                    };
                  if ("auto" === e.axisLabelPosition) {
                    ...
                    m.axes = {
                      y: { left: c(i, "x", -1), right: c(i, "x", 1) },
                      x: { top: c(l, "y", -1), bottom: c(n, "y", 1) },
                      z: { top: c(d, "y", -1), bottom: c(p, "y", 1) },
                    };
                  } else
                    m.axes = {
                      y: {
                        left: { x: s, z: 0, xDir: { x: 1, y: 0, z: 0 } },
                        right: { x: a, z: 0, xDir: { x: 0, y: 0, z: 1 } },
                      },
                      x: {
                        top: { y: r, z: 0, xDir: { x: 1, y: 0, z: 0 } },
                        bottom: { y: o, z: 0, xDir: { x: 1, y: 0, z: 0 } },
                      },
                      z: {
                        top: {
                          x: z ? a : s,
                ...
                getScale(t) {
                  ...
                  return (
                    ...
                    [0, 1].forEach(function (t) {
                      l.push({ x: s, y: l[t].y, z: l[t].z });
                    }),
                    [0, 1, 2, 3].forEach(function (t) {
                      l.push({ x: l[t].x, y: r, z: l[t].z });
                    }),
                    (l = k(l, e, !1)).forEach(function (t) {
                      ((n.minX = Math.min(n.minX, t.x)),
                        (n.maxX = Math.max(n.maxX, t.x)),
                        (n.minY = Math.min(n.minY, t.y)),
                        (n.maxY = Math.max(n.maxY, t.y)));
                    }),
                    i > n.minX &&
                      (p = Math.min(
                        p,
                        1 - (Math.abs((i + o) / (n.minX + o)) % 1),
                      )),
                    s < n.maxX && (p = Math.min(p, (s - o) / (n.maxX - o))),
                    a > n.minY &&
                      (p =
                        n.minY < 0
                          ? Math.min(p, (a + h) / (-n.minY + a + h))
                          : Math.min(p, 1 - (((a + h) / (n.minY + h)) % 1))),
                    r < n.maxY &&
                      (p = Math.min(p, Math.abs((r - h) / (n.maxY - h)))),
                    p
                  );
                }
              }
            ...
            function T(t) {
              ...
              let i = H.getGraphPath,
                s = this.options,
                a = Math.round(this.yAxis.getThreshold(s.threshold)),
                r = [];
              if (this.rawPointsX)
                for (let t = 0; t < this.points.length; t++)
                  r.push({
                    x: this.rawPointsX[t],
                    y: s.stacking ? this.points[t].yBottom : a,
                    z: this.zPadding,
                  });
              let o = this.chart.options.chart.options3d;
              ((r = X(r, this.chart, !0).map((t) => ({
                plotX: t.x,
                plotY: t.y,
                plotZ: t.z,
              }))),
                this.group &&
                  ...
                  o.beta &&
                  (this.markerGroup &&
                    (this.markerGroup.add(this.group),
                  ...
                  this.group.attr({
                    zIndex: Math.max(
                      1,
                      o.beta > 270 || o.beta < 90
                        ? o.depth - Math.round(this.zPadding || 0)
                        : Math.round(this.zPadding || 0),
                    ),
                  })),
                (r.reversed = !0));
              let h = i.call(this, r, !0, !0);
              if (
                (h[0] && "M" === h[0][0] && (h[0] = ["L", h[0][1], h[0][2]]),
                this.areaPath)
              ) {
                let t = this.areaPath
                  .splice(0, this.areaPath.length / 2)
                  .concat(h);
                ((t.xMap = this.areaPath.xMap), (this.areaPath = t));
              }
              return ((this.graphPath = e), e);
            }
            let Y = {
            ...
            function O(t) {
              ...
              e && (0, f.extend)(t.pos, e.fix3dPosition(t.pos));
            }
            function C(t) {
              let e = this.axis.axis3D,
              ...
              if (e) {
                ...
                if ("M" === t[0] && "L" === s[0]) {
                  let i = [
                    e.fix3dPosition({ x: t[1], y: t[2], z: 0 }),
                    e.fix3dPosition({ x: s[1], y: s[2], z: 0 }),
                  ];
            ...
            let F = function (t) {
                (0, f.pushUnique)(Z, "Axis.Tick3D") &&
                  ((0, f.addEvent)(t, "afterGetLabelPosition", O),
                  (0, f.wrap)(t.prototype, "getMarkPath", C));
              },
              { defaultOptions: G } = u(),
              { deg2rad: _ } = u(),
              { perspective: W, perspective3D: R, shapeArea: B } = A;
            function j() {
              let t = this.chart,
                e = this.options;
              t.is3d?.() &&
                "colorAxis" !== this.coll &&
                ((this.clippable = !1),
                (e.tickWidth = e.tickWidth ?? 0),
                (e.gridLineWidth = e.gridLineWidth ?? 1));
            }
            function V(t) {
              this.chart.is3d() &&
                "colorAxis" !== this.coll &&
                t.point &&
                (t.point.crosshairPos = this.isXAxis
                  ? t.point.axisXpos
                  : this.len - t.point.axisYpos);
            }
            function N() {
              this.axis3D || (this.axis3D = new $(this));
            }
            function U(t) {
            ...
            function q(t) {
              ...
              let e = arguments,
                ...
                s = e[2],
                a = [],
                r = this.getPlotLinePath({ value: i }),
                o = this.getPlotLinePath({ value: s });
              if (r && o)
            ...
            function J(t) {
              ...
              if (
                ...
                return s;
              let a = i.options.chart.options3d,
                r = this.isZAxis ? i.plotWidth : a.depth,
                o = i.chart3d.frame3d,
                h = s[0],
                n = s[1],
                l,
              ...
              return (
                "M" === h[0] &&
                  "L" === n[0] &&
                  ((l = [
                    e.swapZ({ x: h[1], y: h[2], z: 0 }),
                    e.swapZ({ x: h[1], y: h[2], z: r }),
                    e.swapZ({ x: n[1], y: n[2], z: 0 }),
                    e.swapZ({ x: n[1], y: n[2], z: r }),
                  ]),
                  this.horiz
                    ? (this.isZAxis
                        ? (o.left.visible && p.push(l[0], l[2]),
                          o.right.visible && p.push(l[1], l[3]))
                        : (o.front.visible && p.push(l[0], l[2]),
                          o.back.visible && p.push(l[1], l[3])),
                      o.top.visible && p.push(l[0], l[1]),
                      o.bottom.visible && p.push(l[2], l[3]))
                    : (o.front.visible && p.push(l[0], l[2]),
                      o.back.visible && p.push(l[1], l[3]),
                      o.left.visible && p.push(l[0], l[1]),
                      o.right.visible && p.push(l[2], l[3])),
                  (p = W(p, this.chart, !1))),
                i.renderer.toLineSegments(p)
              );
            }
            function K(t, e) {
              let { chart: i, gridGroup: s, tickPositions: a, ticks: r } = this;
              if (
                this.categories &&
                i.frameShapes &&
                i.is3d() &&
                ...
                let t,
                  o,
                  h,
                  n = s.element.childNodes[0].getBBox(),
                  l = i.frameShapes.left.getBBox(),
                  p = i.options.chart.options3d,
                  d = {
                    x: i.plotWidth / 2,
                    y: i.plotHeight / 2,
                    z: p.depth / 2,
                    vd: (p.depth ?? 1) * (p.viewDistance ?? 0),
                  },
                  c = a.indexOf(e.pos),
                  x = r[a[c - 1]],
                  y = r[a[c + 1]];
                return (
                  x?.label?.xy &&
                    (o = R(
                      { x: x.label.xy.x, y: x.label.xy.y, z: null },
                      d,
                      d.vd,
                    )),
                  y?.label?.xy &&
                    (h = R(
                      { x: y.label.xy.x, y: y.label.xy.y, z: null },
                      d,
                      d.vd,
                    )),
                  (t = R(
                    (t = { x: e.label.xy.x, y: e.label.xy.y, z: null }),
                    d,
                    d.vd,
                  )),
                  Math.abs(o ? t.x - o.x : h ? h.x - t.x : n.x - l.x)
                );
              }
              return t.apply(this, [].slice.call(arguments, 1));
            }
            ...
            class $ {
              static compose(t, e) {
                if ((F(e), !t.keepProps.includes("axis3D"))) {
                  ((0, f.merge)(!0, G.xAxis, Y),
                    t.keepProps.push("axis3D"),
                    (0, f.addEvent)(t, "init", N),
                    (0, f.addEvent)(t, "afterSetOptions", j),
                    (0, f.addEvent)(t, "drawCrosshair", V));
                  let e = t.prototype;
                  ((0, f.wrap)(e, "getLinePath", U),
                    (0, f.wrap)(e, "getPlotBandPath", q),
                    (0, f.wrap)(e, "getPlotLinePath", J),
                    (0, f.wrap)(e, "getSlotWidth", K),
                    (0, f.wrap)(e, "getTitlePosition", Q));
                }
              }
              constructor(t) {
                this.axis = t;
              ...
              fix3dPosition(t, e) {
                ...
                let a = _ * s.options.chart.options3d.alpha,
                  r = _ * s.options.chart.options3d.beta,
                  o =
                    (e && i.options.title.position3d) ??
                    i.options.labels.position3d,
                  h = (e && i.options.title.skew3d) ?? i.options.labels.skew3d,
                  n = s.chart3d.frame3d,
                  l = s.plotLeft,
                  p = s.plotWidth + l,
                  d = s.plotTop,
                  ...
                  u = { x: 0, y: 1, z: 0 },
                  z = !1;
                if (((t = i.axis3D.swapZ({ x: t.x, y: t.y, z: 0 })), i.isZAxis))
                  if (i.opposite) {
                    if (null === n.axes.z.top) return {};
                    ((y = t.y - d),
                      (t.x = n.axes.z.top.x),
                      (t.y = n.axes.z.top.y),
                      (f = n.axes.z.top.xDir),
                    ...
                    if (null === n.axes.z.bottom) return {};
                    ((y = t.y - c),
                      (t.x = n.axes.z.bottom.x),
                      (t.y = n.axes.z.bottom.y),
                      (f = n.axes.z.bottom.xDir),
                      (z = !n.bottom.frontFacing));
                  }
                else if (i.horiz)
                  if (i.opposite) {
                    if (null === n.axes.x.top) return {};
                    ((y = t.y - d),
                      (t.y = n.axes.x.top.y),
                      (t.z = n.axes.x.top.z),
                      (f = n.axes.x.top.xDir),
                    ...
                    if (null === n.axes.x.bottom) return {};
                    ((y = t.y - c),
                      (t.y = n.axes.x.bottom.y),
                      (t.z = n.axes.x.bottom.z),
                      (f = n.axes.x.bottom.xDir),
                      (z = !n.bottom.frontFacing));
                  }
                else if (i.opposite) {
                  if (null === n.axes.y.right) return {};
                  ((x = t.x - p),
                    (t.x = n.axes.y.right.x),
                    (t.z = n.axes.y.right.z),
                    (f = { x: (f = n.axes.y.right.xDir).z, y: f.y, z: -f.x }));
                } else {
                  if (null === n.axes.y.left) return {};
                  ((x = t.x - l),
                    (t.x = n.axes.y.left.x),
                    (t.z = n.axes.y.left.z),
                    (f = n.axes.y.left.xDir));
                }
                if ("chart" === o);
                else if ("flap" === o)
                  if (i.horiz) {
                    let t = Math.sin(a),
                      e = Math.cos(a);
                    (z && (t = -t), (u = { x: f.z * t, y: e, z: -f.x * t }));
                  } else f = { x: Math.cos(r), y: 0, z: Math.sin(r) };
                else if ("ortho" === o)
                  if (i.horiz) {
                    let t = Math.sin(a),
                      e = Math.cos(a),
                      i = { x: Math.sin(r) * e, y: -t, z: -e * Math.cos(r) },
                      s =
                        1 /
                        Math.sqrt(
                          (u = {
                  ...
                  i.horiz
                    ? (u = {
                        ...
                        y: Math.cos(a),
                        z: -Math.cos(r) * Math.sin(a),
                      })
                    : (f = { x: Math.cos(r), y: 0, z: Math.sin(r) });
                ((t.x += x * f.x + y * u.x),
                  (t.y += x * f.y + y * u.y),
                  (t.z += x * f.z + y * u.z));
                let b = W([t], i.chart)[0];
                if (h) {
                  ...
                  ((b.matrix = [
                    ...
                    (b.matrix[4] -= b.x * b.matrix[0] + b.y * b.matrix[2]),
                    (b.matrix[5] -= b.x * b.matrix[1] + b.y * b.matrix[3]));
                }
                return b;
              }
              swapZ(t, e) {
            ...
            class ta extends te() {
              static compose(t) {
                (0, f.pushUnique)(ti, "Core.Series3D") &&
                  ((0, f.addEvent)(t, "afterTranslate", function () {
                    this.chart.is3d() && this.translate3dPoints();
                  }),
                  (0, f.extend)(t.prototype, {
                    translate3dPoints: ta.prototype.translate3dPoints,
                  }));
              }
              translate3dPoints() {
                let t,
                  ...
                  s = i.options,
                  a = i.chart,
                  r = i.zAxis ?? a.options.zAxis[0],
                  o = [],
                  h = [],
                  n = s.stacking
                    ? (0, f.isNumber)(s.stack)
                      ? s.stack
                      : 0
                    : i.index || 0;
                ((i.zPadding = n * (s.depth || 0 + (s.groupZPadding || 1))),
                  i.points.forEach((t) => {
                    (r?.translate
                      ? ((e =
                          r.logarithmic && r.val2lin ? r.val2lin(t.z) : t.z),
                        (t.plotZ = r.translate(e)),
                        (t.isInside = !!t.isInside && e >= r.min && e <= r.max))
                      : (t.plotZ = i.zPadding),
                      (t.axisXpos = t.plotX),
                      (t.axisYpos = t.plotY),
                      (t.axisZpos = t.plotZ),
                      o.push({ x: t.plotX, y: t.plotY, z: t.plotZ }),
                      h.push(t.plotX || 0));
                  }),
                  (i.rawPointsX = h));
                let l = ts(o, a, !0);
                i.points.forEach((e, i) => {
                  ((e.plotX = (t = l[i]).x), (e.plotY = t.y), (e.plotZ = t.z));
                });
              }
            }
            ta.defaultOptions = (0, f.merge)(te().defaultOptions);
            var tr = x(184),
              to = x.n(tr),
              th = x(540),
              tn = x.n(th),
            ...
            class tc extends tp() {
              ...
              initArgs(t) {
                ...
                for (let t of this.parts) {
                  let a = { class: "highcharts-3d-" + t, zIndex: s[t] || 0 };
                  (e.styledMode &&
                    ("top" === t
                      ? (a.filter = "url(#highcharts-brighter)")
                      : "side" === t && (a.filter = "url(#highcharts-darker)")),
                    (this[t] = e.path(i[t]).attr(a).add(this)));
                }
                (this.attr({ "stroke-linejoin": "round", zIndex: s.group }),
                  (this.forcedSides = i.forcedSides));
              }
              singleSetterForParts(t, e, i, s, a, r) {
                let o = {},
                  h = [null, null, s || "attr", a, r],
                  n = i?.zIndexes;
                if (i) {
                  for (let e of (n?.group && this.attr({ zIndex: n.group }),
                  Object.keys(i)))
                    ((o[e] = {}),
                      (o[e][t] = i[e]),
                      n && (o[e].zIndex = i.zIndexes[e] || 0));
                  h[1] = o;
                } else ((o[t] = e), (h[0] = o));
                return this.processParts.apply(this, h);
              }
              processParts(t, e, i, s, a) {
                for (let r of this.parts)
                  (e && (t = e[r] ?? !1), !1 !== t && this[r][i](t, s, a));
                return this;
              }
              destroy() {
                return (
              ...
              attr(t, e, i, s) {
                ...
                return t.shapeArgs || (0, f.defined)(t.x)
                  ? this.singleSetterForParts(
                      "d",
                      null,
                      this.renderer[this.pathType + "Path"](t.shapeArgs || t),
                    )
                  : super.attr(t, void 0, i, s);
              }
              animate(t, e, i) {
                if ((0, f.defined)(t.x) && (0, f.defined)(t.y)) {
                  let s = this.renderer[this.pathType + "Path"](t),
                    a = s.forcedSides;
                  (this.singleSetterForParts("d", null, s, "animate", e, i),
                    this.attr({ zIndex: s.zIndexes.group }),
                    a !== this.forcedSides &&
                      ((this.forcedSides = a),
              ...
              fillSetter(t) {
                return (
                  ...
                  this.singleSetterForParts("fill", null, {
                    front: t,
                    top: td(t)
                      .brighten(this.forcedSides.indexOf("top") >= 0 ? 0 : 0.1)
                      .get(),
                    side: td(t)
                      .brighten(
                        this.forcedSides.indexOf("side") >= 0 ? 0 : -0.1,
                      )
                      .get(),
                  }),
            ...
            tc.types = { base: tc, cuboid: tc };
            let { parse: tx } = b(),
              { charts: ty, deg2rad: tf } = u(),
              { perspective: tu, shapeArea: tz } = A,
              tb = Math.cos,
              tg = Math.sin,
              tm = Math.PI,
              tv = (4 * (Math.sqrt(2) - 1)) / 3 / (tm / 2);
            function tM(t, e, i, s, a, r, o, h) {
              let n = r - a,
                l = [];
              return r > a && r - a > Math.PI / 2 + 1e-4
                ? (l = (l = l.concat(
                    tM(t, e, i, s, a, a + Math.PI / 2, o, h),
                  )).concat(tM(t, e, i, s, a + Math.PI / 2, r, o, h)))
                : r < a && a - r > Math.PI / 2 + 1e-4
                  ? (l = (l = l.concat(
                      tM(t, e, i, s, a, a - Math.PI / 2, o, h),
                    )).concat(tM(t, e, i, s, a - Math.PI / 2, r, o, h)))
                  : [
                      [
                        "C",
                        t + i * Math.cos(a) - i * tv * n * Math.sin(a) + o,
                        e + s * Math.sin(a) + s * tv * n * Math.cos(a) + h,
                        t + i * Math.cos(r) + i * tv * n * Math.sin(r) + o,
                        e + s * Math.sin(r) - s * tv * n * Math.cos(r) + h,
                        t + i * Math.cos(r) + o,
                        e + s * Math.sin(r) + h,
                      ],
                    ];
            ...
            !(function (t) {
              ...
              function i(t) {
                let e = [],
                  i = !0;
                for (let s of t)
                  (e.push(i ? ["M", s.x, s.y] : ["L", s.x, s.y]), (i = !i));
                return e;
              }
              function s(t) {
                let e = this,
                ...
                return (
                  ...
                  (s.attr = function (t) {
                    if (
                      "object" == typeof t &&
                      ((0, f.defined)(t.enabled) ||
                        (0, f.defined)(t.vertexes) ||
                        (0, f.defined)(t.insidePlotArea))
                    ) {
                      ((this.enabled = t.enabled ?? this.enabled),
                        (this.vertexes = t.vertexes ?? this.vertexes),
                        (this.insidePlotArea =
                          t.insidePlotArea ?? this.insidePlotArea),
                        delete t.enabled,
                        delete t.vertexes,
                        delete t.insidePlotArea);
                      let i = ty[e.chartIndex],
                        s = tu(this.vertexes, i, this.insidePlotArea),
                        a = e.toLinePath(s, !0),
                        r = tz(s);
                      ((t.d = a),
                        (t.visibility =
                          this.enabled && r > 0 ? "inherit" : "hidden"));
                    }
                  ...
                  (s.animate = function (t) {
                    if (
                      ...
                      let i = ty[e.chartIndex],
                        ...
                        a = e.toLinePath(s, !0),
                        r = tz(s),
                        o = this.enabled && r > 0 ? "visible" : "hidden";
                      ((t.d = a), this.attr("visibility", o));
                    }
              ...
              function a(t) {
                let e = this,
                  ...
                  a = s.destroy;
                return (
                  this.styledMode || s.attr({ "stroke-linejoin": "round" }),
                  (s.faces = []),
                  (s.destroy = function () {
                  ...
                  (s.attr = function (t, a, r, o) {
                    if ("object" == typeof t && (0, f.defined)(t.faces)) {
                      ...
                      for (let i = 0; i < t.faces.length; i++)
                        (e.styledMode && delete t.faces[i].fill,
                          s.faces[i].attr(t.faces[i], null, r, o));
                      delete t.faces;
                    }
                    return i.attr.apply(this, arguments);
                  }),
                  (s.animate = function (t, a, r) {
                    if (t?.faces) {
                      for (; s.faces.length > t.faces.length; )
                        s.faces.pop().destroy();
                      for (; s.faces.length < t.faces.length; )
                      ...
                      for (let e = 0; e < t.faces.length; e++)
                        s.faces[e].animate(t.faces[e], a, r);
                      delete t.faces;
                    }
                    return i.animate.apply(this, arguments);
                  }),
              ...
              function r(t, e) {
                let i = new tc.types[t](this, "g");
                return (i.initArgs(e), i);
              }
              function o(t) {
              ...
              function h(t) {
                let e = t.x || 0,
                  ...
                  r = t.width || 0,
                  o = t.depth || 0,
                  h = ty[this.chartIndex],
                  n = h.options.chart.options3d.alpha,
                  l = [],
                  p,
                  d = 0,
                  c = [
                ...
                c = tu(c, h, t.insidePlotArea);
                let x = (t) =>
                    0 === a && t > 1 && t < 6
                      ? { x: c[t].x, y: c[t].y + 10, z: c[t].z }
                      : c[0].x === c[7].x && t >= 4
                        ? { x: c[t].x + 10, y: c[t].y, z: c[t].z }
                        : (0 === o && t < 2) || t > 5
                          ? { x: c[t].x, y: c[t].y, z: c[t].z + 10 }
                          : c[t],
                  y = (t) => c[t],
                  f = (t, e, i) => {
                    let s = t.map(y),
                  ...
                  u = (p = f([3, 2, 1, 0], [7, 6, 5, 4], "front"))[0],
                  z = p[1],
                  b = (p = f([1, 6, 7, 0], [4, 5, 2, 3], "top"))[0],
                  g = p[1],
                  m = (p = f([1, 2, 5, 6], [0, 7, 4, 3], "side"))[0],
                  v = p[1];
                return (
                  1 === v
                    ? (d += 1e6 * (h.plotWidth - e))
                  ...
                  (d +=
                    10 *
                    (!g || (n >= 0 && n <= 180) || (n < 360 && n > 357.5)
                      ? h.plotHeight - i
                      : 10 + i)),
                  1 === z ? (d += 100 * s) : z || (d += 100 * (1e3 - s)),
                  {
                    front: this.toLinePath(u, !0),
                    top: this.toLinePath(b, !0),
                    side: this.toLinePath(m, !0),
                    zIndexes: { group: Math.round(d) },
                    forcedSides: l,
                    isFront: z,
                    isTop: g,
                  }
              ...
              function n(t) {
                ...
                function a(t) {
                  let e,
                    i = {};
                  for (e in (t = (0, f.merge)(t)))
                    -1 !== s.indexOf(e) && ((i[e] = t[e]), delete t[e]);
                  return !!Object.keys(i).length && [i, t];
                }
                for (let i of (((t = (0, f.merge)(t)).alpha =
                  (t.alpha || 0) * tf),
                (t.beta = (t.beta || 0) * tf),
                (e.top = this.path()),
                (e.side1 = this.path()),
                ...
                (e.onAdd = function () {
                  ...
                  ["out", "inn", "side1", "side2"]))
                    e[s].attr({ class: i + " highcharts-3d-side" }).add(t);
                }),
                ...
                for (let i of ((e.setPaths = function (t) {
                  let i = e.renderer.arc3dPath(t),
                    s = 100 * i.zTop;
                  ((e.attribs = t),
                    e.top.attr({ d: i.top, zIndex: i.zTop }),
                    e.inn.attr({ d: i.inn, zIndex: i.zInn }),
                    e.out.attr({ d: i.out, zIndex: i.zOut }),
                    e.side1.attr({ d: i.side1, zIndex: i.zSide1 }),
                    e.side2.attr({ d: i.side2, zIndex: i.zSide2 }),
                    (e.zIndex = s),
                    e.attr({ zIndex: s }),
                    t.center &&
                      (e.top.setRadialReference(t.center), delete t.center));
                }),
                e.setPaths(t),
                (e.fillSetter = function (t) {
                  let e = tx(t).brighten(-0.1).get();
                  return (
                    (this.fill = t),
                  ...
                  (e.attr = function (t) {
                    if ("object" == typeof t) {
                      ...
                      if (i) {
                        let t = i[0];
                        ((arguments[0] = i[1]),
                          void 0 !== t.alpha && (t.alpha *= tf),
                          void 0 !== t.beta && (t.beta *= tf),
                          (0, f.extend)(e.attribs, t),
                          e.attribs && e.setPaths(e.attribs));
                      }
                    }
                    return i.attr.apply(e, arguments);
                  }),
                  (e.animate = function (t, s, r) {
                    let o = this.attribs,
                      h = "data-" + Math.random().toString(26).substring(2, 9);
                    (delete t.center, delete t.z);
                    let n = (0, f.animObject)(
                      s ?? this.renderer.globalAnimation,
                    );
                    if (n.duration) {
                      let i = a(t);
                      if (
                    ...
                    return i.animate.call(this, t, s, r);
                  }),
                  (e.destroy = function () {
                    return (
                      this.top.destroy(),
              ...
              function l(t) {
                let e = t.x || 0,
                  ...
                  g = h * Math.sin(n),
                  m = [["M", e + y * p, i + f * d]];
                ((m = m.concat(tM(e, i, y, f, s, a, 0, 0))).push([
                  "L",
                  e + u * c,
                  i + z * x,
                ]),
                  (m = m.concat(tM(e, i, u, z, a, s, 0, 0))).push(["Z"]));
                let v = l > 0 ? Math.PI / 2 : 0,
                  M = n > 0 ? 0 : Math.PI / 2,
                  A = s > -v ? s : a > -v ? -v : s,
                  P = a < tm - M ? a : s < tm - M ? tm - M : a,
                  S = 2 * tm - M,
                  k = [["M", e + y * tb(A), i + f * tg(A)]];
                ((k = k.concat(tM(e, i, y, f, A, P, 0, 0))),
                  a > S && s < S
                    ? (k.push(["L", e + y * tb(P) + b, i + f * tg(P) + g]),
                      (k = k.concat(tM(e, i, y, f, P, S, b, g))).push([
                        "L",
                        e + y * tb(S),
                        i + f * tg(S),
                      ]),
                      (k = k.concat(tM(e, i, y, f, S, a, 0, 0))).push([
                        "L",
                        e + y * tb(a) + b,
                        i + f * tg(a) + g,
                      ]),
                      (k = k.concat(tM(e, i, y, f, a, S, b, g))).push([
                        "L",
                        e + y * tb(S),
                        i + f * tg(S),
                      ]),
                      (k = k.concat(tM(e, i, y, f, S, P, 0, 0))))
                    : a > tm - M &&
                      s < tm - M &&
                      (k.push([
                        "L",
                      ...
                      (k = k.concat(tM(e, i, y, f, P, a, b, g))).push([
                        "L",
                        e + y * Math.cos(a),
                        i + f * Math.sin(a),
                      ]),
                  ...
                  (k = k.concat(tM(e, i, y, f, P, A, b, g))).push(["Z"]));
                let w = [["M", e + u * p, i + z * d]];
                ((w = w.concat(tM(e, i, u, z, s, a, 0, 0))).push([
                  "L",
                  e + u * Math.cos(a) + b,
                  i + z * Math.sin(a) + g,
                ]),
                  (w = w.concat(tM(e, i, u, z, a, s, b, g))).push(["Z"]));
                let D = [
                    ["M", e + y * p, i + f * d],
                    ["L", e + y * p + b, i + f * d + g],
                    ["L", e + u * p + b, i + z * d + g],
                ...
                function T(t) {
                  return (
                    (t %= 2 * Math.PI) > Math.PI && (t = 2 * Math.PI - t),
                    t
                  );
                }
                ((E = T(E)), (X = T(X)));
            ...
            var tP = x(532),
              tS = x.n(tP);
            let { defaultOptions: tk } = u();
            function tw(t) {
              return new tL(this, t);
            }
            function tD() {
              let t = (this.options.zAxis = (0, f.splat)(
                this.options.zAxis || {},
              ));
              this.is3d() &&
                ((this.zAxis = []),
            ...
            class tL extends tS() {
              ...
              static compose(t) {
                ...
                e.addZAxis ||
                  ...
                  (0, f.addEvent)(t, "afterCreateAxes", tD));
              }
              init(t, e) {
              ...
              getSeriesExtremes() {
                ((this.hasVisibleSeries = !1),
                  (this.dataMin =
                    this.dataMax =
                    this.ignoreMinPadding =
                    this.ignoreMaxPadding =
                      void 0),
                  ...
                  this.series.forEach((t) => {
                    if (t.reserveSpace()) {
                      ...
                      let i = [...t.getColumn("z", !1, !0)].map((t) => t || 0);
                      i.length &&
              ...
              setAxisSize() {
                ...
                (super.setAxisSize(),
                  (this.width = this.len =
                    t.options.chart.options3d?.depth || 0),
            ...
            function tX() {
              let t = this.chart,
                ...
                i = e.depth,
                s =
                  (e.stacking ? e.stack || 0 : this.index) *
                  (i + (e.groupZPadding || 1)),
                a = this.borderWidth % 2 ? 0.5 : 0,
                r;
              for (let o of (t.inverted && !this.yAxis.reversed && (a *= -1),
              !1 !== e.grouping && (s = 0),
              (s += e.groupZPadding || 1),
              this.points))
                if (((o.outside3dPlot = null), null !== o.y)) {
                  let e,
                    h = (0, f.extend)(
                  ...
                  for (let t of n)
                    if (
                      ((e = h[t[0]] - a) < 0 &&
                        ((h[t[1]] += h[t[0]] + a), (h[t[0]] = -a), (e = 0)),
                      e + h[t[1]] > this[t[0] + "Axis"].len &&
                        0 !== h[t[1]] &&
                        (h[t[1]] = this[t[0] + "Axis"].len - h[t[0]]),
                      0 !== h[t[1]] &&
                        (h[t[0]] >= this[t[0] + "Axis"].len ||
                          h[t[0]] + h[t[1]] <= a))
                    ) {
                  ...
                  if (
                    ("roundedRect" === o.shapeType && (o.shapeType = "cuboid"),
                    (o.shapeArgs = (0, f.extend)(h, {
                      z: s,
                      depth: i,
                      insidePlotArea: !0,
                    })),
                    (r = { x: h.x + h.width / 2, y: h.y, z: s + i / 2 }),
                    t.inverted && ((r.x = h.height), (r.y = o.clientX || 0)),
                    (o.axisXpos = r.x),
                    (o.axisYpos = r.y),
                    (o.axisZpos = r.z),
                    (o.plot3d = tE([r], t, !0, !1)[0]),
                    l)
                  ) {
                    let e = tE(
                      [{ x: l[0], y: l[1], z: s + i / 2 }],
            ...
            function tH() {
              if (this.chart.is3d()) {
                ...
                if (!(void 0 !== s && !s)) {
                  ...
                  let s,
                    ...
                    d =
                      ...
                      h.forEach(function (t) {
                        n[
                          (l =
                            t.options.stack ?? (e ? 0 : h.length - 1 - t.index))
                        ]
                          ? n[l].series.push(t)
                          : ((n[l] = { series: [t], position: p }), p++);
                      }),
                      (n.totalStacks = p + 1),
                      n),
                    c = i.stack || 0;
                  for (
                    s = 0;
                    s < d[c].series.length && d[c].series[s] !== this;
                    s++
                  );
                  ((o = 10 * (d.totalStacks - d[c].position) + (r ? s : -s)),
                    this.xAxis.reversed || (o = 10 * d.totalStacks - o));
                }
                ((i.depth = i.depth || 25),
                  (this.z = this.z || 0),
                  (i.zIndex = o));
              ...
              if (this.chart.is3d()) {
                ...
                if (e)
                  for (let t of this.points)
                    null !== t.y &&
                      ((t.height = t.shapeArgs.height),
                      (t.shapey = t.shapeArgs.y),
                      (t.shapeArgs.height = 1),
                      s ||
                        (t.stackY
                          ? (t.shapeArgs.y = t.plotY + i.translate(t.stackY))
                          : (t.shapeArgs.y =
                              t.plotY + (t.negative ? -t.height : t.height))));
                else {
                  for (let t of this.points)
                    null !== t.y &&
                      ((t.shapeArgs.height = t.height),
                      (t.shapeArgs.y = t.shapey),
                      t.graphic &&
                        t.graphic[t.outside3dPlot ? "attr" : "animate"](
                          t.shapeArgs,
                          this.options.animation,
                        ));
                  this.drawDataLabels();
            ...
            function tO(t) {
              ...
              return (
                this.chart.is3d &&
                  this.chart.is3d() &&
                  ((e.stroke = this.options.edgeColor || e.fill),
                  (e["stroke-width"] = this.options.edgeWidth ?? 1)),
                e
              );
            }
            function tC(t, e, i) {
              ...
              if (this.chart.is3d())
                for (let t of this.points)
                  ((t.visible =
                    t.options.visible =
                    e =
                      void 0 === e ? !(this.visible ?? t.visible) : e),
                    this.options.data &&
                      (this.options.data[this.data.indexOf(t)] = t.options),
                    t.graphic?.attr({ visibility: e ? "visible" : "hidden" }));
              t.apply(this, Array.prototype.slice.call(arguments, 1));
            }
            function tG(t) {
              (t.apply(this, [].slice.call(arguments, 1)),
            ...
            function t_(t, e, i, s, a) {
              let r = this.chart;
              if (
                ((s.outside3dPlot = e.outside3dPlot),
                r.is3d() && this.is("column"))
              ) {
                let t = this.options,
                  i = s.inside ?? !!this.options.stacking,
                  o = r.options.chart.options3d,
                  h = (e.pointWidth || 0) / 2,
                  n = { x: a.x + h, y: a.y, z: this.z + t.depth / 2 };
                (r.inverted &&
                  (i && ((a.width = 0), (n.x += e.shapeArgs.height / 2)),
                  o.alpha >= 90 &&
                    o.alpha <= 270 &&
                    (n.y += e.shapeArgs.width)),
                  (a.x = (n = tE([n], r, !0, !1)[0]).x - h),
                  (a.y = e.outside3dPlot ? -9e9 : n.y));
              }
              t.apply(this, [].slice.call(arguments, 1));
            }
            function tW(t) {
            ...
            function tR(t, e) {
              ...
              if (s.is3d() && this.base) {
                let t = +this.base.split(",")[0],
                  e = s.series[t],
                  r = s.options.chart.options3d;
                if (e && "column" === e.type) {
                  let t = {
                    x: i.x + (s.inverted ? i.height : a / 2),
                    y: i.y,
                    z: e.options.depth / 2,
                  };
                  (s.inverted &&
                    ((i.width = 0),
                    r.alpha >= 90 && r.alpha <= 270 && (t.y += a)),
                    (i.x = (t = tE([t], s, !0, !1)[0]).x - a / 2),
                    (i.y = t.y));
                }
              }
              return i;
            ...
            let {
              ...
              { composed: tV, deg2rad: tN } = u(),
              { pie: tU } = I().seriesTypes;
            class tq extends tU {
              static compose(t) {
                (0, f.pushUnique)(tV, "Pie3D") && (t.types.pie = tq);
              }
              addPoint() {
              ...
              animate(t) {
                if (this.chart.is3d()) {
                  ...
                  (!0 === a && (a = {}),
                    t
                      ? ((i.oldtranslateX = i.oldtranslateX ?? i.translateX),
                        (i.oldtranslateY = i.oldtranslateY ?? i.translateY),
                        (r = {
                          translateX: e[0],
                          translateY: e[1],
                          scaleX: 0.001,
                        ...
                        i.attr(r),
                        s && ((s.attrSetters = i.attrSetters), s.attr(r)))
                      : ((r = {
              ...
              getDataLabelPosition(t, e) {
                ...
                if (this.chart.is3d()) {
                  let e = this.chart.options.chart.options3d,
                    s = t.shapeArgs,
                    a = s.r,
                    r = (s.alpha || e?.alpha) * tN,
                    o = (s.beta || e?.beta) * tN,
                    h = (s.start + s.end) / 2,
                    n = i.connectorPosition,
                    l = -a * (1 - Math.cos(r)) * Math.sin(h),
                    p = a * (Math.cos(o) - 1) * Math.cos(h);
                  for (let t of [i?.natural, n.breakAt, n.touchingSliceAt])
                    ((t.x += p), (t.y += l));
                }
                return i;
              }
              pointAttribs(t) {
                ...
                return (
                  this.chart.is3d() &&
                    !this.chart.styledMode &&
                    ((e.stroke = i.edgeColor || t.color || this.color),
                    (e["stroke-width"] = i.edgeWidth ?? 1)),
                  e
                );
              }
              translate() {
                if (
                  (super.translate.apply(this, arguments), !this.chart.is3d())
                )
                  return;
                let t = this.options,
                  e = t.depth || 0,
                  ...
                  s = i.alpha,
                  a = i.beta,
                  r = t.stacking ? (t.stack || 0) * e : this._i * e;
                for (let i of ((r += e / 2),
                !1 !== t.grouping && (r = 0),
                this.points)) {
                  let o = i.shapeArgs;
                  ((i.shapeType = "arc3d"),
                    ...
                    (o.alpha = s),
                    (o.beta = a),
                    (o.center = this.center));
                  let h = (o.end + o.start) / 2;
                  i.slicedTranslation = {
                    translateX: Math.round(
                      Math.cos(h) * t.slicedOffset * Math.cos(s * tN),
                    ),
                    translateY: Math.round(
                      Math.sin(h) * t.slicedOffset * Math.cos(s * tN),
                    ),
                  };
                }
              }
              drawTracker() {
                if (
                  (super.drawTracker.apply(this, arguments), this.chart.is3d())
                ) {
                  for (let t of this.points)
                    if (t.graphic)
            ...
            (0, f.extend)(tq.prototype, { pointClass: tj });
            var tJ = x(632),
              tK = x.n(tJ);
            let { pointClass: tQ } = tK().prototype,
              t$ = class extends tQ {
                applyOptions() {
                  return (
                    super.applyOptions.apply(this, arguments),
                    (0, f.defined)(this.z) || (this.z = 0),
                    this
                  );
                }
              },
              { pointCameraDistance: t0 } = A;
            class t1 extends tK() {
              pointAttribs(t) {
                let e = super.pointAttribs.apply(this, arguments);
                return (
                  this.chart.is3d() && t && (e.zIndex = t0(t, this.chart)),
                  e
                );
              }
            }
            ((t1.defaultOptions = (0, f.merge)(tK().defaultOptions, {
              tooltip: {
                pointFormat:
                  "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>z: <b>{point.z}</b><br/>",
              },
            })),
              (0, f.extend)(t1.prototype, {
              ...
              I().registerSeriesType("scatter3d", t1));
            let t3 = u();
            (({
              compose: function (t) {
                (0, f.pushUnique)(E, "Area3DSeries") &&
                  (0, f.wrap)(t.prototype, "getGraphPath", T);
              },
            }).compose(t3.Series.types.area),
              $.compose(t3.Axis, t3.Tick),
              D.compose(t3.Chart, t3.Fx),
              {
                compose: function (t, e) {
                  if ((0, f.pushUnique)(tI, "Column3D")) {
                    let i = t.prototype,
                      s = e.prototype,
                      { column: a, columnRange: r } = t.types;
                    if (
                      ((0, f.wrap)(i, "alignDataLabel", t_),
                      (0, f.wrap)(i, "justifyDataLabel", tW),
                      (0, f.wrap)(s, "getStackBox", tR),
                      a)
                    ) {
                      let t = a.prototype,
                        e = t.pointClass.prototype;
                      ((t.translate3dPoints = () => void 0),
                        (t.translate3dShapes = tX),
                        (0, f.addEvent)(t, "afterInit", tH),
                        (0, f.wrap)(e, "hasNewShapeType", tT),
                        (0, f.wrap)(t, "animate", tY),
                        (0, f.wrap)(t, "plotGroup", tZ),
                        (0, f.wrap)(t, "pointAttribs", tO),
                        (0, f.wrap)(t, "setState", tC),
                        (0, f.wrap)(t, "setVisible", tF),
                        (0, f.wrap)(t, "translate", tG));
                    }
                    if (r) {
                      let t = r.prototype,
                        e = t.pointClass.prototype;
              ...
              }.compose(t3.Series, to()),
              tq.compose(t3.Series),
              ta.compose(t3.Series),
              tA.compose(tn()),
              tL.compose(t3.Chart));
            let t2 = t3;
            return y.default;
