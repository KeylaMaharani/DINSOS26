...
return new class extends Migration {
    ...
    {
        Schema::create('dtsen_permohonan', function (Blueprint $table) {
            $table->id();
            ...
            // "Alasan Cetak" -> kolom listing Monitoring & filter di Arsip
            // (setara peran "masalah_kartu" di modul Kartu KKS)
            $table->string('alasan_cetak')->nullable();
    ...
    {
        Schema::dropIfExists('dtsen_permohonan');
    }
};
