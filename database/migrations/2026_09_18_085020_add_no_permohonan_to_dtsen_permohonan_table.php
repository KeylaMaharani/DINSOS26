...
return new class extends Migration
{
    ...
    {
        Schema::table('dtsen_permohonan', function (Blueprint $table) {
        ...
        $rows = DB::table('dtsen_permohonan')->orderBy('id')->get();
        $counterPerYear = [];
        ...
        foreach ($rows as $row) {
            ...
            $noPermohonan = 'DTSEN-' . $year . '-' . str_pad($counterPerYear[$year], 4, '0', STR_PAD_LEFT);

            DB::table('dtsen_permohonan')
                ->where('id', $row->id)
